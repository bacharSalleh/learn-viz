...
`;class ed extends R{static get observedAttributes(){return["title"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(td),this._render()}handleAttributeChange(){this.root.querySelector(".title")&&this._render()}get _title(){return this.getAttribute("title")||""}_render(){this.render(`
...
`;class Fg extends R{static get observedAttributes(){return["answer","accept"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(qg),this._build()}handleAttributeChange(){}_build(){this.render(`
...
`,kt={top:20,right:20,bottom:50,left:55},po=500,qi=400;class e0 extends R{constructor(){super(...arguments);z(this,"_data",[]);z(this,"_hasAnimated",!1);z(this,"_svg",null);z(this,"_container",null)}static get observedAttributes(){return["data","x-label","y-label","clusters","tooltip"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(t0),this._container=document.createElement("div"),this.root.appendChild(this._container),this._data=this.jsonAttr("data",[]),this._initSvg(),this._render(!1)}disconnectedCallback(){super.disconnectedCallback()}handleAttributeChange(t,n,i){n!==i&&(t==="data"&&(this._data=this.jsonAttr("data",[])),this._svg&&this._render(!1))}animateIn(t){this._hasAnimated||(this._hasAnimated=!0,t?this._render(!1):this._render(!0))}_getColor(t,n){return n.color?n.color:getComputedStyle(this).getPropertyValue(`--lv-chart-${t%8}`).trim()||fo[t%8]}_clusterColor(t){const i=[...new Set(this._data.map(o=>o.cluster).filter(o=>o!=null))].indexOf(t),s=i>=0?i:0;return getComputedStyle(this).getPropertyValue(`--lv-chart-${s%8}`).trim()||fo[s%8]}_initSvg(){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("role","img"),t.setAttribute("aria-label","Scatter plot"),this._container.appendChild(t),this._svg=U(t),this._svg.append("g").attr("class","grid-group"),this._svg.append("g").attr("class","axis-group"),this._svg.append("g").attr("class","points-group"),this._svg.append("g").attr("class","tooltip-group"),this._svg.append("g").attr("class","legend-group")}_render(t){if(!this._svg)return;const n=this._data,i=this.hasAttribute("clusters"),s=this.hasAttribute("tooltip"),a=this.getAttribute("x-label")||"",o=this.getAttribute("y-label")||"",c=i?[...new Set(n.map(P=>P.cluster).filter(P=>P!=null))]:[],l=c.length>0?30:0,d=qi+l,u=po-kt.left-kt.right,h=qi-kt.top-kt.bottom;this._svg.attr("viewBox",`0 0 ${po} ${d}`);const f=ne(n,P=>P.x),g=ne(n,P=>P.y),p=(f[1]-f[0])*.05||1,m=(g[1]-g[0])*.05||1,b=rt().domain([f[0]-p,f[1]+p]).range([0,u]),x=rt().domain([g[0]-m,g[1]+m]).range([h,0]),v=this._svg.select(".grid-group").attr("transform",`translate(${kt.left},${kt.top})`);v.selectAll("*").remove();const _=Yn(b).tickSize(-h).tickFormat(()=>"");v.append("g").attr("class","grid").attr("transform",`translate(0,${h})`).call(_);const w=Gn(x).tickSize(-u).tickFormat(()=>"");v.append("g").attr("class","grid").call(w);const k=this._svg.select(".axis-group").attr("transform",`translate(${kt.left},${kt.top})`);k.selectAll("*").remove(),k.append("g").attr("class","axis").attr("transform",`translate(0,${h})`).call(Yn(b).ticks(6)),k.append("g").attr("class","axis").call(Gn(x).ticks(6)),a&&k.append("text").attr("class","axis-label").attr("x",u/2).attr("y",h+38).attr("text-anchor","middle").text(a),o&&k.append("text").attr("class","axis-label").attr("x",-h/2).attr("y",-40).attr("text-anchor","middle").attr("transform","rotate(-90)").text(o);const $=this._svg.select(".points-group").attr("transform",`translate(${kt.left},${kt.top})`),A=this._svg.select(".tooltip-group").attr("transform",`translate(${kt.left},${kt.top})`);A.selectAll("*").remove();const S=A.append("g").attr("class","tooltip-box");S.append("rect").attr("class","tooltip-bg"),S.append("text").attr("class","tooltip-text");const y=$.selectAll(".point").data(n,(P,q)=>String(q));y.exit().remove();const C=y.enter().append("circle").attr("class","point").attr("cx",P=>b(P.x)).attr("cy",P=>x(P.y)).attr("r",5).attr("fill",(P,q)=>i&&P.cluster!=null?this._clusterColor(P.cluster):this._getColor(q,P)).attr("opacity",t?0:1).attr("transform",t?"scale(0)":"scale(1)").style("transform-origin",P=>`${b(P.x)}px ${x(P.y)}px`);s?C.on("mouseenter",(P,q)=>{var D;if(U(P.currentTarget).transition().duration(150).attr("r",6.5).attr("opacity",1),q.label){const nt=b(q.x),lt=x(q.y)-14;S.classed("visible",!0),S.select(".tooltip-text").attr("x",nt).attr("y",lt).text(q.label);const W=S.select(".tooltip-text").node(),G=((D=W==null?void 0:W.getComputedTextLength)==null?void 0:D.call(W))||40;S.select(".tooltip-bg").attr("x",nt-G/2-6).attr("y",lt-10).attr("width",G+12).attr("height",20)}}).on("mouseleave",P=>{U(P.currentTarget).transition().duration(150).attr("r",5).attr("opacity",.85),S.classed("visible",!1)}):C.on("mouseenter",P=>{U(P.currentTarget).transition().duration(150).attr("r",6.5)}).on("mouseleave",P=>{U(P.currentTarget).transition().duration(150).attr("r",5)});const M=C.merge(y);if(t?M.each(function(P,q){U(this).transition().delay(q*30).duration(400).ease(cp).attr("opacity",.85).attr("transform","scale(1)")}):M.attr("cx",P=>b(P.x)).attr("cy",P=>x(P.y)).attr("opacity",.85).attr("transform","scale(1)").attr("fill",(P,q)=>i&&P.cluster!=null?this._clusterColor(P.cluster):this._getColor(q,P)),this.hasAttribute("labels")||this.hasAttribute("tooltip")){const P=this._svg.select(".points-group");P.selectAll(".point-label").remove(),n.forEach((q,N)=>{if(!q.label)return;const D=P.append("text").attr("class","point-label").attr("x",b(q.x)+8).attr("y",x(q.y)+4).attr("fill","var(--lv-text, #e4e4ec)").attr("font-size","11px").attr("opacity",t?0:.9).text(q.label);t&&D.transition().delay(N*30+200).duration(300).attr("opacity",.9)})}const L=this._svg.select(".legend-group");if(L.selectAll("*").remove(),c.length>0){const P=qi+5;let q=kt.left;for(const N of c){const D=this._clusterColor(N);L.append("circle").attr("cx",q+5).attr("cy",P+8).attr("r",4).attr("fill",D),L.append("text").attr("class","legend-text").attr("x",q+14).attr("y",P+8).attr("dominant-baseline","central").text(String(N)),q+=14+String(N).length*7+20}}let E=this._container.querySelector(".sr-table");E||(E=document.createElement("table"),E.className="sr-table",this._container.appendChild(E));const F=P=>P.replace(/&/g,"&amp;").replace(/</g,"&lt;"),I=n.map(P=>`<tr><td>${P.x}</td><td>${P.y}</td><td>${P.label?F(P.label):""}</td></tr>`).join("");E.innerHTML=`<caption>Scatter plot data</caption><thead><tr><th>X</th><th>Y</th><th>Label</th></tr></thead><tbody>${I}</tbody>`}}customElements.define("lv-scatter",e0);const n0=["#3b82f6","#8b5cf6","#06b6d4","#10b981","#f59e0b","#ef4444","#ec4899","#6366f1"],r0=`
  :host { display: block; }
  svg { width: 100%; display: block; direction: ltr; }
  .sr-table { position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0,0,0,0); border: 0; }
...
`;class o0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["labels","values","normalize","show-metrics"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(a0),this._buildChart()}handleAttributeChange(){this.isConnected&&this._buildChart()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelectorAll(".cell");n.forEach((i,s)=>{const a=i,o=Math.floor(s/Math.sqrt(n.length)),c=s%Math.sqrt(n.length),l=(o+c)*40;a.style.transition="none",a.style.opacity="0",a.style.transform="scale(0.5)",requestAnimationFrame(()=>requestAnimationFrame(()=>{a.style.transition=`opacity 400ms ease-out ${l}ms, transform 400ms ease-out ${l}ms`,a.style.opacity="1",a.style.transform="scale(1)"}))})}_buildChart(){const t=this.jsonAttr("labels",[]),n=this.jsonAttr("values",[]),i=this.hasAttribute("normalize"),s=this.hasAttribute("show-metrics");if(!t.length||!n.length){this.render('<div class="cm-container"></div>');return}const a=t.length,o=i?n.map(y=>{const C=y.reduce((M,T)=>M+T,0);return C>0?y.map(M=>M/C):y}):n,c=Math.max(...o.flat()),l=56,d=3,u=70,h=80,f=s?60:0,g=s?40:0,p=a*l+(a-1)*d,m=p,b=h+p+f,x=u+m+g,v=this.isRtl,_=Ei(Za).domain([0,c||1]),w=y=>{const C=Gt(_(y));if(!C)return"#fff";const{r:M,g:T,b:L}=C.rgb();return M*.299+T*.587+L*.114>150?"#111":"#fff"};let k="";for(let y=0;y<a;y++){const C=h+y*(l+d)+l/2;k+=`<text class="header-text" x="${v?b-C:C}" y="${u-8}"
        ...
        text-anchor="middle" dominant-baseline="central">${this._esc(t[y])}</text>`}for(let y=0;y<a;y++)for(let C=0;C<a;C++){const M=o[y][C],T=n[y][C],L=h+C*(l+d),E=u+y*(l+d),F=v?b-L-l:L,I=_(M),P=w(M),q=i?(M*100).toFixed(0)+"%":String(T);k+=`<g class="cell">
          <rect x="${F}" y="${E}" width="${l}" height="${l}"
            rx="4" fill="${I}" ${y===C?'stroke="var(--lv-accent)" stroke-width="2"':""}/>
          <text class="cell-text" x="${F+l/2}" y="${E+l/2}"
            text-anchor="middle" dominant-baseline="central"
            fill="${P}">${q}</text>
        </g>`}if(s){for(let y=0;y<a;y++){const C=n[y][y],M=n.reduce((F,I)=>F+I[y],0),T=M>0?(C/M*100).toFixed(0)+"%":"-",L=h+y*(l+d)+l/2,E=v?b-L:L;k+=`<text class="metric-text" x="${E}" y="${u+m+25}"
          text-anchor="middle" fill="var(--lv-positive)">${T}</text>`}for(let y=0;y<a;y++){const C=n[y][y],M=n[y].reduce((F,I)=>F+I,0),T=M>0?(C/M*100).toFixed(0)+"%":"-",L=u+y*(l+d)+l/2,E=v?h/2-20:h+p+10;k+=`<text class="metric-text" x="${E}" y="${L}"
...
`,wn=560,Sr=280,ht={top:30,right:60,bottom:40,left:55};class c0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["loss","accuracy","lr","x-label","tooltip"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(l0),this._buildChart()}handleAttributeChange(){this.isConnected&&this._buildChart()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;this.root.querySelectorAll(".metric-line").forEach(i=>{const s=i,a=s.getTotalLength();s.style.strokeDasharray=String(a),s.style.strokeDashoffset=String(a),s.style.transition=`stroke-dashoffset 1.2s ${s.dataset.idx||"0"}s ease-out`,requestAnimationFrame(()=>{s.style.strokeDashoffset="0"})})}_buildChart(){const t=this.jsonAttr("loss",[]),n=this.jsonAttr("accuracy",[]),i=this.jsonAttr("lr",[]),s=this.getAttribute("x-label")||"Epoch";this.hasAttribute("tooltip");const a=Math.max(t.length,n.length,i.length);if(a===0){this.render('<div class="td-container"></div>');return}const o=wn-ht.left-ht.right,c=Sr-ht.top-ht.bottom,l=rt().domain([0,a-1]).range([0,o]),d=Math.max(t.length?Math.max(...t):0,n.length?Math.max(...n):1)*1.1,u=rt().domain([0,d]).range([c,0]),h=i.length>0,f=h?Math.max(...i)*1.2:1,g=rt().domain([0,f]).range([c,0]),p=($,A)=>re().x((S,y)=>ht.left+l(y)).y(S=>ht.top+A(S)).curve(bn)($)||"",m=[];t.length&&m.push({name:"Loss",color:"var(--lv-negative)",data:t,axis:"left"}),n.length&&m.push({name:"Accuracy",color:"var(--lv-positive)",data:n,axis:"left"}),h&&m.push({name:"Learning Rate",color:"var(--lv-accent2)",data:i,axis:"right"});const b=m.map($=>`<div class="legend-item"><div class="legend-dot" style="background:${$.color}"></div>${$.name}</div>`).join("");let x="";const v=u.ticks(5);v.forEach($=>{const A=ht.top+u($);x+=`<line class="grid-line" x1="${ht.left}" x2="${wn-ht.right}" y1="${A}" y2="${A}"/>`});let _="";v.forEach($=>{const A=ht.top+u($);_+=`<text class="axis-text" x="${ht.left-8}" y="${A}" text-anchor="end" dominant-baseline="central">${$.toFixed(2)}</text>`}),h&&g.ticks(4).forEach($=>{const A=ht.top+g($);_+=`<text class="axis-text" x="${wn-ht.right+8}" y="${A}" text-anchor="start" dominant-baseline="central">${$.toFixed(4)}</text>`}),l.ticks(Math.min(a,10)).forEach($=>{const A=ht.left+l($);_+=`<text class="axis-text" x="${A}" y="${Sr-ht.bottom+20}" text-anchor="middle">${Math.round($)}</text>`}),_+=`<text class="axis-text" x="${wn/2}" y="${Sr-4}" text-anchor="middle">${s}</text>`;let k="";m.forEach(($,A)=>{const S=$.axis==="left"?u:g,y=p($.data,S);k+=`<path class="metric-line" d="${y}" stroke="${$.color}" data-idx="${A*.3}"/>`}),this.render(`
    ...
    `)}}customElements.define("lv-train-dashboard",c0);function _o(r,e){let t;if(e===void 0)for(const n of r)n!=null&&(t<n||t===void 0&&n>=n)&&(t=n);else{let n=-1;for(let i of r)(i=e(i,++n,r))!=null&&(t<i||t===void 0&&i>=i)&&(t=i)}return t}function d0(r,e){let t;if(e===void 0)for(const n of r)n!=null&&(t>n||t===void 0&&n>=n)&&(t=n);else{let n=-1;for(let i of r)(i=e(i,++n,r))!=null&&(t>i||t===void 0&&i>=i)&&(t=i)}return t}function Fi(r,e){let t=0;if(e===void 0)for(let n of r)(n=+n)&&(t+=n);else{let n=-1;for(let i of r)(i=+e(i,++n,r))&&(t+=i)}return t}function u0(r){return r.depth}function h0(r,e){return r.sourceLinks.length?r.depth:e-1}function Cr(r){return function(){return r}}function vo(r,e){return Mr(r.source,e.source)||r.index-e.index}function bo(r,e){return Mr(r.target,e.target)||r.index-e.index}function Mr(r,e){return r.y0-e.y0}function Ni(r){return r.value}function f0(r){return r.index}function p0(r){return r.nodes}function g0(r){return r.links}function xo(r,e){const t=r.get(e);if(!t)throw new Error("missing: "+e);return t}function yo({nodes:r}){for(const e of r){let t=e.y0,n=t;for(const i of e.sourceLinks)i.y0=t+i.width/2,t+=i.width;for(const i of e.targetLinks)i.y1=n+i.width/2,n+=i.width}}function m0(){let r=0,e=0,t=1,n=1,i=24,s=8,a,o=f0,c=h0,l,d,u=p0,h=g0,f=6;function g(){const E={nodes:u.apply(null,arguments),links:h.apply(null,arguments)};return p(E),m(E),b(E),x(E),w(E),yo(E),E}g.update=function(E){return yo(E),E},g.nodeId=function(E){return arguments.length?(o=typeof E=="function"?E:Cr(E),g):o},g.nodeAlign=function(E){return arguments.length?(c=typeof E=="function"?E:Cr(E),g):c},g.nodeSort=function(E){return arguments.length?(l=E,g):l},g.nodeWidth=function(E){return arguments.length?(i=+E,g):i},g.nodePadding=function(E){return arguments.length?(s=a=+E,g):s},g.nodes=function(E){return arguments.length?(u=typeof E=="function"?E:Cr(E),g):u},g.links=function(E){return arguments.length?(h=typeof E=="function"?E:Cr(E),g):h},g.linkSort=function(E){return arguments.length?(d=E,g):d},g.size=function(E){return arguments.length?(r=e=0,t=+E[0],n=+E[1],g):[t-r,n-e]},g.extent=function(E){return arguments.length?(r=+E[0][0],t=+E[1][0],e=+E[0][1],n=+E[1][1],g):[[r,e],[t,n]]},g.iterations=function(E){return arguments.length?(f=+E,g):f};function p({nodes:E,links:F}){for(const[P,q]of E.entries())q.index=P,q.sourceLinks=[],q.targetLinks=[];const I=new Map(E.map((P,q)=>[o(P,q,E),P]));for(const[P,q]of F.entries()){q.index=P;let{source:N,target:D}=q;typeof N!="object"&&(N=q.source=xo(I,N)),typeof D!="object"&&(D=q.target=xo(I,D)),N.sourceLinks.push(q),D.targetLinks.push(q)}if(d!=null)for(const{sourceLinks:P,targetLinks:q}of E)P.sort(d),q.sort(d)}function m({nodes:E}){for(const F of E)F.value=F.fixedValue===void 0?Math.max(Fi(F.sourceLinks,Ni),Fi(F.targetLinks,Ni)):F.fixedValue}function b({nodes:E}){const F=E.length;let I=new Set(E),P=new Set,q=0;for(;I.size;){for(const N of I){N.depth=q;for(const{target:D}of N.sourceLinks)P.add(D)}if(++q>F)throw new Error("circular link");I=P,P=new Set}}function x({nodes:E}){const F=E.length;let I=new Set(E),P=new Set,q=0;for(;I.size;){for(const N of I){N.height=q;for(const{source:D}of N.targetLinks)P.add(D)}if(++q>F)throw new Error("circular link");I=P,P=new Set}}function v({nodes:E}){const F=_o(E,q=>q.depth)+1,I=(t-r-i)/(F-1),P=new Array(F);for(const q of E){const N=Math.max(0,Math.min(F-1,Math.floor(c.call(null,q,F))));q.layer=N,q.x0=r+N*I,q.x1=q.x0+i,P[N]?P[N].push(q):P[N]=[q]}if(l)for(const q of P)q.sort(l);return P}function _(E){const F=d0(E,I=>(n-e-(I.length-1)*a)/Fi(I,Ni));for(const I of E){let P=e;for(const q of I){q.y0=P,q.y1=P+q.value*F,P=q.y1+a;for(const N of q.sourceLinks)N.width=N.value*F}P=(n-P+a)/(I.length+1);for(let q=0;q<I.length;++q){const N=I[q];N.y0+=P*(q+1),N.y1+=P*(q+1)}M(I)}}function w(E){const F=v(E);a=Math.min(s,(n-e)/(_o(F,I=>I.length)-1)),_(F);for(let I=0;I<f;++I){const P=Math.pow(.99,I),q=Math.max(1-P,(I+1)/f);$(F,P,q),k(F,P,q)}}function k(E,F,I){for(let P=1,q=E.length;P<q;++P){const N=E[P];for(const D of N){let nt=0,lt=0;for(const{source:G,value:Pe}of D.targetLinks){let ee=Pe*(D.layer-G.layer);nt+=T(G,D)*ee,lt+=ee}if(!(lt>0))continue;let W=(nt/lt-D.y0)*F;D.y0+=W,D.y1+=W,C(D)}l===void 0&&N.sort(Mr),A(N,I)}}function $(E,F,I){for(let P=E.length,q=P-2;q>=0;--q){const N=E[q];for(const D of N){let nt=0,lt=0;for(const{target:G,value:Pe}of D.sourceLinks){let ee=Pe*(G.layer-D.layer);nt+=L(D,G)*ee,lt+=ee}if(!(lt>0))continue;let W=(nt/lt-D.y0)*F;D.y0+=W,D.y1+=W,C(D)}l===void 0&&N.sort(Mr),A(N,I)}}function A(E,F){const I=E.length>>1,P=E[I];y(E,P.y0-a,I-1,F),S(E,P.y1+a,I+1,F),y(E,n,E.length-1,F),S(E,e,0,F)}function S(E,F,I,P){for(;I<E.length;++I){const q=E[I],N=(F-q.y0)*P;N>1e-6&&(q.y0+=N,q.y1+=N),F=q.y1+a}}function y(E,F,I,P){for(;I>=0;--I){const q=E[I],N=(q.y1-F)*P;N>1e-6&&(q.y0-=N,q.y1-=N),F=q.y0-a}}function C({sourceLinks:E,targetLinks:F}){if(d===void 0){for(const{source:{sourceLinks:I}}of F)I.sort(bo);for(const{target:{targetLinks:I}}of E)I.sort(vo)}}function M(E){if(d===void 0)for(const{sourceLinks:F,targetLinks:I}of E)F.sort(bo),I.sort(vo)}function T(E,F){let I=E.y0-(E.sourceLinks.length-1)*a/2;for(const{target:P,width:q}of E.sourceLinks){if(P===F)break;I+=q+a}for(const{source:P,width:q}of F.targetLinks){if(P===E)break;I-=q}return I}function L(E,F){let I=F.y0-(F.targetLinks.length-1)*a/2;for(const{source:P,width:q}of F.targetLinks){if(P===E)break;I+=q+a}for(const{target:P,width:q}of E.sourceLinks){if(P===F)break;I-=q}return I}return g}var Ri=Math.PI,Di=2*Ri,we=1e-6,_0=Di-we;function Oi(){this._x0=this._y0=this._x1=this._y1=null,this._=""}function wo(){return new Oi}Oi.prototype=wo.prototype={constructor:Oi,moveTo:function(r,e){this._+="M"+(this._x0=this._x1=+r)+","+(this._y0=this._y1=+e)},closePath:function(){this._x1!==null&&(this._x1=this._x0,this._y1=this._y0,this._+="Z")},lineTo:function(r,e){this._+="L"+(this._x1=+r)+","+(this._y1=+e)},quadraticCurveTo:function(r,e,t,n){this._+="Q"+ +r+","+ +e+","+(this._x1=+t)+","+(this._y1=+n)},bezierCurveTo:function(r,e,t,n,i,s){this._+="C"+ +r+","+ +e+","+ +t+","+ +n+","+(this._x1=+i)+","+(this._y1=+s)},arcTo:function(r,e,t,n,i){r=+r,e=+e,t=+t,n=+n,i=+i;var s=this._x1,a=this._y1,o=t-r,c=n-e,l=s-r,d=a-e,u=l*l+d*d;if(i<0)throw new Error("negative radius: "+i);if(this._x1===null)this._+="M"+(this._x1=r)+","+(this._y1=e);else if(u>we)if(!(Math.abs(d*o-c*l)>we)||!i)this._+="L"+(this._x1=r)+","+(this._y1=e);else{var h=t-s,f=n-a,g=o*o+c*c,p=h*h+f*f,m=Math.sqrt(g),b=Math.sqrt(u),x=i*Math.tan((Ri-Math.acos((g+u-p)/(2*m*b)))/2),v=x/b,_=x/m;Math.abs(v-1)>we&&(this._+="L"+(r+v*l)+","+(e+v*d)),this._+="A"+i+","+i+",0,0,"+ +(d*h>l*f)+","+(this._x1=r+_*o)+","+(this._y1=e+_*c)}},arc:function(r,e,t,n,i,s){r=+r,e=+e,t=+t,s=!!s;var a=t*Math.cos(n),o=t*Math.sin(n),c=r+a,l=e+o,d=1^s,u=s?n-i:i-n;if(t<0)throw new Error("negative radius: "+t);this._x1===null?this._+="M"+c+","+l:(Math.abs(this._x1-c)>we||Math.abs(this._y1-l)>we)&&(this._+="L"+c+","+l),t&&(u<0&&(u=u%Di+Di),u>_0?this._+="A"+t+","+t+",0,1,"+d+","+(r-a)+","+(e-o)+"A"+t+","+t+",0,1,"+d+","+(this._x1=c)+","+(this._y1=l):u>we&&(this._+="A"+t+","+t+",0,"+ +(u>=Ri)+","+d+","+(this._x1=r+t*Math.cos(i))+","+(this._y1=e+t*Math.sin(i))))},rect:function(r,e,t,n){this._+="M"+(this._x0=this._x1=+r)+","+(this._y0=this._y1=+e)+"h"+ +t+"v"+ +n+"h"+-t+"Z"},toString:function(){return this._}};function ko(r){return function(){return r}}function v0(r){return r[0]}function b0(r){return r[1]}var x0=Array.prototype.slice;function y0(r){return r.source}function w0(r){return r.target}function k0(r){var e=y0,t=w0,n=v0,i=b0,s=null;function a(){var o,c=x0.call(arguments),l=e.apply(this,c),d=t.apply(this,c);if(s||(s=o=wo()),r(s,+n.apply(this,(c[0]=l,c)),+i.apply(this,c),+n.apply(this,(c[0]=d,c)),+i.apply(this,c)),o)return s=null,o+""||null}return a.source=function(o){return arguments.length?(e=o,a):e},a.target=function(o){return arguments.length?(t=o,a):t},a.x=function(o){return arguments.length?(n=typeof o=="function"?o:ko(+o),a):n},a.y=function(o){return arguments.length?(i=typeof o=="function"?o:ko(+o),a):i},a.context=function(o){return arguments.length?(s=o??null,a):s},a}function $0(r,e,t,n,i){r.moveTo(e,t),r.bezierCurveTo(e=(e+n)/2,t,e,i,n,i)}function A0(){return k0($0)}function S0(r){return[r.source.x1,r.y0]}function C0(r){return[r.target.x0,r.y1]}function M0(){return A0().source(S0).target(C0)}const E0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
  svg { display: block; width: 100%; }
...
`,Er=["#3b82f6","#ef4444"];class Q0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_nextClass",0)}static get observedAttributes(){return["data","model","resolution","interactive","c"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(J0),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector("svg");n&&(n.style.opacity="0",n.style.transition="opacity 0.6s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_build(){const t=this.jsonAttr("data",[{x:1,y:2,class:0},{x:2,y:3,class:0},{x:3,y:3,class:0},{x:1.5,y:1,class:0},{x:2.5,y:2,class:0},{x:5,y:5,class:1},{x:6,y:5,class:1},{x:5,y:6,class:1},{x:6,y:6,class:1},{x:5.5,y:4.5,class:1}]),n=this.getAttribute("model")||"linear",i=parseInt(this.getAttribute("resolution")||"50",10),s=this.hasAttribute("interactive"),a=parseFloat(this.getAttribute("c")||"1.0"),o=500,c=400,l={top:20,right:20,bottom:40,left:45},d=o-l.left-l.right,u=c-l.top-l.bottom;if(!t.length){this.render('<div class="db-container"></div>');return}const h=ne(t,L=>L.x),f=ne(t,L=>L.y),g=(h[1]-h[0])*.2||1,p=(f[1]-f[0])*.2||1,m=h[0]-g,b=h[1]+g,x=f[0]-p,v=f[1]+p,_=rt().domain([m,b]).range([0,d]),w=rt().domain([v,x]).range([0,u]),k=this._fitModel(t,n,a);let $="";const A=d/i,S=u/i;for(let L=0;L<i;L++)for(let E=0;E<i;E++){const F=m+(b-m)*(E+.5)/i,I=v-(v-x)*(L+.5)/i,P=k(F,I),q=Er[P>=.5?1:0];$+=`<rect x="${l.left+E*A}" y="${l.top+L*S}" width="${A+.5}" height="${S+.5}" fill="${q}" opacity="0.15"/>`}let y="";t.forEach(L=>{const E=l.left+_(L.x),F=l.top+w(L.y),I=Er[L.class];y+=`<circle class="point" cx="${E}" cy="${F}" r="5" fill="${I}"/>`});const C=_.ticks(6),M=w.ticks(6);let T="";if(C.forEach(L=>{const E=l.left+_(L);T+=`<g class="tick"><line x1="${E}" y1="${l.top+u}" x2="${E}" y2="${l.top+u+5}"/><text x="${E}" y="${l.top+u+18}" text-anchor="middle">${L}</text></g>`}),M.forEach(L=>{const E=l.top+w(L);T+=`<g class="tick"><line x1="${l.left-5}" y1="${E}" x2="${l.left}" y2="${E}"/><text x="${l.left-8}" y="${E+4}" text-anchor="end">${L}</text></g>`}),T+=`<line class="domain" x1="${l.left}" y1="${l.top}" x2="${l.left}" y2="${l.top+u}"/>`,T+=`<line class="domain" x1="${l.left}" y1="${l.top+u}" x2="${l.left+d}" y2="${l.top+u}"/>`,this.render(`<div class="db-container">
...
`;class R_ extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_allNodes",[]);z(this,"_root",null);z(this,"_steps",[]);z(this,"_stepIdx",-1);z(this,"_playing",!1);z(this,"_timer",null)}static get observedAttributes(){return["fn","n","speed","show-memo"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(N_),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector(".rt-container");n&&(n.style.opacity="0",n.style.transition="opacity 0.5s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearTimeout(this._timer)}_build(){const t=this.getAttribute("fn")||"fibonacci",n=parseInt(this.getAttribute("n")||"5",10),i=this.hasAttribute("show-memo");this._allNodes=[],this._root=this._buildTree(t,n),this._layoutTree(this._root),this._steps=[],this._stepIdx=-1,this._playing=!1;const s=new Map;this._generateSteps(this._root,s,i),this._allNodes.forEach(a=>a.state="hidden"),this._renderView()}_buildTree(t,n){const i=new Map,s=(c,l)=>{const d=`${c}(${l.join(",")})`,u={call:d,args:l,children:[],result:null,x:0,y:0,state:"hidden"};switch(this._allNodes.push(u),c){case"fibonacci":case"fib":{const h=l[0];if(h<=1)u.result=h;else{const f=s("fib",[h-1]),g=s("fib",[h-2]);u.children=[f,g],u.result=f.result+g.result}break}case"factorial":case"fact":{const h=l[0];if(h<=1)u.result=1;else{const f=s("fact",[h-1]);u.children=[f],u.result=h*f.result}break}case"power":case"pow":{const[h,f]=l.length>=2?l:[2,l[0]];if(f===0)u.result=1,u.call=`pow(${h},0)`;else if(f===1)u.result=h,u.call=`pow(${h},1)`;else{const g=Math.floor(f/2);u.call=`pow(${h},${f})`;const p=s("pow",[h,g]);if(f%2===0)u.children=[p],u.result=p.result*p.result;else{const m=s("pow",[h,f-1]);u.children=[m],u.result=h*m.result}}break}case"mergesort":case"ms":{const h=l[0];if(h<=1)u.result=h,u.call=`ms(${h})`;else{u.call=`ms(${h})`;const f=Math.floor(h/2),g=s("ms",[f]),p=s("ms",[h-f]);u.children=[g,p],u.result=h}break}default:u.result=n}return i.set(d,u.result),u};return s(t==="fibonacci"?"fib":t==="factorial"?"fact":t==="mergesort"?"ms":t==="power"?"pow":t,t==="power"?[2,n]:[n])}_layoutTree(t){let n=0;const i=(s,a)=>{if(s.y=a,s.children.length===0)s.x=n++;else{for(const o of s.children)i(o,a+1);s.x=s.children.reduce((o,c)=>o+c.x,0)/s.children.length}};i(t,0)}_generateSteps(t,n,i,s){const a=this._allNodes.indexOf(t);if(i&&n.has(t.call)){this._steps.push({nodeIdx:a,action:"show",edgeFrom:s}),this._steps.push({nodeIdx:a,action:"memo"});return}this._steps.push({nodeIdx:a,action:"show",edgeFrom:s}),this._steps.push({nodeIdx:a,action:"activate"});for(const o of t.children)this._generateSteps(o,n,i,a);this._steps.push({nodeIdx:a,action:"compute"}),i&&n.set(t.call,!0)}_doStep(){if(this._stepIdx>=this._steps.length-1){this._playing=!1,this._renderView();return}this._stepIdx++;const t=this._steps[this._stepIdx],n=this._allNodes[t.nodeIdx];switch(t.action){case"show":n.state="pending";break;case"activate":n.state="active";break;case"compute":n.state="computed";break;case"memo":n.state="memo";break}this._renderView()}_play(){if(this._playing){this._playing=!1,this._timer&&clearTimeout(this._timer),this._renderView();return}this._playing=!0;const t=parseInt(this.getAttribute("speed")||"400",10),n=()=>{if(!this._playing||this._stepIdx>=this._steps.length-1){this._playing=!1,this._renderView();return}this._doStep(),this._timer=setTimeout(n,t)};n()}_reset(){this._playing=!1,this._timer&&clearTimeout(this._timer),this._stepIdx=-1,this._allNodes.forEach(t=>t.state="hidden"),this._renderView()}_renderView(){var w,k,$;if(!this._root)return;const t=this._allNodes;let n=0,i=0;for(const A of t)A.x>n&&(n=A.x),A.y>i&&(i=A.y);const s=60,a=40,o=Math.max(70,Math.min(110,600/(n+1))),c=70,l=(n+1)*o+s*2,d=(i+1)*c+a*2,u=56,h=32,f=A=>s+A.x*o+o/2,g=A=>a+A.y*c+c/2;let p="";for(const A of t)if(A.state!=="hidden")for(const S of A.children){if(S.state==="hidden")continue;const y=S.state==="active",C=y?"var(--lv-accent)":"var(--lv-border)";p+=`<line x1="${f(A)}" y1="${g(A)+h/2}" x2="${f(S)}" y2="${g(S)-h/2}" stroke="${C}" stroke-width="${y?2:1.5}"/>`}let m="";const b={hidden:{fill:"transparent",stroke:"transparent"},pending:{fill:"var(--lv-bg-card)",stroke:"var(--lv-border)"},active:{fill:"rgba(59,130,246,0.15)",stroke:"#3b82f6"},computed:{fill:"rgba(34,197,94,0.15)",stroke:"#22c55e"},memo:{fill:"rgba(234,179,8,0.2)",stroke:"#eab308"}};for(const A of t){if(A.state==="hidden")continue;const S=f(A),y=g(A),C=b[A.state];m+=`<g>
    ...
    </div>`;this.render(_),(w=this.root.getElementById("btn-play"))==null||w.addEventListener("click",()=>this._play()),(k=this.root.getElementById("btn-step"))==null||k.addEventListener("click",()=>this._doStep()),($=this.root.getElementById("btn-reset"))==null||$.addEventListener("click",()=>this._reset())}_esc(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}customElements.define("lv-recursion-tree",R_),O.LvBaseElement=R,O.clamp=Fs,O.colorScale=Ns,O.formatNum=Rs,O.getToken=sc,O.lerp=ze,O.loadScript=Ds,O.loadStylesheet=ic,O.scrollAnimator=Gr,O.setTheme=ac,O.simColorScale=ec,O.uid=rc,Object.defineProperty(O,Symbol.toStringTag,{value:"Module"})}));
