(function(O,V){typeof exports=="object"&&typeof module<"u"?V(exports,require("roughjs"),require("three"),require("three/examples/jsm/controls/OrbitControls.js")):typeof define=="function"&&define.amd?define(["exports","roughjs","three","three/examples/jsm/controls/OrbitControls.js"],V):(O=typeof globalThis<"u"?globalThis:O||self,V(O.LearnViz={},O.rough,O.THREE,O.THREE))})(this,(function(O,V,at,sn){"use strict";var D_=Object.defineProperty;var Zl=O=>{throw TypeError(O)};var O_=(O,V,at)=>V in O?D_(O,V,{enumerable:!0,configurable:!0,writable:!0,value:at}):O[V]=at;var z=(O,V,at)=>O_(O,typeof V!="symbol"?V+"":V,at),Jl=(O,V,at)=>V.has(O)||Zl("Cannot "+at);var nn=(O,V,at)=>(Jl(O,V,"read from private field"),at?at.call(O):V.get(O)),Yr=(O,V,at)=>V.has(O)?Zl("Cannot add the same private member more than once"):V instanceof WeakSet?V.add(O):V.set(O,at),rn=(O,V,at,sn)=>(Jl(O,V,"write to private field"),sn?sn.call(O,at):V.set(O,at),at);var en,Bn,pe;function Ql(r){const e=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(r){for(const t in r)if(t!=="default"){const n=Object.getOwnPropertyDescriptor(r,t);Object.defineProperty(e,t,n.get?n:{enumerable:!0,get:()=>r[t]})}}return e.default=r,Object.freeze(e)}const j=Ql(at);class tc{constructor(){Yr(this,en);Yr(this,Bn,new WeakSet);rn(this,en,new IntersectionObserver(e=>{for(const t of e)if(t.isIntersecting&&!nn(this,Bn).has(t.target)){nn(this,Bn).add(t.target);const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches,i=t.target;typeof i.animateIn=="function"&&(n?i.animateIn(!0):i.animateIn(!1))}},{threshold:.15}))}observe(e){nn(this,en).observe(e)}unobserve(e){nn(this,en).unobserve(e)}}en=new WeakMap,Bn=new WeakMap;const Gr=new tc;class R extends HTMLElement{constructor(){super();z(this,"root");Yr(this,pe,!1);this.root=this.attachShadow({mode:"open"})}get dir(){var t;return((t=this.closest("[dir]"))==null?void 0:t.getAttribute("dir"))||document.documentElement.dir||"ltr"}get isRtl(){return this.dir==="rtl"}adoptStyles(t){const n=new CSSStyleSheet;n.replaceSync(t),this.root.adoptedStyleSheets=[...this.root.adoptedStyleSheets,n]}jsonAttr(t,n){const i=this.getAttribute(t);if(!i)return n;const s=i.replace(/\u2212/g,"-");try{return JSON.parse(s)}catch{return n}}render(t){rn(this,pe,!0),this.root.innerHTML=t,rn(this,pe,!1)}attributeChangedCallback(t,n,i){nn(this,pe)||(rn(this,pe,!0),this.handleAttributeChange(t,n,i),rn(this,pe,!1))}handleAttributeChange(t,n,i){}animateIn(t){}connectedCallback(){Gr.observe(this)}disconnectedCallback(){Gr.unobserve(this)}}pe=new WeakMap;function ze(r,e,t){return r+(e-r)*t}function qs(r,e,t){return Math.min(Math.max(r,e),t)}function Ns(r){r=qs(r,0,1);const e=r<.5?Math.round(ze(0,255,r*2)):255,t=r<.5?Math.round(ze(200,230,r*2)):Math.round(ze(230,50,(r-.5)*2)),n=r<.5?Math.round(ze(83,60,r*2)):Math.round(ze(60,80,(r-.5)*2));return`rgb(${e},${t},${n})`}function ec(r){return Ns((1-r)/2)}function Rs(r){return Number.isInteger(r)?r.toString():Math.abs(r)>=100?r.toFixed(0):Math.abs(r)>=1?r.toFixed(1):r.toFixed(2)}let nc=0;function rc(r="lv"){return`${r}-${++nc}`}const Wr=new Map,Ur=new Map;function Ds(r){let e=Wr.get(r);return e||(e=new Promise((t,n)=>{const i=document.createElement("script");i.src=r,i.onload=()=>t(),i.onerror=()=>{Wr.delete(r),n(new Error(`Failed to load ${r}`))},document.head.appendChild(i)}),Wr.set(r,e),e)}function ic(r){let e=Ur.get(r);return e||(e=new Promise((t,n)=>{const i=document.createElement("link");i.rel="stylesheet",i.href=r,i.onload=()=>t(),i.onerror=()=>{Ur.delete(r),n(new Error(`Failed to load ${r}`))},document.head.appendChild(i)}),Ur.set(r,e),e)}function sc(r,e){const t=e||document.documentElement;return getComputedStyle(t).getPropertyValue(`--lv-${r}`).trim()}function ac(r,e){r.setAttribute("data-theme",e)}const oc=`
  :host {
    display: block;
...
`;class lc extends R{static get observedAttributes(){return["theme","dir"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(oc),this._render()}handleAttributeChange(){this._render()}_render(){const e=this.getAttribute("dir")||"ltr";this.setAttribute("dir",e);const t=this.getAttribute("theme")||"dark";this.setAttribute("data-theme",t),this.render("<slot></slot>")}}customElements.define("lv-page",lc);const cc=`
  :host {
    display: block;
    position: relative;
    text-align: center;
...
`;class dc extends R{static get observedAttributes(){return["number","title","subtitle","gradient"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(cc),this._render()}handleAttributeChange(){this._render()}_render(){const e=this.getAttribute("number")||"",t=this.getAttribute("title")||"",n=this.getAttribute("subtitle")||"",i=this.getAttribute("gradient")||"",s=i?`background: ${i};`:"";this.render(`
...
`;class hc extends R{static get observedAttributes(){return["title"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(uc),this._render()}handleAttributeChange(){this._render()}_render(){const e=this.getAttribute("title")||"";this.render(`
      ${e?`<h2>${e}</h2>`:""}
      <slot></slot>
...
`;class pc extends R{static get observedAttributes(){return["variant"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(fc),this._render()}handleAttributeChange(){this._render()}_render(){this.root.querySelector(".card")||this.render('<div class="card"><slot></slot></div>')}}customElements.define("lv-card",pc);const gc=`
  :host {
    display: block;
  }
...
`;class mc extends R{static get observedAttributes(){return["cols","gap"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(gc),this._render()}handleAttributeChange(){this.root.querySelector(".grid")||this._render()}_render(){this.render('<div class="grid"><slot></slot></div>')}}customElements.define("lv-grid",mc);const _c=`
  :host {
    display: none;
  }
  :host([active]) {
...
`;class vc extends R{static get observedAttributes(){return["label","active"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(_c),this.render("<slot></slot>"),this.setAttribute("role","tabpanel")}handleAttributeChange(){}}customElements.define("lv-tab",vc);const bc=`
  :host {
    display: block;
  }
...
`;class xc extends R{constructor(){super(...arguments);z(this,"_tabs",[]);z(this,"_buttons",[]);z(this,"_activeIndex",0)}connectedCallback(){super.connectedCallback(),this.adoptStyles(bc),requestAnimationFrame(()=>this._setup())}_setup(){if(this._tabs=Array.from(this.querySelectorAll("lv-tab")),this._tabs.length===0)return;const t=this._tabs.findIndex(s=>s.hasAttribute("active"));this._activeIndex=t>=0?t:0;const n=this._tabs.map((s,a)=>{const o=s.getAttribute("label")||`Tab ${a+1}`,c=a===this._activeIndex;return`<button
        class="tab-btn"
        role="tab"
        aria-selected="${c}"
        tabindex="${c?"0":"-1"}"
...
`;class wc extends R{static get observedAttributes(){return["prev","prev-label","next","next-label"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(yc),this._render()}handleAttributeChange(){this._render()}_render(){const e=this.getAttribute("prev")||"",t=this.getAttribute("prev-label")||"Previous",n=this.getAttribute("next")||"",i=this.getAttribute("next-label")||"Next",s=this.isRtl,a=s?"→":"←",o=s?"←":"→";this.render(`
      <nav class="nav">
        <a class="prev" href="${e}">
...
`;class $c extends R{static get observedAttributes(){return["vs"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(kc),this._render()}handleAttributeChange(){this._render()}_render(){const e=this.getAttribute("vs"),t=e!==null,n=e||"VS";t?this.render(`
...
`,Sc=`
  <div class="val"></div>
  <div class="label"></div>
`;class Cc extends R{constructor(){super(...arguments);z(this,"_observer",null);z(this,"_animFrame",null)}static get observedAttributes(){return["value","label","prefix","suffix","color","animated"]}disconnectedCallback(){var t;super.disconnectedCallback(),this._animFrame!==null&&(cancelAnimationFrame(this._animFrame),this._animFrame=null),(t=this._observer)==null||t.disconnect(),this._observer=null}connectedCallback(){var t;(t=super.connectedCallback)==null||t.call(this),this.adoptStyles(Ac),this.render(Sc),this._update(),this._setupObserver()}handleAttributeChange(t,n,i){this.root.querySelector(".val")&&this._update()}_update(){const t=this.getAttribute("color");t&&(this.style.setProperty("--_color",t),this.style.setProperty("--_glow",t));const n=this.root.querySelector(".label");n&&(n.textContent=this.getAttribute("label")||"");const i=this.root.querySelector(".val");if(i){const s=this.getAttribute("prefix")||"",a=this.getAttribute("suffix")||"",o=this.getAttribute("value")||"";i.textContent=s+o+a}}_setupObserver(){this.hasAttribute("animated")&&(this._observer=new IntersectionObserver(t=>{var n;for(const i of t)i.isIntersecting&&(this.animateIn(!1),(n=this._observer)==null||n.unobserve(this))},{threshold:.1}),this._observer.observe(this))}animateIn(t){if(!this.hasAttribute("animated")||t)return;const n=parseFloat(this.getAttribute("value")||"0");if(isNaN(n))return;const i=1200,s=performance.now(),a=this.root.querySelector(".val"),o=c=>{const l=Math.min((c-s)/i,1),d=1-Math.pow(1-l,3),u=n*d;a.textContent=(this.getAttribute("prefix")||"")+Rs(u)+(this.getAttribute("suffix")||""),l<1&&(this._animFrame=requestAnimationFrame(o))};this._animFrame=requestAnimationFrame(o)}}customElements.define("lv-metric",Cc);const Os={info:{color:"var(--lv-info, #3b82f6)",icon:`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
...
`;class Ec extends R{static get observedAttributes(){return["type","title"]}connectedCallback(){var e;(e=super.connectedCallback)==null||e.call(this),this.adoptStyles(Mc),this._render()}handleAttributeChange(e,t,n){this.root.querySelector(".callout")&&this._render()}_getType(){const e=this.getAttribute("type");return Os[e]?e:"info"}_render(){const e=this._getType(),t=Os[e],n=this.getAttribute("title")||"";this.style.setProperty("--_type-color",t.color),this.style.setProperty("--_type-bg",`color-mix(in srgb, ${t.color} 8%, transparent)`);const i=`
...
`;class Pc extends R{static get observedAttributes(){return["color","variant"]}connectedCallback(){var e;(e=super.connectedCallback)==null||e.call(this),this.adoptStyles(Tc),this.render(Lc),this._updateColor()}handleAttributeChange(e,t,n){e==="color"&&this._updateColor()}_updateColor(){const e=this.getAttribute("color");e?this.style.setProperty("--_color",e):this.style.removeProperty("--_color")}}customElements.define("lv-badge",Pc);const zc=`
...
`,Bs="https://cdn.jsdelivr.net/npm/katex@0.16.9/dist/katex.min.css",Ic="https://cdn.jsdelivr.net/npm/katex@0.16.9/dist/katex.min.js";let Hn=null;function Fc(){return window.katex?Promise.resolve():Hn||(Hn=new Promise((r,e)=>{const t=document.createElement("link");t.rel="stylesheet",t.href=Bs,document.head.appendChild(t);const n=document.createElement("script");n.src=Ic,n.onload=()=>r(),n.onerror=()=>e(new Error("Failed to load KaTeX")),document.head.appendChild(n)}),Hn)}class qc extends R{constructor(){super(...arguments);z(this,"_source","")}connectedCallback(){var t,n;(t=super.connectedCallback)==null||t.call(this),this._source=((n=this.textContent)==null?void 0:n.trim())||"",this.adoptStyles(zc),this._render()}async _render(){try{await Fc();const t=this.hasAttribute("display"),n=window.katex.renderToString(this._source,{displayMode:t,throwOnError:!1});this.root.innerHTML=`<link rel="stylesheet" href="${Bs}"><span class="katex-container">${n}</span>`}catch{this.root.innerHTML=`<span class="fallback">${this._escapeHtml(this._source)}</span>`}}_escapeHtml(t){const n=document.createElement("span");return n.textContent=t,n.innerHTML}}customElements.define("lv-math",qc);const Nc=`
...
`,Rc="https://cdn.jsdelivr.net/npm/@highlightjs/cdn-assets@11.9.0/highlight.min.js",Hs="https://cdn.jsdelivr.net/npm/@highlightjs/cdn-assets@11.9.0/styles/github-dark.min.css";let jn=null;function Dc(){return window.hljs?Promise.resolve():jn||(jn=new Promise((r,e)=>{const t=document.createElement("link");t.rel="stylesheet",t.href=Hs,document.head.appendChild(t);const n=document.createElement("script");n.src=Rc,n.onload=()=>r(),n.onerror=()=>e(new Error("Failed to load highlight.js")),document.head.appendChild(n)}),jn)}class Oc extends R{constructor(){super(...arguments);z(this,"_source","")}static get observedAttributes(){return["language","line-numbers"]}connectedCallback(){var t,n;(t=super.connectedCallback)==null||t.call(this),this._source=((n=this.textContent)==null?void 0:n.trim())||"",this.adoptStyles(Nc),this._render()}async _render(){const t=this.getAttribute("language")||"",n=this.hasAttribute("line-numbers");let i;try{await Dc();const a=window.hljs;t&&a.getLanguage(t)?i=a.highlight(this._source,{language:t}).value:i=a.highlightAuto(this._source).value}catch{i=this._escapeHtml(this._source)}let s;n?s=i.split(`
`).map((o,c)=>`<span class="line-num">${c+1}</span>${o}`).join(`
`):s=i,this.root.innerHTML=`<link rel="stylesheet" href="${Hs}"><div class="code-block"><pre><code>${s}</code></pre></div>`}_escapeHtml(t){const n=document.createElement("span");return n.textContent=t,n.innerHTML}}customElements.define("lv-code",Oc);const Bc=`
...
`;class Vc extends R{constructor(){super(...arguments);z(this,"_sortState",{column:"",direction:"none"});z(this,"_currentPage",0);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["data","columns","sortable","show-stats","page-size","striped"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(jc),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector(".table-container");n&&(n.style.opacity="0",n.style.transform="translateY(10px)",n.style.transition="opacity 0.5s ease-out, transform 0.5s ease-out",requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="translateY(0)"}))}_build(){const t=this.jsonAttr("data",[]),n=this.hasAttribute("sortable"),i=this.hasAttribute("show-stats"),s=parseInt(this.getAttribute("page-size")||"0",10),a=this.hasAttribute("striped");if(!t.length){this.render('<div class="table-container"><table><tbody><tr><td style="padding:20px;text-align:center;color:var(--lv-text-dim)">No data</td></tr></tbody></table></div>');return}let o=this.jsonAttr("columns",[]);o.length||(o=Object.keys(t[0]));const c=new Set;for(const x of o)t.every(_=>{const w=_[x];return w==null||typeof w=="number"||typeof w=="string"&&w!==""&&!isNaN(Number(w))})&&c.add(x);let l=[...t];if(n&&this._sortState.direction!=="none"&&this._sortState.column){const x=this._sortState.column,v=this._sortState.direction==="asc"?1:-1,_=c.has(x);l.sort((w,k)=>{const $=w[x],A=k[x];return $==null&&A==null?0:$==null?1:A==null?-1:_?(Number($)-Number(A))*v:String($).localeCompare(String(A))*v})}const d=l.length,u=s>0?Math.ceil(d/s):1;this._currentPage>=u&&(this._currentPage=Math.max(0,u-1));const h=s>0?l.slice(this._currentPage*s,(this._currentPage+1)*s):l;let f="<tr>";for(const x of o){const v=this._getSortArrow(x);f+=`<th${n?' class="sortable"':""} data-col="${this._esc(x)}">${this._esc(x)}${v}</th>`}f+="</tr>";let g="";for(const x of h){g+="<tr>";for(const v of o){const _=x[v],w=c.has(v),k=w?' class="num-cell"':"",$=this._formatValue(_,w);g+=`<td${k}>${$}</td>`}g+="</tr>"}let p="";if(i){p="<tfoot><tr>";for(const x of o)if(c.has(x)){const v=t.map($=>Number($[x])).filter($=>!isNaN($)),_=v.reduce(($,A)=>$+A,0)/v.length,w=Math.min(...v),k=Math.max(...v);p+=`<td class="num-cell">${this._fmtSig(_)} (${this._fmtSig(w)}..${this._fmtSig(k)})</td>`}else{const v=new Set(t.map(_=>_[x])).size;p+=`<td>${v} unique</td>`}p+="</tr></tfoot>"}let m="";s>0&&u>1&&(m=`<div class="page-controls">
...
`;class Kc extends R{constructor(){super(...arguments);z(this,"_input",null);z(this,"_valueEl",null);z(this,"_popTimeout",null)}static get observedAttributes(){return["min","max","step","value","label","name","color"]}disconnectedCallback(){super.disconnectedCallback(),this._popTimeout&&(clearTimeout(this._popTimeout),this._popTimeout=null)}connectedCallback(){super.connectedCallback(),this.adoptStyles(Uc),this._render(),this._bind(),this._updateTrack()}handleAttributeChange(){this._input&&(this._render(),this._bind(),this._updateTrack())}get _min(){return parseFloat(this.getAttribute("min")||"0")}get _max(){return parseFloat(this.getAttribute("max")||"100")}get _step(){return this.getAttribute("step")||"1"}get _value(){return this.getAttribute("value")||"50"}get _label(){return this.getAttribute("label")||""}get _name(){return this.getAttribute("name")||""}get _color(){return this.getAttribute("color")||""}_render(){const t=this._color?`--fill-color: ${this._color};`:"";this.render(`
      <div class="header">
...
`;class Jc extends R{static get observedAttributes(){return[]}connectedCallback(){super.connectedCallback(),this.adoptStyles(Zc),this._render(),this._bind()}_render(){this.render(`
      <div class="layout">
        <div class="output">
...
`;class ed extends R{static get observedAttributes(){return["title"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(td),this._render()}handleAttributeChange(){this.root.querySelector(".title")&&this._render()}get _title(){return this.getAttribute("title")||""}_esc(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}_render(){this.render(`
...
`;class rd extends R{constructor(){super(...arguments);z(this,"_current",0);z(this,"_steps",[])}connectedCallback(){super.connectedCallback(),this.adoptStyles(nd),this._render(),requestAnimationFrame(()=>{this._steps=Array.from(this.querySelectorAll("lv-step")),this._showStep(0,null),this._bind()})}get _total(){return this._steps.length}_render(){this.render(`
      <div class="container">
    ...
    `)}_bind(){const t=this.root.querySelector(".prev"),n=this.root.querySelector(".next");t.addEventListener("click",()=>this._go(-1)),n.addEventListener("click",()=>this._go(1)),this.addEventListener("keydown",i=>{i.key==="ArrowRight"?(i.preventDefault(),this._go(this.isRtl?-1:1)):i.key==="ArrowLeft"&&(i.preventDefault(),this._go(this.isRtl?1:-1))}),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0")}_go(t){const n=this._current+t;n<0||n>=this._total||(this._current,this._current=n,this._showStep(n,t>0?"forward":"backward"))}_showStep(t,n){this._steps.forEach((c,l)=>{c.classList.remove("active","from-start","from-end"),l===t&&(c.classList.add("active"),n==="forward"?c.classList.add(this.isRtl?"from-start":"from-end"):n==="backward"&&c.classList.add(this.isRtl?"from-end":"from-start"))});const i=this.root.querySelector(".counter");i&&(i.textContent=`${js(t+1)} / ${js(this._total)}`);const s=this.root.querySelector(".steps");s&&s.setAttribute("aria-label",`Step ${t+1} of ${this._total}`);const a=this.root.querySelector(".prev"),o=this.root.querySelector(".next");a&&(a.disabled=t===0),o&&(o.disabled=t===this._total-1)}}customElements.define("lv-stepper",rd);const id=`
  :host {
    display: block;
    min-height: 80vh;
...
`;class sd extends R{connectedCallback(){super.connectedCallback(),this.adoptStyles(id),this.render("<slot></slot>")}}customElements.define("lv-scrolly-step",sd);const ad=`
  :host {
    display: block;
...
`;class od extends R{constructor(){super(...arguments);z(this,"_observer",null);z(this,"_steps",[])}static get observedAttributes(){return["sticky-side"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(ad),this._build(),requestAnimationFrame(()=>this._setupObserver())}disconnectedCallback(){super.disconnectedCallback(),this._observer&&(this._observer.disconnect(),this._observer=null)}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){}_build(){this.setAttribute("role","region"),this.setAttribute("aria-label","Scrollable narrative"),this.render(`
      <div class="scrolly-grid">
        <div class="viz-col"><slot name="viz"></slot></div>
        <div class="steps-col"><slot></slot></div>
      </div>
    `)}_setupObserver(){this._steps=Array.from(this.querySelectorAll("lv-scrolly-step")),this._steps.length&&(this._steps[0].classList.add("active"),this._steps[0].setAttribute("aria-current","step"),this.setAttribute("data-active-step","0"),this._observer=new IntersectionObserver(t=>{t.forEach(n=>{if(n.isIntersecting){const i=this._steps.indexOf(n.target);if(i===-1)return;this._steps.forEach(s=>{s.classList.remove("active"),s.removeAttribute("aria-current")}),n.target.classList.add("active"),n.target.setAttribute("aria-current","step"),this.setAttribute("data-active-step",String(i)),this.dispatchEvent(new CustomEvent("lv-scrolly-change",{detail:{step:i},bubbles:!0,composed:!0}))}})},{threshold:.5}),this._steps.forEach(t=>this._observer.observe(t)))}}customElements.define("lv-scrolly",od);const ld=`
  :host {
    display: block;
    margin: var(--lv-sp-4, 16px) 0;
  }
...
`;class cd extends R{constructor(){super(...arguments);z(this,"_order",[]);z(this,"_dragIndex",-1);z(this,"_clone",null);z(this,"_checked",!1);z(this,"_onPointerMove",null);z(this,"_onPointerUp",null)}static get observedAttributes(){return["items","correct","label","submit-label"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(ld),this._build()}disconnectedCallback(){super.disconnectedCallback(),this._cleanupDrag()}handleAttributeChange(){this.isConnected&&!this._checked&&this._build()}animateIn(t){}_build(){const t=this.jsonAttr("items",[]),n=this.getAttribute("label")||"Drag to reorder:",i=this.getAttribute("submit-label")||"Check";(!this._order.length||this._order.length!==t.length)&&(this._order=[...t]),this._checked=!1;const s=this._order.map((a,o)=>`
...
`;class ud extends R{constructor(){super(...arguments);z(this,"_placements",[]);z(this,"_categories",[]);z(this,"_dragIdx",-1);z(this,"_clone",null);z(this,"_checked",!1);z(this,"_onPointerMove",null);z(this,"_onPointerUp",null)}static get observedAttributes(){return["items","categories","submit-label"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(dd),this._build()}disconnectedCallback(){super.disconnectedCallback(),this._cleanupDrag()}handleAttributeChange(){this.isConnected&&!this._checked&&this._build()}animateIn(t){}_build(){const t=this.jsonAttr("items",[]);this._categories=this.jsonAttr("categories",[]);const n=this.getAttribute("submit-label")||"Check";(!this._placements.length||this._placements.length!==t.length)&&(this._placements=t.map(i=>({text:i.text,category:i.category,bucket:null}))),this._renderInner(n)}_renderInner(t){const n=this._placements.filter(o=>o.bucket===null),i=n.length===0?" empty-hint":"",s=n.map(o=>`<div class="chip" role="option" data-idx="${this._placements.indexOf(o)}">${this._esc(o.text)}<span class="tooltip"></span></div>`).join(""),a=this._categories.map((o,c)=>{const l=Vs[c%Vs.length],u=this._placements.filter(h=>h.bucket===o).map(h=>`<div class="chip" role="option" data-idx="${this._placements.indexOf(h)}">${this._esc(h.text)}<span class="tooltip"></span></div>`).join("");return`
...
`,kr=500,$r=300,Lt={top:20,right:30,bottom:40,left:50};class Ig extends R{constructor(){super(...arguments);z(this,"_userPoints",[]);z(this,"_revealed",!1);z(this,"_drawing",!1);z(this,"_hasAnimated",!1);z(this,"_xScale",null);z(this,"_yScale",null)}static get observedAttributes(){return["data","reveal-at","x-label","y-label","reveal-label"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(zg),this._build()}handleAttributeChange(){this.isConnected&&!this._revealed&&(this._userPoints=[],this._build())}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector(".actual-line");if(n){const i=n.getTotalLength();n.style.strokeDasharray=String(i),n.style.strokeDashoffset=String(i),n.style.transition="stroke-dashoffset 0.8s ease-out",requestAnimationFrame(()=>{n.style.strokeDashoffset="0"})}}_build(){const t=this.jsonAttr("data",[]),n=parseInt(this.getAttribute("reveal-at")||"0",10),i=this.getAttribute("x-label")||"",s=this.getAttribute("y-label")||"",a=this.getAttribute("reveal-label")||"Reveal";if(!t.length||n<=0){this.render('<div class="container"><em>No data</em></div>');return}const o=kr-Lt.left-Lt.right,c=$r-Lt.top-Lt.bottom,l=rt().domain([0,t.length-1]).range([0,o]),d=Math.min(...t),u=Math.max(...t),h=(u-d)*.1||1,f=rt().domain([d-h,u+h]).range([c,0]);this._xScale=l,this._yScale=f;const g=t.slice(0,n),p=re().x((y,C)=>l(C)).y(y=>f(y)).curve(bn)(g)||"",m=l.ticks(8),b=f.ticks(6);let x="";m.forEach(y=>{x+=`<line class="grid-line" x1="${l(y)}" y1="0" x2="${l(y)}" y2="${c}" />`}),b.forEach(y=>{x+=`<line class="grid-line" x1="0" y1="${f(y)}" x2="${o}" y2="${f(y)}" />`});let v="";m.forEach(y=>{v+=`<text class="axis-text" x="${l(y)}" y="${c+20}" text-anchor="middle">${Math.round(y)}</text>`});let _="";b.forEach(y=>{_+=`<text class="axis-text" x="-10" y="${f(y)+4}" text-anchor="end">${y.toFixed(1)}</text>`});const w=l(n-1),k=o-w,$=l(n-1),A=w+k/2,S=c/2;this.render(`
      <div class="container">
        <svg viewBox="0 0 ${kr} ${$r}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Draw your prediction chart">
...
`;class qg extends R{static get observedAttributes(){return["answer","accept"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(Fg),this._build()}handleAttributeChange(){}_build(){this.render(`
...
`;class Og extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_cards",[]);z(this,"_deck",[]);z(this,"_current",0);z(this,"_flipped",!1);z(this,"_ratings",[]);z(this,"_done",!1);z(this,"_storageKey","lv-flashcard");z(this,"_keyHandler",t=>{t.code==="Space"&&(t.preventDefault(),this._flip())})}static get observedAttributes(){return["cards","shuffle","persist"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(Dg),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector(".fc-container");n&&(n.style.opacity="0",n.style.transition="opacity 0.4s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_build(){if(this._cards=this.jsonAttr("cards",[]),this._ratings=[],this._done=!1,this._flipped=!1,this._current=0,!this._cards.length){this.render('<div class="fc-container"><p style="color:var(--lv-text-dim);text-align:center;">No cards provided.</p></div>');return}if(this._deck=this._cards.map((t,n)=>n),this.hasAttribute("shuffle"))for(let t=this._deck.length-1;t>0;t--){const n=Math.floor(Math.random()*(t+1));[this._deck[t],this._deck[n]]=[this._deck[n],this._deck[t]]}if(this.hasAttribute("persist"))try{const t=localStorage.getItem(this._storageKey);t&&(this._ratings=JSON.parse(t))}catch{}this._renderView(),this._attachKeyListener()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._keyHandler)}_attachKeyListener(){document.removeEventListener("keydown",this._keyHandler),document.addEventListener("keydown",this._keyHandler)}_flip(){if(this._done)return;this._flipped=!this._flipped;const t=this.root.querySelector(".card");t&&t.classList.toggle("flipped",this._flipped)}_rate(t){const n=this._deck[this._current];if(this._ratings.push({index:n,rating:t}),this.dispatchEvent(new CustomEvent("lv-flashcard-rate",{detail:{index:n,rating:t,front:this._cards[n].front},bubbles:!0,composed:!0})),t==="hard"){const i=Math.min(this._current+4,this._deck.length);this._deck.splice(i,0,n)}if(this.hasAttribute("persist"))try{localStorage.setItem(this._storageKey,JSON.stringify(this._ratings))}catch{}this._current++,this._flipped=!1,this._current>=this._deck.length&&(this._done=!0),this._renderView()}_reset(){if(this._ratings=[],this.hasAttribute("persist"))try{localStorage.removeItem(this._storageKey)}catch{}this._build()}_esc(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}_renderView(){var a,o,c,l,d;if(this._done){const u=this._ratings.filter(g=>g.rating==="easy").length,h=this._ratings.filter(g=>g.rating==="ok").length,f=this._ratings.filter(g=>g.rating==="hard").length;this.render(`<div class="fc-container" role="region" aria-label="Flashcard">
      ...
      </div>`),(a=this.root.getElementById("btn-reset"))==null||a.addEventListener("click",()=>this._reset());return}const t=this._deck[this._current],n=this._cards[t],i=this._deck.length,s=Math.round(this._current/i*100);this.render(`<div class="fc-container" role="region" aria-label="Flashcard">
      <div class="progress">
...
`;class Vg extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["code","language","run-label","editable","auto-run"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(jg),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector(".sb-container");n&&(n.style.opacity="0",n.style.transition="opacity 0.4s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_build(){var d;const t=this.getAttribute("code")||"",n=this.getAttribute("language")||"javascript",i=this.getAttribute("run-label")||"Run",s=!this.hasAttribute("editable")||this.getAttribute("editable")!=="false";this.render(`<div class="sb-container">
...
`;class Gg extends R{constructor(){super(...arguments);z(this,"_data",[]);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["data","direction","sorted"]}get data(){return this._data}set data(t){if(typeof t=="string")try{this._data=JSON.parse(t)}catch{this._data=[]}else this._data=t;this._buildChart()}connectedCallback(){super.connectedCallback(),this.adoptStyles(Yg),this._data=this.jsonAttr("data",[]),this._buildChart()}handleAttributeChange(t){t==="data"&&(this._data=this.jsonAttr("data",[])),this._buildChart()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;this.root.querySelectorAll(".bar-fill").forEach((i,s)=>{const a=i,o=a.dataset.width||"0%";a.classList.add("animate"),setTimeout(()=>{a.classList.remove("animate"),a.style.width=o},s*80+50)})}_getColor(t,n){return n.color?n.color:getComputedStyle(this).getPropertyValue(`--lv-chart-${t%8}`).trim()||Xg[t%8]}_buildChart(){const t=this.hasAttribute("sorted")?[...this._data].sort((o,c)=>c.value-o.value):[...this._data];if(!t.length){this.render('<div class="bar-list"></div>');return}const n=Math.max(...t.map(o=>o.value),.001),i=t.map((o,c)=>{const l=o.value/n*100,d=this._getColor(c,o),u=o.tagColor||d,h=typeof o.value=="number"?o.value%1?o.value.toFixed(2):o.value.toString():o.value;return`
      ...
      `}).join(""),a=`<table class="sr-table"><caption>Bar chart data</caption><thead><tr><th>Label</th><th>Value</th></tr></thead><tbody>${t.map(o=>`<tr><td>${this._esc(o.label)}</td><td>${typeof o.value=="number"?o.value%1?o.value.toFixed(2):o.value.toString():o.value}</td></tr>`).join("")}</tbody></table>`;this.render(`<div class="bar-list" role="img" aria-label="Bar chart">${i}</div>${a}`),this._hasAnimated&&this.root.querySelectorAll(".bar-fill").forEach(o=>{const c=o;c.style.width=c.dataset.width||"0%"})}_esc(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}}customElements.define("lv-bar-chart",Gg);const Wg=`
  :host { display: block; }
...
`;class Ug extends R{constructor(){super(...arguments);z(this,"_svg",null);z(this,"_animated",!0);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["labels","values","scale","animated"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(Wg),this._animated=this.getAttribute("animated")!=="false",this._buildChart()}handleAttributeChange(){this.isConnected&&this._buildChart()}animateIn(t){if(this._hasAnimated)return;this._hasAnimated=!0;const n=this._svg;if(!n)return;const i=n.querySelectorAll(".cell");if(t||!this._animated){i.forEach(s=>{s.style.opacity="1",s.style.transform="scale(1)"});return}i.forEach(s=>{const a=s,o=Number(a.dataset.delay||0);a.style.opacity="0",a.style.transform="scale(0.5)",a.style.transition="none",requestAnimationFrame(()=>{requestAnimationFrame(()=>{a.style.transition=`opacity 400ms ease-out ${o}ms, transform 400ms ease-out ${o}ms`,a.style.opacity="1",a.style.transform="scale(1)"})})})}_buildChart(){var v;const t=this.jsonAttr("labels",[]),n=this.jsonAttr("values",[]),i=this.getAttribute("scale")||"diverging";if(!t.length||!n.length){this.render("<svg></svg>");return}const s=t.length,a=3,o=60,c=110,l=56,d=s*l+(s-1)*a,u=d+c,h=d+o,f=i==="sequential"?Ei(Za).domain([0,1]):Wa(hg).domain([-1,0,1]),g=this.isRtl;let p="";for(let _=0;_<s;_++){const w=c+_*(l+a)+l/2,k=o/2;p+=`<text class="header-text" x="${g?u-w:w}" y="${k}">${this._escapeHtml(t[_])}</text>`}for(let _=0;_<s;_++){const w=o+_*(l+a)+l/2,k=g?u-c/2:c/2;p+=`<text class="header-text" x="${k}" y="${w}">${this._escapeHtml(t[_])}</text>`}for(let _=0;_<s;_++)for(let w=0;w<s;w++){const k=((v=n[_])==null?void 0:v[w])??0,$=f(k),A=this._contrastColor($),S=(_+w)*40;let y=c+w*(l+a);g&&(y=u-y-l);const C=o+_*(l+a),M=y+l/2,T=C+l/2;p+=`<g class="cell" data-delay="${S}" data-value="${k.toFixed(2)}" style="transform-origin: ${M}px ${T}px; opacity: 0; transform: scale(0.5);">`,p+=`<rect x="${y}" y="${C}" width="${l}" height="${l}" rx="6" ry="6" fill="${$}"/>`,p+=`<text class="cell-text" x="${M}" y="${T}" fill="${A}">${k.toFixed(2)}</text>`,p+="</g>"}let m="<tr><th></th>"+t.map(_=>`<th>${this._escapeHtml(_)}</th>`).join("")+"</tr>";for(let _=0;_<s;_++)m+=`<tr><th>${this._escapeHtml(t[_])}</th>`+(n[_]||[]).map(w=>`<td>${(w??0).toFixed(2)}</td>`).join("")+"</tr>";const b=`
      <div style="position: relative;">
        <svg viewBox="0 0 ${u} ${h}" role="img" aria-label="Heatmap">${p}</svg>
        <table class="sr-table"><caption>Heatmap data</caption>${m}</table>
        <div class="tooltip"></div>
      </div>
    `;this.render(b),this._svg=this.root.querySelector("svg");const x=this.root.querySelector(".tooltip");this._svg&&x&&this._svg.querySelectorAll(".cell").forEach(_=>{_.addEventListener("mouseenter",w=>{const $=w.currentTarget.dataset.value||"";x.textContent=$,x.style.opacity="1"}),_.addEventListener("mousemove",w=>{const k=w,$=this.root.querySelector("div").getBoundingClientRect();x.style.left=`${k.clientX-$.left+10}px`,x.style.top=`${k.clientY-$.top-28}px`}),_.addEventListener("mouseleave",()=>{x.style.opacity="0"})})}_contrastColor(t){const n=Gt(t);if(!n)return"#000";const i=n.rgb();return(.299*i.r+.587*i.g+.114*i.b)/255>.5?"#000":"#fff"}_escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}}customElements.define("lv-heatmap",Ug);const Kg=`
  :host { display: block; }
...
`,Be={top:20,right:30,bottom:40,left:60},lo=500,co=250,ye=lo-Be.left-Be.right,Kt=co-Be.top-Be.bottom;class Zg extends R{constructor(){super(...arguments);z(this,"_resizeObs",null);z(this,"_svg",null);z(this,"_built",!1)}static get observedAttributes(){return["data","area","points","tooltip","color","x-label","y-label","animated"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(Kg),this.root.innerHTML='<svg role="img" aria-label="Line chart"></svg>',this._buildChart(),this._resizeObs=new ResizeObserver(()=>{}),this._resizeObs.observe(this)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._resizeObs)==null||t.disconnect(),this._resizeObs=null}handleAttributeChange(t,n,i){this._built&&this._buildChart()}_parseData(){const t=this.jsonAttr("data",[]);return!Array.isArray(t)||t.length===0?[]:typeof t[0]=="number"?t.map((n,i)=>({x:i,y:n})):t}_getColor(){return this.getAttribute("color")||"var(--lv-accent, #3b82f6)"}_buildChart(){const t=this._parseData();if(t.length===0)return;const n=this.root.querySelector("svg");if(!n)return;const i=this._getColor(),s=this.hasAttribute("area"),a=this.hasAttribute("points"),o=this.hasAttribute("tooltip"),c=this.getAttribute("x-label")||"",l=this.getAttribute("y-label")||"";U(n).selectAll("*").remove();const d=U(n).attr("viewBox",`0 0 ${lo} ${co}`).attr("preserveAspectRatio","xMidYMid meet");this._svg=d;const u=d.append("defs"),h=`lv-area-grad-${Math.random().toString(36).slice(2,8)}`,f=u.append("linearGradient").attr("id",h).attr("x1","0").attr("y1","0").attr("x2","0").attr("y2","1");f.append("stop").attr("offset","0%").attr("stop-color",i).attr("stop-opacity",.25),f.append("stop").attr("offset","100%").attr("stop-color",i).attr("stop-opacity",0);const g=d.append("g").attr("transform",`translate(${Be.left},${Be.top})`),p=ne(t,y=>y.x),m=ne(t,y=>y.y),b=(m[1]-m[0])*.1||1,x=rt().domain(p).range([0,ye]),v=rt().domain([m[0]-b,m[1]+b]).range([Kt,0]);if(g.append("g").attr("class","grid").attr("transform",`translate(0,${Kt})`).call(Yn(x).tickSize(-Kt).tickFormat(()=>"")),g.append("g").attr("class","grid").call(Gn(v).tickSize(-ye).tickFormat(()=>"")),g.append("g").attr("class","axis x-axis").attr("transform",`translate(0,${Kt})`).call(Yn(x).ticks(6)),g.append("g").attr("class","axis y-axis").call(Gn(v).ticks(5)),c&&g.append("text").attr("class","axis-label").attr("x",ye/2).attr("y",Kt+35).attr("text-anchor","middle").text(c),l&&g.append("text").attr("class","axis-label").attr("x",-Kt/2).attr("y",-38).attr("transform","rotate(-90)").attr("text-anchor","middle").text(l),s){const y=kg().x(C=>x(C.x)).y0(Kt).y1(C=>v(C.y));g.append("path").datum(t).attr("class","area").attr("d",y).attr("fill",`url(#${h})`)}const _=re().x(y=>x(y.x)).y(y=>v(y.y)),w=g.append("path").datum(t).attr("class","line").attr("d",_).attr("stroke",i).attr("stroke-width",2.5),$=w.node().getTotalLength();w.attr("stroke-dasharray",$).attr("stroke-dashoffset",$),a&&g.selectAll(".point").data(t).enter().append("circle").attr("class","point").attr("cx",y=>x(y.x)).attr("cy",y=>v(y.y)).attr("r",4).attr("fill",i).attr("stroke","white").attr("stroke-width",1.5),o&&this._setupTooltip(g,t,x,v,i);let A=this.root.querySelector(".sr-table");A||(A=document.createElement("table"),A.className="sr-table",this.root.appendChild(A));const S=t.map(y=>`<tr><td>${y.x}</td><td>${y.y}</td></tr>`).join("");A.innerHTML=`<caption>Line chart data</caption><thead><tr><th>X</th><th>Y</th></tr></thead><tbody>${S}</tbody>`,this._built=!0,this.getAttribute("animated")==="false"&&this._showInstant()}_setupTooltip(t,n,i,s,a){const o=t.append("g").attr("class","tooltip-group").style("display","none");o.append("line").attr("class","crosshair crosshair-x").attr("y1",0).attr("y2",Kt),o.append("line").attr("class","crosshair crosshair-y").attr("x1",0).attr("x2",ye),o.append("circle").attr("r",5).attr("fill",a).attr("stroke","white").attr("stroke-width",2),o.append("rect").attr("class","tooltip-bg").attr("width",60).attr("height",24).attr("rx",6),o.append("text").attr("class","tooltip-text").attr("text-anchor","middle").attr("dy","0.35em");const c=Kr(l=>l.x).left;t.append("rect").attr("width",ye).attr("height",Kt).attr("fill","transparent").on("mousemove",l=>{const[d]=si(l),u=i.invert(d);let h=c(n,u,1);if(h>=n.length&&(h=n.length-1),h>0){const _=n[h-1],w=n[h];h=u-_.x>w.x-u?h:h-1}const f=n[h],g=i(f.x),p=s(f.y);o.style("display",null),o.select(".crosshair-x").attr("x1",g).attr("x2",g),o.select(".crosshair-y").attr("y1",p).attr("y2",p),o.select("circle").attr("cx",g).attr("cy",p);const m=60,b=24;let x=g-m/2,v=p-b-10;x<0&&(x=0),x+m>ye&&(x=ye-m),v<0&&(v=p+10),o.select(".tooltip-bg").attr("x",x).attr("y",v),o.select(".tooltip-text").attr("x",x+m/2).attr("y",v+b/2).text(`${f.y.toFixed(1)}`)}).on("mouseleave",()=>{o.style("display","none")})}_showInstant(){if(!this._svg)return;const t=this._svg.select("g");t.select(".line").attr("stroke-dashoffset",0),t.select(".area").classed("visible",!0),t.selectAll(".point").classed("visible",!0)}animateIn(t){var a;if(!this._svg)return;if(t||this.getAttribute("animated")==="false"){this._showInstant();return}const n=this._svg.select("g"),i=n.select(".line"),s=((a=i.node())==null?void 0:a.getTotalLength())||0;i.attr("stroke-dasharray",s).attr("stroke-dashoffset",s).transition().duration(1200).ease(mn).attr("stroke-dashoffset",0),n.select(".area").transition().delay(1500).duration(0).on("start",function(){U(this).classed("visible",!0)}),n.selectAll(".point").each(function(o,c){U(this).transition().delay(1500+c*50).duration(0).on("start",function(){U(this).classed("visible",!0)})})}}customElements.define("lv-line-chart",Zg);const Ar={sigmoid:r=>1/(1+Math.exp(-r)),relu:r=>Math.max(0,r),tanh:r=>Math.tanh(r),linear:r=>r},Jg=`
  :host { display: block; }
...
`,kt={top:20,right:20,bottom:50,left:55},po=500,Fi=400;class e0 extends R{constructor(){super(...arguments);z(this,"_data",[]);z(this,"_hasAnimated",!1);z(this,"_svg",null);z(this,"_container",null)}static get observedAttributes(){return["data","x-label","y-label","clusters","tooltip"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(t0),this._container=document.createElement("div"),this.root.appendChild(this._container),this._data=this.jsonAttr("data",[]),this._initSvg(),this._render(!1)}disconnectedCallback(){super.disconnectedCallback()}handleAttributeChange(t,n,i){n!==i&&(t==="data"&&(this._data=this.jsonAttr("data",[])),this._svg&&this._render(!1))}animateIn(t){this._hasAnimated||(this._hasAnimated=!0,t?this._render(!1):this._render(!0))}_getColor(t,n){return n.color?n.color:getComputedStyle(this).getPropertyValue(`--lv-chart-${t%8}`).trim()||fo[t%8]}_clusterColor(t){const i=[...new Set(this._data.map(o=>o.cluster).filter(o=>o!=null))].indexOf(t),s=i>=0?i:0;return getComputedStyle(this).getPropertyValue(`--lv-chart-${s%8}`).trim()||fo[s%8]}_initSvg(){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("role","img"),t.setAttribute("aria-label","Scatter plot"),this._container.appendChild(t),this._svg=U(t),this._svg.append("g").attr("class","grid-group"),this._svg.append("g").attr("class","axis-group"),this._svg.append("g").attr("class","points-group"),this._svg.append("g").attr("class","tooltip-group"),this._svg.append("g").attr("class","legend-group")}_render(t){if(!this._svg)return;const n=this._data,i=this.hasAttribute("clusters"),s=this.hasAttribute("tooltip"),a=this.getAttribute("x-label")||"",o=this.getAttribute("y-label")||"",c=i?[...new Set(n.map(P=>P.cluster).filter(P=>P!=null))]:[],l=c.length>0?30:0,d=Fi+l,u=po-kt.left-kt.right,h=Fi-kt.top-kt.bottom;this._svg.attr("viewBox",`0 0 ${po} ${d}`);const f=ne(n,P=>P.x),g=ne(n,P=>P.y),p=(f[1]-f[0])*.05||1,m=(g[1]-g[0])*.05||1,b=rt().domain([f[0]-p,f[1]+p]).range([0,u]),x=rt().domain([g[0]-m,g[1]+m]).range([h,0]),v=this._svg.select(".grid-group").attr("transform",`translate(${kt.left},${kt.top})`);v.selectAll("*").remove();const _=Yn(b).tickSize(-h).tickFormat(()=>"");v.append("g").attr("class","grid").attr("transform",`translate(0,${h})`).call(_);const w=Gn(x).tickSize(-u).tickFormat(()=>"");v.append("g").attr("class","grid").call(w);const k=this._svg.select(".axis-group").attr("transform",`translate(${kt.left},${kt.top})`);k.selectAll("*").remove(),k.append("g").attr("class","axis").attr("transform",`translate(0,${h})`).call(Yn(b).ticks(6)),k.append("g").attr("class","axis").call(Gn(x).ticks(6)),a&&k.append("text").attr("class","axis-label").attr("x",u/2).attr("y",h+38).attr("text-anchor","middle").text(a),o&&k.append("text").attr("class","axis-label").attr("x",-h/2).attr("y",-40).attr("text-anchor","middle").attr("transform","rotate(-90)").text(o);const $=this._svg.select(".points-group").attr("transform",`translate(${kt.left},${kt.top})`),A=this._svg.select(".tooltip-group").attr("transform",`translate(${kt.left},${kt.top})`);A.selectAll("*").remove();const S=A.append("g").attr("class","tooltip-box");S.append("rect").attr("class","tooltip-bg"),S.append("text").attr("class","tooltip-text");const y=$.selectAll(".point").data(n,(P,F)=>String(F));y.exit().remove();const C=y.enter().append("circle").attr("class","point").attr("cx",P=>b(P.x)).attr("cy",P=>x(P.y)).attr("r",5).attr("fill",(P,F)=>i&&P.cluster!=null?this._clusterColor(P.cluster):this._getColor(F,P)).attr("opacity",t?0:1).attr("transform",t?"scale(0)":"scale(1)").style("transform-origin",P=>`${b(P.x)}px ${x(P.y)}px`);s?C.on("mouseenter",(P,F)=>{var D;if(U(P.currentTarget).transition().duration(150).attr("r",6.5).attr("opacity",1),F.label){const nt=b(F.x),lt=x(F.y)-14;S.classed("visible",!0),S.select(".tooltip-text").attr("x",nt).attr("y",lt).text(F.label);const W=S.select(".tooltip-text").node(),G=((D=W==null?void 0:W.getComputedTextLength)==null?void 0:D.call(W))||40;S.select(".tooltip-bg").attr("x",nt-G/2-6).attr("y",lt-10).attr("width",G+12).attr("height",20)}}).on("mouseleave",P=>{U(P.currentTarget).transition().duration(150).attr("r",5).attr("opacity",.85),S.classed("visible",!1)}):C.on("mouseenter",P=>{U(P.currentTarget).transition().duration(150).attr("r",6.5)}).on("mouseleave",P=>{U(P.currentTarget).transition().duration(150).attr("r",5)});const M=C.merge(y);if(t?M.each(function(P,F){U(this).transition().delay(F*30).duration(400).ease(cp).attr("opacity",.85).attr("transform","scale(1)")}):M.attr("cx",P=>b(P.x)).attr("cy",P=>x(P.y)).attr("opacity",.85).attr("transform","scale(1)").attr("fill",(P,F)=>i&&P.cluster!=null?this._clusterColor(P.cluster):this._getColor(F,P)),this.hasAttribute("labels")||this.hasAttribute("tooltip")){const P=this._svg.select(".points-group");P.selectAll(".point-label").remove(),n.forEach((F,N)=>{if(!F.label)return;const D=P.append("text").attr("class","point-label").attr("x",b(F.x)+8).attr("y",x(F.y)+4).attr("fill","var(--lv-text, #e4e4ec)").attr("font-size","11px").attr("opacity",t?0:.9).text(F.label);t&&D.transition().delay(N*30+200).duration(300).attr("opacity",.9)})}const L=this._svg.select(".legend-group");if(L.selectAll("*").remove(),c.length>0){const P=Fi+5;let F=kt.left;for(const N of c){const D=this._clusterColor(N);L.append("circle").attr("cx",F+5).attr("cy",P+8).attr("r",4).attr("fill",D),L.append("text").attr("class","legend-text").attr("x",F+14).attr("y",P+8).attr("dominant-baseline","central").text(String(N)),F+=14+String(N).length*7+20}}let E=this._container.querySelector(".sr-table");E||(E=document.createElement("table"),E.className="sr-table",this._container.appendChild(E));const q=P=>P.replace(/&/g,"&amp;").replace(/</g,"&lt;"),I=n.map(P=>`<tr><td>${P.x}</td><td>${P.y}</td><td>${P.label?q(P.label):""}</td></tr>`).join("");E.innerHTML=`<caption>Scatter plot data</caption><thead><tr><th>X</th><th>Y</th><th>Label</th></tr></thead><tbody>${I}</tbody>`}}customElements.define("lv-scatter",e0);const n0=["#3b82f6","#8b5cf6","#06b6d4","#10b981","#f59e0b","#ef4444","#ec4899","#6366f1"],r0=`
  :host { display: block; }
  svg { width: 100%; display: block; direction: ltr; }
  .sr-table { position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0,0,0,0); border: 0; }
  ...
  .legend-swatch { rx: 5; }
`,yn=300,i0=130,go=26,mo=16;class s0 extends R{constructor(){super(...arguments);z(this,"_data",[]);z(this,"_hasAnimated",!1);z(this,"_svg",null);z(this,"_container",null)}static get observedAttributes(){return["data","donut","legend"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(r0),this._container=document.createElement("div"),this.root.appendChild(this._container),this._data=this.jsonAttr("data",[]),this._initSvg(),this._render(!1)}disconnectedCallback(){super.disconnectedCallback()}handleAttributeChange(t,n,i){n!==i&&(t==="data"&&(this._data=this.jsonAttr("data",[])),this._svg&&this._render(!1))}animateIn(t){this._hasAnimated||(this._hasAnimated=!0,t?this._render(!1):this._render(!0))}_getColor(t,n){return n.color?n.color:getComputedStyle(this).getPropertyValue(`--lv-chart-${t%8}`).trim()||n0[t%8]}_initSvg(){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("role","img"),t.setAttribute("aria-label","Pie chart"),this._container.appendChild(t),this._svg=U(t),this._svg.append("g").attr("class","arcs-group"),this._svg.append("g").attr("class","labels-group"),this._svg.append("g").attr("class","hover-group"),this._svg.append("g").attr("class","legend-group")}_render(t){if(!this._svg)return;const n=this._data,i=this.hasAttribute("donut"),s=this.hasAttribute("legend"),a=i0,o=i?a*.6:0,c=a+5,l=s?n.length:0,d=l>0?mo+l*go:0,u=yn+d;this._svg.attr("viewBox",`0 0 ${yn} ${u}`);const h=yn/2,f=yn/2,p=Sg().value(y=>y.value).sort(null).padAngle(.015)(n),m=to().innerRadius(o).outerRadius(a),b=to().innerRadius(o).outerRadius(c),x=this._svg.select(".arcs-group").attr("transform",`translate(${h},${f})`);x.selectAll("*").remove();const v=this._svg.select(".hover-group").attr("transform",`translate(${h},${f})`);v.selectAll("*").remove();const _=v.append("text").attr("class","hover-label").attr("x",0).attr("y",0),w=v.append("text").attr("class","hover-label").attr("x",0).attr("y",18).style("font-size","11px").style("font-weight","400");for(let y=0;y<p.length;y++){const C=p[y],M=this._getColor(y,C.data),T=x.append("path").attr("class","arc").attr("fill",M).attr("stroke","var(--lv-bg, #0f0f23)").attr("stroke-width",1.5);if(t){const L={...C,endAngle:C.startAngle};T.attr("d",m(L)).transition().delay(y*120).duration(800).ease(mn).attrTween("d",()=>{const E=_e(L,C);return q=>m(E(q))})}else T.attr("d",m(C));T.on("mouseenter",()=>{if(T.transition().duration(150).attr("d",b(C)),i)_.text(C.data.label).classed("visible",!0),w.text(String(C.data.value)).classed("visible",!0);else{const[L,E]=m.centroid(C);_.attr("x",L*1.6).attr("y",E*1.6-8).text(C.data.label).classed("visible",!0),w.attr("x",L*1.6).attr("y",E*1.6+8).text(String(C.data.value)).classed("visible",!0)}}).on("mouseleave",()=>{T.transition().duration(150).attr("d",m(C)),_.classed("visible",!1),w.classed("visible",!1)})}const k=this._svg.select(".labels-group").attr("transform",`translate(${h},${f})`);if(k.selectAll("*").remove(),!s)for(let y=0;y<p.length;y++){const C=p[y];if(C.endAngle-C.startAngle>.35){const[T,L]=m.centroid(C),E=k.append("text").attr("class","arc-label").attr("x",T).attr("y",L).text(C.data.label);t&&E.attr("opacity",0).transition().delay(y*120+600).duration(300).attr("opacity",1)}}let $=this._container.querySelector(".sr-table");$||($=document.createElement("table"),$.className="sr-table",this._container.appendChild($));const A=n.map(y=>`<tr><td>${y.label.replace(/&/g,"&amp;").replace(/</g,"&lt;")}</td><td>${y.value}</td></tr>`).join("");$.innerHTML=`<caption>Pie chart data</caption><thead><tr><th>Label</th><th>Value</th></tr></thead><tbody>${A}</tbody>`;const S=this._svg.select(".legend-group");if(S.selectAll("*").remove(),s&&n.length>0){const y=yn+mo;for(let C=0;C<n.length;C++){const T=y+C*go,L=this._getColor(C,n[C]);S.append("rect").attr("class","legend-swatch").attr("x",20).attr("y",T-5).attr("width",10).attr("height",10).attr("fill",L),S.append("text").attr("class","legend-text").attr("x",38).attr("y",T).attr("dominant-baseline","central").text(`${n[C].label} (${n[C].value})`)}}}}customElements.define("lv-pie",s0);const a0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
...
`;class o0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["labels","values","normalize","show-metrics"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(a0),this._buildChart()}handleAttributeChange(){this.isConnected&&this._buildChart()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelectorAll(".cell");n.forEach((i,s)=>{const a=i,o=Math.floor(s/Math.sqrt(n.length)),c=s%Math.sqrt(n.length),l=(o+c)*40;a.style.transition="none",a.style.opacity="0",a.style.transform="scale(0.5)",requestAnimationFrame(()=>requestAnimationFrame(()=>{a.style.transition=`opacity 400ms ease-out ${l}ms, transform 400ms ease-out ${l}ms`,a.style.opacity="1",a.style.transform="scale(1)"}))})}_buildChart(){const t=this.jsonAttr("labels",[]),n=this.jsonAttr("values",[]),i=this.hasAttribute("normalize"),s=this.hasAttribute("show-metrics");if(!t.length||!n.length){this.render('<div class="cm-container"></div>');return}const a=t.length,o=i?n.map(y=>{const C=y.reduce((M,T)=>M+T,0);return C>0?y.map(M=>M/C):y}):n,c=Math.max(...o.flat()),l=56,d=3,u=70,h=80,f=s?60:0,g=s?40:0,p=a*l+(a-1)*d,m=p,b=h+p+f,x=u+m+g,v=this.isRtl,_=Ei(Za).domain([0,c||1]),w=y=>{const C=Gt(_(y));if(!C)return"#fff";const{r:M,g:T,b:L}=C.rgb();return M*.299+T*.587+L*.114>150?"#111":"#fff"};let k="";for(let y=0;y<a;y++){const C=h+y*(l+d)+l/2;k+=`<text class="header-text" x="${v?b-C:C}" y="${u-8}"
        text-anchor="middle">${this._esc(t[y])}</text>`}for(let y=0;y<a;y++){const C=u+y*(l+d)+l/2,M=v?b-h/2:h/2;k+=`<text class="header-text" x="${M}" y="${C}"
        text-anchor="middle" dominant-baseline="central">${this._esc(t[y])}</text>`}for(let y=0;y<a;y++)for(let C=0;C<a;C++){const M=o[y][C],T=n[y][C],L=h+C*(l+d),E=u+y*(l+d),q=v?b-L-l:L,I=_(M),P=w(M),F=i?(M*100).toFixed(0)+"%":String(T);k+=`<g class="cell">
          ...
          <text class="cell-text" x="${q+l/2}" y="${E+l/2}"
            ...
            fill="${P}">${F}</text>
        </g>`}if(s){for(let y=0;y<a;y++){const C=n[y][y],M=n.reduce((q,I)=>q+I[y],0),T=M>0?(C/M*100).toFixed(0)+"%":"-",L=h+y*(l+d)+l/2,E=v?b-L:L;k+=`<text class="metric-text" x="${E}" y="${u+m+25}"
          text-anchor="middle" fill="var(--lv-positive)">${T}</text>`}for(let y=0;y<a;y++){const C=n[y][y],M=n[y].reduce((q,I)=>q+I,0),T=M>0?(C/M*100).toFixed(0)+"%":"-",L=u+y*(l+d)+l/2,E=v?h/2-20:h+p+10;k+=`<text class="metric-text" x="${E}" y="${L}"
          text-anchor="start" dominant-baseline="central" fill="var(--lv-accent)">${T}</text>`}}const $=v?b-12:12,A=u+m/2;k+=`<text class="axis-label" x="${$}" y="${A}"
      text-anchor="middle" dominant-baseline="central"
      transform="rotate(-90, ${$}, ${A})">Actual</text>`,k+=`<text class="axis-label" x="${h+p/2}" y="${x-2}"
      text-anchor="middle">Predicted</text>`;let S="<tr><th></th>"+t.map(y=>`<th>${this._esc(y)}</th>`).join("")+"</tr>";for(let y=0;y<a;y++)S+=`<tr><th>${this._esc(t[y])}</th>`+n[y].map(C=>`<td>${C}</td>`).join("")+"</tr>";this.render(`<div class="cm-container">
...
`,wn=560,Sr=280,ht={top:30,right:60,bottom:40,left:55};class c0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["loss","accuracy","lr","x-label","tooltip"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(l0),this._buildChart()}handleAttributeChange(){this.isConnected&&this._buildChart()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;this.root.querySelectorAll(".metric-line").forEach(i=>{const s=i,a=s.getTotalLength();s.style.strokeDasharray=String(a),s.style.strokeDashoffset=String(a),s.style.transition=`stroke-dashoffset 1.2s ${s.dataset.idx||"0"}s ease-out`,requestAnimationFrame(()=>{s.style.strokeDashoffset="0"})})}_buildChart(){const t=this.jsonAttr("loss",[]),n=this.jsonAttr("accuracy",[]),i=this.jsonAttr("lr",[]),s=this.getAttribute("x-label")||"Epoch";this.hasAttribute("tooltip");const a=Math.max(t.length,n.length,i.length);if(a===0){this.render('<div class="td-container"></div>');return}const o=wn-ht.left-ht.right,c=Sr-ht.top-ht.bottom,l=rt().domain([0,a-1]).range([0,o]),d=Math.max(t.length?Math.max(...t):0,n.length?Math.max(...n):1)*1.1,u=rt().domain([0,d]).range([c,0]),h=i.length>0,f=h?Math.max(...i)*1.2:1,g=rt().domain([0,f]).range([c,0]),p=($,A)=>re().x((S,y)=>ht.left+l(y)).y(S=>ht.top+A(S)).curve(bn)($)||"",m=[];t.length&&m.push({name:"Loss",color:"var(--lv-negative)",data:t,axis:"left"}),n.length&&m.push({name:"Accuracy",color:"var(--lv-positive)",data:n,axis:"left"}),h&&m.push({name:"Learning Rate",color:"var(--lv-accent2)",data:i,axis:"right"});const b=m.map($=>`<div class="legend-item"><div class="legend-dot" style="background:${$.color}"></div>${$.name}</div>`).join("");let x="";const v=u.ticks(5);v.forEach($=>{const A=ht.top+u($);x+=`<line class="grid-line" x1="${ht.left}" x2="${wn-ht.right}" y1="${A}" y2="${A}"/>`});let _="";v.forEach($=>{const A=ht.top+u($);_+=`<text class="axis-text" x="${ht.left-8}" y="${A}" text-anchor="end" dominant-baseline="central">${$.toFixed(2)}</text>`}),h&&g.ticks(4).forEach($=>{const A=ht.top+g($);_+=`<text class="axis-text" x="${wn-ht.right+8}" y="${A}" text-anchor="start" dominant-baseline="central">${$.toFixed(4)}</text>`}),l.ticks(Math.min(a,10)).forEach($=>{const A=ht.left+l($);_+=`<text class="axis-text" x="${A}" y="${Sr-ht.bottom+20}" text-anchor="middle">${Math.round($)}</text>`}),_+=`<text class="axis-text" x="${wn/2}" y="${Sr-4}" text-anchor="middle">${s}</text>`;let k="";m.forEach(($,A)=>{const S=$.axis==="left"?u:g,y=p($.data,S);k+=`<path class="metric-line" d="${y}" stroke="${$.color}" data-idx="${A*.3}"/>`}),this.render(`
    ...
    `)}}customElements.define("lv-train-dashboard",c0);function _o(r,e){let t;if(e===void 0)for(const n of r)n!=null&&(t<n||t===void 0&&n>=n)&&(t=n);else{let n=-1;for(let i of r)(i=e(i,++n,r))!=null&&(t<i||t===void 0&&i>=i)&&(t=i)}return t}function d0(r,e){let t;if(e===void 0)for(const n of r)n!=null&&(t>n||t===void 0&&n>=n)&&(t=n);else{let n=-1;for(let i of r)(i=e(i,++n,r))!=null&&(t>i||t===void 0&&i>=i)&&(t=i)}return t}function qi(r,e){let t=0;if(e===void 0)for(let n of r)(n=+n)&&(t+=n);else{let n=-1;for(let i of r)(i=+e(i,++n,r))&&(t+=i)}return t}function u0(r){return r.depth}function h0(r,e){return r.sourceLinks.length?r.depth:e-1}function Cr(r){return function(){return r}}function vo(r,e){return Mr(r.source,e.source)||r.index-e.index}function bo(r,e){return Mr(r.target,e.target)||r.index-e.index}function Mr(r,e){return r.y0-e.y0}function Ni(r){return r.value}function f0(r){return r.index}function p0(r){return r.nodes}function g0(r){return r.links}function xo(r,e){const t=r.get(e);if(!t)throw new Error("missing: "+e);return t}function yo({nodes:r}){for(const e of r){let t=e.y0,n=t;for(const i of e.sourceLinks)i.y0=t+i.width/2,t+=i.width;for(const i of e.targetLinks)i.y1=n+i.width/2,n+=i.width}}function m0(){let r=0,e=0,t=1,n=1,i=24,s=8,a,o=f0,c=h0,l,d,u=p0,h=g0,f=6;function g(){const E={nodes:u.apply(null,arguments),links:h.apply(null,arguments)};return p(E),m(E),b(E),x(E),w(E),yo(E),E}g.update=function(E){return yo(E),E},g.nodeId=function(E){return arguments.length?(o=typeof E=="function"?E:Cr(E),g):o},g.nodeAlign=function(E){return arguments.length?(c=typeof E=="function"?E:Cr(E),g):c},g.nodeSort=function(E){return arguments.length?(l=E,g):l},g.nodeWidth=function(E){return arguments.length?(i=+E,g):i},g.nodePadding=function(E){return arguments.length?(s=a=+E,g):s},g.nodes=function(E){return arguments.length?(u=typeof E=="function"?E:Cr(E),g):u},g.links=function(E){return arguments.length?(h=typeof E=="function"?E:Cr(E),g):h},g.linkSort=function(E){return arguments.length?(d=E,g):d},g.size=function(E){return arguments.length?(r=e=0,t=+E[0],n=+E[1],g):[t-r,n-e]},g.extent=function(E){return arguments.length?(r=+E[0][0],t=+E[1][0],e=+E[0][1],n=+E[1][1],g):[[r,e],[t,n]]},g.iterations=function(E){return arguments.length?(f=+E,g):f};function p({nodes:E,links:q}){for(const[P,F]of E.entries())F.index=P,F.sourceLinks=[],F.targetLinks=[];const I=new Map(E.map((P,F)=>[o(P,F,E),P]));for(const[P,F]of q.entries()){F.index=P;let{source:N,target:D}=F;typeof N!="object"&&(N=F.source=xo(I,N)),typeof D!="object"&&(D=F.target=xo(I,D)),N.sourceLinks.push(F),D.targetLinks.push(F)}if(d!=null)for(const{sourceLinks:P,targetLinks:F}of E)P.sort(d),F.sort(d)}function m({nodes:E}){for(const q of E)q.value=q.fixedValue===void 0?Math.max(qi(q.sourceLinks,Ni),qi(q.targetLinks,Ni)):q.fixedValue}function b({nodes:E}){const q=E.length;let I=new Set(E),P=new Set,F=0;for(;I.size;){for(const N of I){N.depth=F;for(const{target:D}of N.sourceLinks)P.add(D)}if(++F>q)throw new Error("circular link");I=P,P=new Set}}function x({nodes:E}){const q=E.length;let I=new Set(E),P=new Set,F=0;for(;I.size;){for(const N of I){N.height=F;for(const{source:D}of N.targetLinks)P.add(D)}if(++F>q)throw new Error("circular link");I=P,P=new Set}}function v({nodes:E}){const q=_o(E,F=>F.depth)+1,I=(t-r-i)/(q-1),P=new Array(q);for(const F of E){const N=Math.max(0,Math.min(q-1,Math.floor(c.call(null,F,q))));F.layer=N,F.x0=r+N*I,F.x1=F.x0+i,P[N]?P[N].push(F):P[N]=[F]}if(l)for(const F of P)F.sort(l);return P}function _(E){const q=d0(E,I=>(n-e-(I.length-1)*a)/qi(I,Ni));for(const I of E){let P=e;for(const F of I){F.y0=P,F.y1=P+F.value*q,P=F.y1+a;for(const N of F.sourceLinks)N.width=N.value*q}P=(n-P+a)/(I.length+1);for(let F=0;F<I.length;++F){const N=I[F];N.y0+=P*(F+1),N.y1+=P*(F+1)}M(I)}}function w(E){const q=v(E);a=Math.min(s,(n-e)/(_o(q,I=>I.length)-1)),_(q);for(let I=0;I<f;++I){const P=Math.pow(.99,I),F=Math.max(1-P,(I+1)/f);$(q,P,F),k(q,P,F)}}function k(E,q,I){for(let P=1,F=E.length;P<F;++P){const N=E[P];for(const D of N){let nt=0,lt=0;for(const{source:G,value:Pe}of D.targetLinks){let ee=Pe*(D.layer-G.layer);nt+=T(G,D)*ee,lt+=ee}if(!(lt>0))continue;let W=(nt/lt-D.y0)*q;D.y0+=W,D.y1+=W,C(D)}l===void 0&&N.sort(Mr),A(N,I)}}function $(E,q,I){for(let P=E.length,F=P-2;F>=0;--F){const N=E[F];for(const D of N){let nt=0,lt=0;for(const{target:G,value:Pe}of D.sourceLinks){let ee=Pe*(G.layer-D.layer);nt+=L(D,G)*ee,lt+=ee}if(!(lt>0))continue;let W=(nt/lt-D.y0)*q;D.y0+=W,D.y1+=W,C(D)}l===void 0&&N.sort(Mr),A(N,I)}}function A(E,q){const I=E.length>>1,P=E[I];y(E,P.y0-a,I-1,q),S(E,P.y1+a,I+1,q),y(E,n,E.length-1,q),S(E,e,0,q)}function S(E,q,I,P){for(;I<E.length;++I){const F=E[I],N=(q-F.y0)*P;N>1e-6&&(F.y0+=N,F.y1+=N),q=F.y1+a}}function y(E,q,I,P){for(;I>=0;--I){const F=E[I],N=(F.y1-q)*P;N>1e-6&&(F.y0-=N,F.y1-=N),q=F.y0-a}}function C({sourceLinks:E,targetLinks:q}){if(d===void 0){for(const{source:{sourceLinks:I}}of q)I.sort(bo);for(const{target:{targetLinks:I}}of E)I.sort(vo)}}function M(E){if(d===void 0)for(const{sourceLinks:q,targetLinks:I}of E)q.sort(bo),I.sort(vo)}function T(E,q){let I=E.y0-(E.sourceLinks.length-1)*a/2;for(const{target:P,width:F}of E.sourceLinks){if(P===q)break;I+=F+a}for(const{source:P,width:F}of q.targetLinks){if(P===E)break;I-=F}return I}function L(E,q){let I=q.y0-(q.targetLinks.length-1)*a/2;for(const{source:P,width:F}of q.targetLinks){if(P===E)break;I+=F+a}for(const{target:P,width:F}of E.sourceLinks){if(P===q)break;I-=F}return I}return g}var Ri=Math.PI,Di=2*Ri,we=1e-6,_0=Di-we;function Oi(){this._x0=this._y0=this._x1=this._y1=null,this._=""}function wo(){return new Oi}Oi.prototype=wo.prototype={constructor:Oi,moveTo:function(r,e){this._+="M"+(this._x0=this._x1=+r)+","+(this._y0=this._y1=+e)},closePath:function(){this._x1!==null&&(this._x1=this._x0,this._y1=this._y0,this._+="Z")},lineTo:function(r,e){this._+="L"+(this._x1=+r)+","+(this._y1=+e)},quadraticCurveTo:function(r,e,t,n){this._+="Q"+ +r+","+ +e+","+(this._x1=+t)+","+(this._y1=+n)},bezierCurveTo:function(r,e,t,n,i,s){this._+="C"+ +r+","+ +e+","+ +t+","+ +n+","+(this._x1=+i)+","+(this._y1=+s)},arcTo:function(r,e,t,n,i){r=+r,e=+e,t=+t,n=+n,i=+i;var s=this._x1,a=this._y1,o=t-r,c=n-e,l=s-r,d=a-e,u=l*l+d*d;if(i<0)throw new Error("negative radius: "+i);if(this._x1===null)this._+="M"+(this._x1=r)+","+(this._y1=e);else if(u>we)if(!(Math.abs(d*o-c*l)>we)||!i)this._+="L"+(this._x1=r)+","+(this._y1=e);else{var h=t-s,f=n-a,g=o*o+c*c,p=h*h+f*f,m=Math.sqrt(g),b=Math.sqrt(u),x=i*Math.tan((Ri-Math.acos((g+u-p)/(2*m*b)))/2),v=x/b,_=x/m;Math.abs(v-1)>we&&(this._+="L"+(r+v*l)+","+(e+v*d)),this._+="A"+i+","+i+",0,0,"+ +(d*h>l*f)+","+(this._x1=r+_*o)+","+(this._y1=e+_*c)}},arc:function(r,e,t,n,i,s){r=+r,e=+e,t=+t,s=!!s;var a=t*Math.cos(n),o=t*Math.sin(n),c=r+a,l=e+o,d=1^s,u=s?n-i:i-n;if(t<0)throw new Error("negative radius: "+t);this._x1===null?this._+="M"+c+","+l:(Math.abs(this._x1-c)>we||Math.abs(this._y1-l)>we)&&(this._+="L"+c+","+l),t&&(u<0&&(u=u%Di+Di),u>_0?this._+="A"+t+","+t+",0,1,"+d+","+(r-a)+","+(e-o)+"A"+t+","+t+",0,1,"+d+","+(this._x1=c)+","+(this._y1=l):u>we&&(this._+="A"+t+","+t+",0,"+ +(u>=Ri)+","+d+","+(this._x1=r+t*Math.cos(i))+","+(this._y1=e+t*Math.sin(i))))},rect:function(r,e,t,n){this._+="M"+(this._x0=this._x1=+r)+","+(this._y0=this._y1=+e)+"h"+ +t+"v"+ +n+"h"+-t+"Z"},toString:function(){return this._}};function ko(r){return function(){return r}}function v0(r){return r[0]}function b0(r){return r[1]}var x0=Array.prototype.slice;function y0(r){return r.source}function w0(r){return r.target}function k0(r){var e=y0,t=w0,n=v0,i=b0,s=null;function a(){var o,c=x0.call(arguments),l=e.apply(this,c),d=t.apply(this,c);if(s||(s=o=wo()),r(s,+n.apply(this,(c[0]=l,c)),+i.apply(this,c),+n.apply(this,(c[0]=d,c)),+i.apply(this,c)),o)return s=null,o+""||null}return a.source=function(o){return arguments.length?(e=o,a):e},a.target=function(o){return arguments.length?(t=o,a):t},a.x=function(o){return arguments.length?(n=typeof o=="function"?o:ko(+o),a):n},a.y=function(o){return arguments.length?(i=typeof o=="function"?o:ko(+o),a):i},a.context=function(o){return arguments.length?(s=o??null,a):s},a}function $0(r,e,t,n,i){r.moveTo(e,t),r.bezierCurveTo(e=(e+n)/2,t,e,i,n,i)}function A0(){return k0($0)}function S0(r){return[r.source.x1,r.y0]}function C0(r){return[r.target.x0,r.y1]}function M0(){return A0().source(S0).target(C0)}const E0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
  svg { display: block; width: 100%; }
...
`,P0=["#3b82f6","#8b5cf6","#06b6d4","#22c55e","#f59e0b","#ef4444","#ec4899","#6366f1"];class z0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["data","roughness"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(L0),this._buildChart()}handleAttributeChange(){this.isConnected&&this._buildChart()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector("canvas");n&&(n.style.opacity="0",n.style.transition="opacity 0.6s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_buildChart(){const t=this.jsonAttr("data",[]),n=parseFloat(this.getAttribute("roughness")||"2");if(!t.length){this.render('<div class="sketch-container"></div>');return}const i=500,s=300,a={top:20,right:20,bottom:40,left:50};this.render(`<div class="sketch-container">
    ...
    </div>`);const o=this.root.querySelector("canvas");if(!o)return;const c=V.canvas(o),l=o.getContext("2d");if(!l)return;l.scale(2,2);const d=Math.max(...t.map(m=>m.value),.001),u=i-a.left-a.right,h=s-a.top-a.bottom,f=u/t.length*.7,g=u/t.length*.3;c.line(a.left,s-a.bottom,i-a.right,s-a.bottom,{roughness:n*.5,stroke:"#888"}),c.line(a.left,a.top,a.left,s-a.bottom,{roughness:n*.5,stroke:"#888"});const p=this.isRtl;t.forEach((m,b)=>{const x=m.value/d*h,v=p?t.length-1-b:b,_=a.left+v*(f+g)+g/2,w=s-a.bottom-x,k=m.color||`var(--lv-chart-${b%8})`,$=k.startsWith("var(")?P0[b%8]:k;c.rectangle(_,w,f,x,{roughness:n,fill:$,fillStyle:"hachure",hachureGap:6,stroke:$,strokeWidth:1.5})}),l.font="11px sans-serif",l.fillStyle="#888",l.textAlign="right";for(let m=0;m<=4;m++){const b=d*m/4,x=s-a.bottom-m/4*h;l.fillText(b.toFixed(1),a.left-8,x+4)}}_esc(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}customElements.define("lv-sketch-bar",z0);const I0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
  canvas { display: block; width: 100%; }
`,Ao=["#3b82f6","#8b5cf6","#06b6d4","#22c55e","#f59e0b","#ef4444","#ec4899","#6366f1"];class F0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["data","x-label","y-label","color","area","roughness"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(I0),this._buildChart()}handleAttributeChange(){this.isConnected&&this._buildChart()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector("canvas");n&&(n.style.opacity="0",n.style.transition="opacity 0.6s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_buildChart(){const t=this.jsonAttr("data",[]),n=this.getAttribute("x-label")||"",i=this.getAttribute("y-label")||"",s=this.getAttribute("color")||"",a=this.hasAttribute("area"),o=parseFloat(this.getAttribute("roughness")||"2");if(!t.length){this.render("<canvas></canvas>");return}const c=typeof t[0]=="number"?t.map((M,T)=>({x:T,y:M})):t,l=500,d=260,u={top:20,right:20,bottom:40,left:55};this.render(`<canvas width="${l*2}" height="${d*2}" style="width:${l}px;height:${d}px;"></canvas>`);const h=this.root.querySelector("canvas");if(!h)return;const f=V.canvas(h),g=h.getContext("2d");if(!g)return;g.scale(2,2);const p=c.map(M=>M.x),m=c.map(M=>M.y),b=Math.min(...p),x=Math.max(...p),v=Math.min(0,Math.min(...m)),_=Math.max(...m)*1.1,w=l-u.left-u.right,k=d-u.top-u.bottom,$=M=>u.left+(M-b)/(x-b||1)*w,A=M=>u.top+(1-(M-v)/(_-v||1))*k,S=s.startsWith("var(")?Ao[0]:s||Ao[0];if(f.line(u.left,d-u.bottom,l-u.right,d-u.bottom,{roughness:o*.5,stroke:"#888"}),f.line(u.left,u.top,u.left,d-u.bottom,{roughness:o*.5,stroke:"#888"}),a){const M=[[$(c[0].x),A(v)],...c.map(T=>[$(T.x),A(T.y)]),[$(c[c.length-1].x),A(v)]];f.polygon(M,{roughness:o*.3,fill:S,fillStyle:"hachure",hachureGap:8,hachureAngle:60,stroke:"none",fillWeight:.5})}const y=c.map(M=>[$(M.x),A(M.y)]);f.curve(y,{roughness:o,stroke:S,strokeWidth:2.5}),c.forEach(M=>{f.circle($(M.x),A(M.y),6,{roughness:o*.5,fill:S,fillStyle:"solid",stroke:S})}),g.font="11px sans-serif",g.fillStyle="#888",g.textAlign="center",n&&g.fillText(n,l/2,d-4),i&&(g.save(),g.translate(12,d/2),g.rotate(-Math.PI/2),g.fillText(i,0,0),g.restore()),g.textAlign="right";for(let M=0;M<=4;M++){const T=v+(_-v)*M/4;g.fillText(T.toFixed(2),u.left-8,A(T)+4)}g.textAlign="center";const C=Math.ceil(c.length/8);for(let M=0;M<c.length;M+=C)g.fillText(String(c[M].x),$(c[M].x),d-u.bottom+16)}}customElements.define("lv-sketch-line",F0);const q0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
...
`,Bi=["#3b82f6","#8b5cf6","#06b6d4","#22c55e","#f59e0b","#ef4444","#ec4899","#6366f1"];class N0 extends R{constructor(){super(...arguments);z(this,"_raf",null);z(this,"_renderer",null)}static get observedAttributes(){return["data","x-label","y-label","z-label","clusters","auto-rotate","tooltip"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(q0),this._buildScene()}disconnectedCallback(){super.disconnectedCallback(),this._raf&&cancelAnimationFrame(this._raf),this._renderer&&(this._renderer.dispose(),this._renderer=null)}handleAttributeChange(){this.isConnected&&this._buildScene()}_buildScene(){this._raf&&(cancelAnimationFrame(this._raf),this._raf=null),this._renderer&&(this._renderer.dispose(),this._renderer=null);const t=this.jsonAttr("data",[]);this.getAttribute("x-label"),this.getAttribute("y-label"),this.getAttribute("z-label");const n=this.hasAttribute("clusters"),i=this.hasAttribute("auto-rotate");if(this.render('<div class="scene-container" id="scene"></div>'),!t.length)return;const s=this.root.getElementById("scene");if(!s)return;const a=s.clientWidth||500,o=s.clientHeight||375,c=new j.Scene;c.background=new j.Color(getComputedStyle(this).getPropertyValue("--lv-bg-raised").trim()||"#12122a");const l=new j.PerspectiveCamera(50,a/o,.1,100);l.position.set(2.5,2,2.5),l.lookAt(0,0,0);const d=new j.WebGLRenderer({antialias:!0});d.setSize(a,o),d.setPixelRatio(window.devicePixelRatio),s.appendChild(d.domElement),this._renderer=d;const u=new sn.OrbitControls(l,d.domElement);u.enableDamping=!0,u.dampingFactor=.05,u.autoRotate=i,u.autoRotateSpeed=1;const h=t.map(T=>T.x),f=t.map(T=>T.y),g=t.map(T=>T.z),p=T=>{const L=Math.min(...T),q=Math.max(...T)-L||1;return T.map(I=>(I-L)/q*2-1)},m=p(h),b=p(f),x=p(g),v=[...new Set(t.map(T=>T.cluster||""))],_=T=>{const L=v.indexOf(T);return new j.Color(Bi[L%Bi.length])},w=new j.BufferGeometry,k=new Float32Array(t.length*3),$=new Float32Array(t.length*3);t.forEach((T,L)=>{k[L*3]=m[L],k[L*3+1]=b[L],k[L*3+2]=x[L];const E=n?_(T.cluster||""):new j.Color(Bi[0]);$[L*3]=E.r,$[L*3+1]=E.g,$[L*3+2]=E.b}),w.setAttribute("position",new j.BufferAttribute(k,3)),w.setAttribute("color",new j.BufferAttribute($,3));const A=new j.PointsMaterial({size:.06,vertexColors:!0,sizeAttenuation:!0});c.add(new j.Points(w,A));const S=1.2,y=[16729156,4521796,4474111];[[S,0,0],[0,S,0],[0,0,S]].forEach(([T,L,E],q)=>{const I=[new j.Vector3(0,0,0),new j.Vector3(T,L,E)],P=new j.BufferGeometry().setFromPoints(I),F=new j.LineBasicMaterial({color:y[q],opacity:.4,transparent:!0});c.add(new j.Line(P,F))});const C=new j.GridHelper(2,10,3355477,2236996);C.position.y=-1,c.add(C);const M=()=>{this._raf=requestAnimationFrame(M),u.update(),d.render(c,l)};M()}}customElements.define("lv-scatter-3d",N0);const R0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
  .scene-container { width: 100%; aspect-ratio: 4/3; border-radius: var(--lv-r-md); overflow: hidden; background: var(--lv-bg-raised); }
  canvas { display: block; width: 100% !important; height: 100% !important; }
`;class D0 extends R{constructor(){super(...arguments);z(this,"_raf",null);z(this,"_renderer",null)}static get observedAttributes(){return["data","x-label","y-label","z-label","color-scale","wireframe","auto-rotate"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(R0),this._buildScene()}disconnectedCallback(){super.disconnectedCallback(),this._raf&&cancelAnimationFrame(this._raf),this._renderer&&(this._renderer.dispose(),this._renderer=null)}handleAttributeChange(){this.isConnected&&this._buildScene()}_buildScene(){this._raf&&(cancelAnimationFrame(this._raf),this._raf=null),this._renderer&&(this._renderer.dispose(),this._renderer=null);const t=this.jsonAttr("data",[]),n=this.hasAttribute("wireframe"),i=this.hasAttribute("auto-rotate");if(this.render('<div class="scene-container" id="scene"></div>'),!t.length||!t[0].length)return;const s=this.root.getElementById("scene");if(!s)return;const a=s.clientWidth||500,o=s.clientHeight||375,c=t.length,l=t[0].length,d=t.flat(),u=Math.min(...d),f=Math.max(...d)-u||1,g=new j.Scene;g.background=new j.Color(getComputedStyle(this).getPropertyValue("--lv-bg-raised").trim()||"#12122a");const p=new j.PerspectiveCamera(50,a/o,.1,100);p.position.set(2.5,2.5,2.5),p.lookAt(0,0,0);const m=new j.WebGLRenderer({antialias:!0});m.setSize(a,o),m.setPixelRatio(window.devicePixelRatio),s.appendChild(m.domElement),this._renderer=m;const b=new sn.OrbitControls(p,m.domElement);b.enableDamping=!0,b.autoRotate=i,b.autoRotateSpeed=.8;const x=new j.PlaneGeometry(2,2,l-1,c-1),v=x.attributes.position,_=new Float32Array(v.count*3);for(let A=0;A<c;A++)for(let S=0;S<l;S++){const y=A*l+S,C=(t[A][S]-u)/f;v.setZ(y,C-.5);const M=C;let T,L,E;M<.25?(T=0,L=M*4,E=1):M<.5?(T=0,L=1,E=1-(M-.25)*4):M<.75?(T=(M-.5)*4,L=1,E=0):(T=1,L=1-(M-.75)*4,E=0),_[y*3]=T,_[y*3+1]=L,_[y*3+2]=E}x.setAttribute("color",new j.BufferAttribute(_,3)),x.computeVertexNormals(),x.rotateX(-Math.PI/2);const w=n?new j.MeshBasicMaterial({vertexColors:!0,wireframe:!0}):new j.MeshPhongMaterial({vertexColors:!0,side:j.DoubleSide,flatShading:!0});if(g.add(new j.Mesh(x,w)),!n){g.add(new j.AmbientLight(16777215,.4));const A=new j.DirectionalLight(16777215,.8);A.position.set(3,5,3),g.add(A)}const k=new j.GridHelper(2,10,3355477,2236996);k.position.y=-.5,g.add(k);const $=()=>{this._raf=requestAnimationFrame($),b.update(),m.render(g,p)};$()}}customElements.define("lv-surface-3d",D0);const O0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
...
`;class G0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1)}static get observedAttributes(){return["type","params","shade-from","shade-to","show-stats"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(Y0),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector(".dist-area"),i=this.root.querySelector(".dist-line");n&&(n.style.opacity="0",n.style.transition="opacity 0.6s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"})),i&&(i.style.opacity="0",i.style.transition="opacity 0.6s ease-out 0.1s",requestAnimationFrame(()=>{i.style.opacity="1"}))}_build(){const t=this.getAttribute("type")||"normal",n=this.hasAttribute("shade-from")?parseFloat(this.getAttribute("shade-from")):null,i=this.hasAttribute("shade-to")?parseFloat(this.getAttribute("shade-to")):null,s=this.hasAttribute("show-stats"),a=500,o=300,c={top:20,right:30,bottom:40,left:50},l=a-c.left-c.right,d=o-c.top-c.bottom,u=t==="poisson"||t==="binomial",{points:h,range:f,mean:g,std:p,mode:m}=this._computeDistribution(t);if(!h.length){this.render('<div class="dist-container"></div>');return}const b=rt().domain(f).range([0,l]),x=Math.max(...h.map(A=>A.y))*1.15,v=rt().domain([0,x]).range([d,0]);let _="";const w=v.ticks(5);for(const A of w)_+=`<line x1="0" y1="${v(A)}" x2="${l}" y2="${v(A)}" stroke="var(--lv-border)" stroke-opacity="0.3" stroke-dasharray="3,3"/>`;if(u){const A=Math.max(2,Math.min(20,l/h.length*.7));if(n!==null||i!==null){let S=0;for(const y of h)(n!==null&&i!==null?y.x>=n&&y.x<=i:n!==null?y.x>=n:i!==null?y.x<=i:!1)&&(_+=`<rect x="${b(y.x)-A/2}" y="${v(y.y)}" width="${A}" height="${d-v(y.y)}" fill="var(--lv-accent)" opacity="0.3"/>`,S+=y.y);_+=`<text class="shade-label" x="${l/2}" y="-4" text-anchor="middle">P = ${S.toFixed(4)}</text>`}for(const S of h)_+=`<rect x="${b(S.x)-A/2}" y="${v(S.y)}" width="${A}" height="${d-v(S.y)}" fill="var(--lv-accent)" opacity="0.6" stroke="var(--lv-accent)" stroke-width="1"/>`}else{const A=this._areaPath(h,b,v,d),S=this._linePath(h,b,v);if(n!==null||i!==null){const y=n??f[0],C=i??f[1],M=h.filter(T=>T.x>=y&&T.x<=C);if(M.length>1){const T=this._areaPath(M,b,v,d);_+=`<path d="${T}" fill="var(--lv-accent)" opacity="0.3"/>`;let L=0;for(let I=1;I<M.length;I++)L+=(M[I].x-M[I-1].x)*(M[I].y+M[I-1].y)/2;const E=b((y+C)/2),q=v(Math.max(...M.map(I=>I.y))/2);_+=`<text class="shade-label" x="${E}" y="${Math.min(q,d-10)}" text-anchor="middle">P = ${L.toFixed(4)}</text>`}}_+=`<path class="dist-area" d="${A}" fill="var(--lv-accent)" opacity="0.15"/>`,_+=`<path class="dist-line" d="${S}" fill="none" stroke="var(--lv-accent)" stroke-width="2"/>`}const k=b.ticks(8);for(const A of k)_+=`<g class="axis" transform="translate(${b(A)},${d})">
        <line y2="5" stroke="var(--lv-border)"/>
        <text y="18" text-anchor="middle">${this._fmtNum(A)}</text>
      </g>`;_+=`<line x1="0" y1="${d}" x2="${l}" y2="${d}" stroke="var(--lv-border)"/>`;for(const A of w)_+=`<g class="axis" transform="translate(0,${v(A)})">
        <line x2="-5" stroke="var(--lv-border)"/>
        <text x="-8" text-anchor="end" dominant-baseline="central">${this._fmtNum(A)}</text>
      </g>`;_+=`<line x1="0" y1="0" x2="0" y2="${d}" stroke="var(--lv-border)"/>`;let $="";s&&($=`<div class="stats-row">
...
`;class U0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_points",[]);z(this,"_dragging",null);z(this,"_svgEl",null);z(this,"_xScale");z(this,"_yScale");z(this,"_margin",{top:20,right:30,bottom:40,left:50})}static get observedAttributes(){return["data","degree","interactive","show-r2","show-equation"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(W0),this._points=this.jsonAttr("data",[]),this._build()}handleAttributeChange(t){t==="data"&&(this._points=this.jsonAttr("data",[])),this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector("svg");n&&(n.style.opacity="0",n.style.transition="opacity 0.6s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_build(){const t=Math.max(1,Math.min(5,parseInt(this.getAttribute("degree")||"1",10))),n=this.hasAttribute("interactive"),i=this.hasAttribute("show-r2"),s=this.hasAttribute("show-equation"),a=this._points,o=500,c=350,l=this._margin,d=o-l.left-l.right,u=c-l.top-l.bottom;if(!a.length){this._xScale=rt().domain([0,10]).range([0,d]),this._yScale=rt().domain([0,10]).range([u,0]),this.render(`<div class="reg-container">
      ...
      </div>`),n&&this._attachInteraction();return}const h=ne(a,k=>k.x),f=ne(a,k=>k.y),g=(h[1]-h[0])*.15||1,p=(f[1]-f[0])*.15||1,m=rt().domain([h[0]-g,h[1]+g]).range([0,d]),b=rt().domain([f[0]-p,f[1]+p]).range([u,0]);this._xScale=m,this._yScale=b;let x="";for(const k of m.ticks(8))x+=`<line class="gridline" x1="${m(k)}" y1="0" x2="${m(k)}" y2="${u}"/>`;for(const k of b.ticks(6))x+=`<line class="gridline" x1="0" y1="${b(k)}" x2="${d}" y2="${b(k)}"/>`;const v=Math.min(t,a.length-1),_=this._fitPolynomial(a,v);if(_.length){const k=[];for(let A=0;A<=200;A++){const S=m.domain()[0]+(m.domain()[1]-m.domain()[0])*A/200,y=this._evalPoly(_,S);k.push(`${A===0?"M":"L"}${m(S)},${b(y)}`)}x+=`<path d="${k.join("")}" fill="none" stroke="var(--lv-accent2)" stroke-width="2.5" stroke-linecap="round"/>`}for(let k=0;k<a.length;k++){const $=a[k];x+=`<circle class="point" data-idx="${k}" cx="${m($.x)}" cy="${b($.y)}" r="6" fill="var(--lv-accent)" stroke="#fff" stroke-width="2"/>`}for(const k of m.ticks(8))x+=`<g class="axis" transform="translate(${m(k)},${u})">
        <line y2="5"/><text y="18" text-anchor="middle">${this._fmtNum(k)}</text>
      </g>`;x+=`<line x1="0" y1="${u}" x2="${d}" y2="${u}" stroke="var(--lv-border)"/>`;for(const k of b.ticks(6))x+=`<g class="axis" transform="translate(0,${b(k)})">
        <line x2="-5"/><text x="-8" text-anchor="end" dominant-baseline="central">${this._fmtNum(k)}</text>
      </g>`;x+=`<line x1="0" y1="0" x2="0" y2="${u}" stroke="var(--lv-border)"/>`;let w="";if(i||s){if(w='<div class="info-row">',i&&_.length){const k=this._computeR2(a,_),$=k>.8?"var(--lv-positive)":k>.5?"var(--lv-warning)":"var(--lv-negative)";w+=`<span class="r2-text" style="color:${$}">R² = ${k.toFixed(4)}</span>`}s&&_.length&&(w+=`<span class="eq-text">${this._formatEquation(_)}</span>`),w+="</div>"}this.render(`<div class="reg-container">
...
`,So={quadratic:{fn:(r,e)=>r*r+e*e,range:[-3,3]},rosenbrock:{fn:(r,e)=>(1-r)**2+100*(e-r*r)**2,range:[-2,2]},himmelblau:{fn:(r,e)=>(r*r+e-11)**2+(r+e*e-7)**2,range:[-5,5]},saddle:{fn:(r,e)=>r*r-e*e,range:[-3,3]}};class Z0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_animFrame",null);z(this,"_timer",null)}static get observedAttributes(){return["fn","optimizer","lr","start","show-path","speed"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(K0),this._build()}handleAttributeChange(){this.isConnected&&this._build()}disconnectedCallback(){super.disconnectedCallback(),this._stopAnimation()}animateIn(t){this._hasAnimated||(this._hasAnimated=!0,t||this._runOptimization())}_stopAnimation(){this._animFrame&&(cancelAnimationFrame(this._animFrame),this._animFrame=null),this._timer&&(clearTimeout(this._timer),this._timer=null)}_build(){this._stopAnimation(),this._hasAnimated=!1;const t=400,n=400;this.render(`<div class="gd-container">
    ...
    </div>`),this._drawContour()}_getFnConfig(){const t=this.getAttribute("fn")||"quadratic",n=So[t]||So.quadratic;return{fnName:t,...n}}_drawContour(){const t=this.root.getElementById("gd-canvas");if(!t)return;const n=t.getContext("2d");if(!n)return;const i=400,s=400;n.clearRect(0,0,i*2,s*2),n.save(),n.scale(2,2);const{fn:a,range:o}=this._getFnConfig(),[c,l]=o,d=200,u=[];let h=1/0,f=-1/0;for(let _=0;_<d;_++){u[_]=[];for(let w=0;w<d;w++){const k=c+(l-c)*w/(d-1),$=c+(l-c)*_/(d-1),A=a(k,$);u[_][w]=A,A<h&&(h=A),A>f&&(f=A)}}const g=Math.log(1+h-h),m=Math.log(1+f-h)-g||1,b=i/d,x=s/d;for(let _=0;_<d;_++)for(let w=0;w<d;w++){const k=Math.log(1+u[_][w]-h)/m;n.fillStyle=this._contourColor(k),n.fillRect(w*b,_*x,b+.5,x+.5)}const v=15;n.strokeStyle="rgba(255,255,255,0.15)",n.lineWidth=.5;for(let _=0;_<v;_++){const w=h+(f-h)*(_/v);this._drawContourLine(n,u,w,d,i,s)}n.fillStyle="rgba(255,255,255,0.6)",n.font="11px sans-serif",n.textAlign="center",n.fillText(String(c),20,s-5),n.fillText(String(l),i-20,s-5),n.fillText("x",i/2,s-5),n.save(),n.translate(12,s/2),n.rotate(-Math.PI/2),n.fillText("y",0,0),n.restore(),n.restore()}_drawContourLine(t,n,i,s,a,o){const c=a/s,l=o/s;t.beginPath();for(let d=0;d<s-1;d++)for(let u=0;u<s-1;u++){const h=n[d][u],f=n[d][u+1],g=n[d+1][u];if((h-i)*(f-i)<0){const p=(i-h)/(f-h),m=(u+p)*c,b=d*l;t.moveTo(m-.5,b),t.lineTo(m+.5,b)}if((h-i)*(g-i)<0){const p=(i-h)/(g-h),m=u*c,b=(d+p)*l;t.moveTo(m,b-.5),t.lineTo(m,b+.5)}}t.stroke()}_contourColor(t){const n=Math.max(0,Math.min(1,t));let i,s,a;if(n<.33){const o=n/.33;i=Math.round(10+o*0),s=Math.round(20+o*180),a=Math.round(80+o*140)}else if(n<.66){const o=(n-.33)/.33;i=Math.round(10+o*230),s=Math.round(200-o*10),a=Math.round(220-o*180)}else{const o=(n-.66)/.34;i=Math.round(240),s=Math.round(190-o*140),a=Math.round(40-o*30)}return`rgb(${i},${s},${a})`}_runOptimization(){const t=this.root.getElementById("gd-canvas"),n=this.root.getElementById("gd-info");if(!t)return;const i=t.getContext("2d");if(!i)return;const s=400,a=400,{fn:o,range:c}=this._getFnConfig(),[l,d]=c,u=parseFloat(this.getAttribute("lr")||"0.05"),h=parseInt(this.getAttribute("speed")||"50",10),f=this.hasAttribute("show-path"),g=this.getAttribute("optimizer")||"sgd",p=this.jsonAttr("start",[l+Math.random()*(d-l)*.6+(d-l)*.2,l+Math.random()*(d-l)*.6+(d-l)*.2]);let m=p[0],b=p[1];const x=[[m,b]],v={vx:0,vy:0,mx:0,my:0,sx:0,sy:0,t:0},_=(y,C)=>[(y-l)/(d-l)*s,(C-l)/(d-l)*a],w=1e-5,k=(y,C)=>{const M=(o(y+w,C)-o(y-w,C))/(2*w),T=(o(y,C+w)-o(y,C-w))/(2*w);return[M,T]};let $=0;const A=200,S=()=>{if($>=A)return;const[y,C]=k(m,b);if(Math.sqrt(y*y+C*C)<1e-6)return;switch(g){case"momentum":v.vx=.9*v.vx+u*y,v.vy=.9*v.vy+u*C,m-=v.vx,b-=v.vy;break;case"adam":v.t++,v.mx=.9*v.mx+.1*y,v.my=.9*v.my+.1*C,v.sx=.999*v.sx+.001*y*y,v.sy=.999*v.sy+.001*C*C;const q=v.mx/(1-Math.pow(.9,v.t)),I=v.my/(1-Math.pow(.9,v.t)),P=v.sx/(1-Math.pow(.999,v.t)),F=v.sy/(1-Math.pow(.999,v.t));m-=u*q/(Math.sqrt(P)+1e-8),b-=u*I/(Math.sqrt(F)+1e-8);break;default:m-=u*y,b-=u*C;break}if(m=Math.max(l,Math.min(d,m)),b=Math.max(l,Math.min(d,b)),x.push([m,b]),this._drawContour(),i.save(),i.scale(2,2),f&&x.length>1)for(let q=1;q<x.length;q++){const I=.1+.9*(q/x.length);i.strokeStyle=`rgba(0,212,255,${I})`,i.lineWidth=1.5,i.beginPath();const[P,F]=_(x[q-1][0],x[q-1][1]),[N,D]=_(x[q][0],x[q][1]);i.moveTo(P,F),i.lineTo(N,D),i.stroke()}const[T,L]=_(m,b);i.beginPath(),i.arc(T,L,6,0,Math.PI*2),i.fillStyle="#00d4ff",i.shadowColor="#00d4ff",i.shadowBlur=12,i.fill(),i.shadowBlur=0,i.strokeStyle="#fff",i.lineWidth=1.5,i.stroke(),i.restore();const E=o(m,b);n&&(n.textContent=`Step ${$+1} | Loss: ${E.toFixed(4)} | x: ${m.toFixed(3)}, y: ${b.toFixed(3)}`),$++,this._timer=setTimeout(()=>{this._animFrame=requestAnimationFrame(S)},h)};this._animFrame=requestAnimationFrame(S)}}customElements.define("lv-gradient-descent",Z0);const J0=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
...
`,Er=["#3b82f6","#ef4444"];class Q0 extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_nextClass",0)}static get observedAttributes(){return["data","model","resolution","interactive","c"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(J0),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector("svg");n&&(n.style.opacity="0",n.style.transition="opacity 0.6s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_build(){const t=this.jsonAttr("data",[{x:1,y:2,class:0},{x:2,y:3,class:0},{x:3,y:3,class:0},{x:1.5,y:1,class:0},{x:2.5,y:2,class:0},{x:5,y:5,class:1},{x:6,y:5,class:1},{x:5,y:6,class:1},{x:6,y:6,class:1},{x:5.5,y:4.5,class:1}]),n=this.getAttribute("model")||"linear",i=parseInt(this.getAttribute("resolution")||"50",10),s=this.hasAttribute("interactive"),a=parseFloat(this.getAttribute("c")||"1.0"),o=500,c=400,l={top:20,right:20,bottom:40,left:45},d=o-l.left-l.right,u=c-l.top-l.bottom;if(!t.length){this.render('<div class="db-container"></div>');return}const h=ne(t,L=>L.x),f=ne(t,L=>L.y),g=(h[1]-h[0])*.2||1,p=(f[1]-f[0])*.2||1,m=h[0]-g,b=h[1]+g,x=f[0]-p,v=f[1]+p,_=rt().domain([m,b]).range([0,d]),w=rt().domain([v,x]).range([0,u]),k=this._fitModel(t,n,a);let $="";const A=d/i,S=u/i;for(let L=0;L<i;L++)for(let E=0;E<i;E++){const q=m+(b-m)*(E+.5)/i,I=v-(v-x)*(L+.5)/i,P=k(q,I),F=Er[P>=.5?1:0];$+=`<rect x="${l.left+E*A}" y="${l.top+L*S}" width="${A+.5}" height="${S+.5}" fill="${F}" opacity="0.15"/>`}let y="";t.forEach(L=>{const E=l.left+_(L.x),q=l.top+w(L.y),I=Er[L.class];y+=`<circle class="point" cx="${E}" cy="${q}" r="5" fill="${I}"/>`});const C=_.ticks(6),M=w.ticks(6);let T="";if(C.forEach(L=>{const E=l.left+_(L);T+=`<g class="tick"><line x1="${E}" y1="${l.top+u}" x2="${E}" y2="${l.top+u+5}"/><text x="${E}" y="${l.top+u+18}" text-anchor="middle">${L}</text></g>`}),M.forEach(L=>{const E=l.top+w(L);T+=`<g class="tick"><line x1="${l.left-5}" y1="${E}" x2="${l.left}" y2="${E}"/><text x="${l.left-8}" y="${E+4}" text-anchor="end">${L}</text></g>`}),T+=`<line class="domain" x1="${l.left}" y1="${l.top}" x2="${l.left}" y2="${l.top+u}"/>`,T+=`<line class="domain" x1="${l.left}" y1="${l.top+u}" x2="${l.left+d}" y2="${l.top+u}"/>`,this.render(`<div class="db-container">
    ...
    </div>`),s){const L=this.root.getElementById("db-svg");L&&L.addEventListener("click",E=>{const q=E,I=L.getBoundingClientRect(),P=(q.clientX-I.left)*(o/I.width)-l.left,F=(q.clientY-I.top)*(c/I.height)-l.top,N=_.invert(P),D=w.invert(F);P<0||P>d||F<0||F>u||(t.push({x:N,y:D,class:this._nextClass}),this._nextClass=1-this._nextClass,this.setAttribute("data",JSON.stringify(t)))})}}_fitModel(t,n,i){if(n==="rbf")return this._fitRbf(t,i);const s=n==="quadratic"?(g,p)=>[1,g,p,g*g,p*p,g*p]:(g,p)=>[1,g,p],a=s(0,0).length,o=new Float64Array(a),c=Ws(t,g=>g.x)||0,l=Ws(t,g=>g.y)||0,d=Math.max(Ys(t,g=>g.x)||1,.01),u=Math.max(Ys(t,g=>g.y)||1,.01),h=.1,f=500;for(let g=0;g<f;g++){const p=new Float64Array(a);for(const m of t){const b=(m.x-c)/d,x=(m.y-l)/u,v=s(b,x);let _=0;for(let $=0;$<a;$++)_+=o[$]*v[$];const k=1/(1+Math.exp(-_))-m.class;for(let $=0;$<a;$++)p[$]+=k*v[$]}for(let m=0;m<a;m++)o[m]-=h*p[m]/t.length}return(g,p)=>{const m=(g-c)/d,b=(p-l)/u,x=s(m,b);let v=0;for(let _=0;_<a;_++)v+=o[_]*x[_];return 1/(1+Math.exp(-v))}}_fitRbf(t,n){const i=n;return(s,a)=>{let o=0,c=0;for(const d of t){const u=(s-d.x)**2+(a-d.y)**2,h=Math.exp(-i*u);d.class===0?o+=h:c+=h}const l=o+c;return l<1e-10?.5:c/l}}}customElements.define("lv-decision-boundary",Q0);const tm=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
...
`,ft=120,Rt=90,Hi=60,ji=40,Co=10,Mo=2,Eo=8,kn=60;function Vi(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}class rm extends R{constructor(){super(...arguments);z(this,"_steps",[])}connectedCallback(){super.connectedCallback(),this.adoptStyles(nm),this._readChildren(),this._renderSvg()}_readChildren(){this._steps=[],this.querySelectorAll("lv-flow-step").forEach(n=>{this._steps.push({icon:n.getAttribute("icon")||"",label:n.getAttribute("label")||"",sub:n.getAttribute("sub")||"",color:n.getAttribute("color")||"var(--lv-accent, #6366f1)",active:n.hasAttribute("active")})})}_renderSvg(){const t=this._steps;if(t.length===0)return;const i=(this.getAttribute("direction")||"horizontal")==="horizontal",s=this.hasAttribute("cyclic"),a=this.isRtl,o=24,c=s?kn+40:0;let l,d;i?(l=o*2+t.length*ft+(t.length-1)*Hi,d=o*2+Rt+c):(l=o*2+ft+c,d=o*2+t.length*Rt+(t.length-1)*ji);const u=[];for(let v=0;v<t.length;v++)if(i){let _=o+v*(ft+Hi);a&&(_=l-o-ft-v*(ft+Hi)),u.push({x:_,y:o})}else u.push({x:o,y:o+v*(Rt+ji)});const h="arrowhead",f=Eo,g=Eo,p=`
      <defs>
      ...
      </defs>`;let m="";for(let v=0;v<t.length;v++){const _=t[v],w=u[v],k=_.active?_.color:"var(--lv-border, #333)",$=_.active?' filter="url(#glow)"':"";m+=`
        <g class="step-group" style="transition-delay: ${v*150}ms">
          <rect x="${w.x}" y="${w.y}" width="${ft}" height="${Rt}"
                rx="${Co}" ry="${Co}"
                fill="var(--lv-bg-card, #1e1e2e)"
                stroke="${k}" stroke-width="${_.active?2.5:1.5}"
                ${$} />
          <text x="${w.x+ft/2}" y="${w.y+30}"
                text-anchor="middle" font-size="24" dominant-baseline="central"
                fill="var(--lv-text, #e0e0e0)">
            ${Vi(_.icon)}
          </text>
          <text x="${w.x+ft/2}" y="${w.y+54}"
                text-anchor="middle" font-size="12" font-weight="700"
                fill="var(--lv-text, #e0e0e0)">
            ${Vi(_.label)}
          </text>
          <text x="${w.x+ft/2}" y="${w.y+70}"
                text-anchor="middle" font-size="10"
                fill="var(--lv-text-dim, #888)">
            ${Vi(_.sub)}
          </text>
        </g>`}let b="";for(let v=0;v<t.length-1;v++){const _=u[v],w=u[v+1],k=t.length*150+v*120;let $;if(i){const S=a?_.x:_.x+ft,y=a?w.x+ft:w.x,C=_.y+Rt/2,T=Math.abs(y-S)*.35,L=y>S?1:-1;$=`M${S},${C} C${S+L*T},${C} ${y-L*T},${C} ${y},${C}`}else{const S=_.x+ft/2,y=_.y+Rt,C=w.y,M=(C-y)*.4;$=`M${S},${y} C${S},${y+M} ${S},${C-M} ${S},${C}`}const A=i?Math.abs(u[v+1].x-u[v].x)+20:ji+Rt;b+=`
        <path class="arrow-path" d="${$}"
              ...
              stroke-dasharray="${A}"
              stroke-dashoffset="${A}"
              style="transition-delay: ${k}ms" />`}if(s&&t.length>1){const v=u[0],_=u[t.length-1],w=t.length*150+(t.length-1)*120;let k,$;if(i){const A=_.x+ft/2,S=v.x+ft/2,y=_.y+Rt,C=v.y+Rt,M=Math.max(y,C)+kn;k=`M${A},${y} C${A},${M} ${S},${M} ${S},${C}`,$=Math.abs(A-S)+kn*2}else{const A=_.x+ft,S=_.y+Rt/2,y=v.y+Rt/2,C=A+kn;k=`M${A},${S} C${C},${S} ${C},${y} ${A},${y}`,$=Math.abs(S-y)+kn*2}b+=`
        <path class="arrow-path" d="${k}"
              ...
              stroke-dasharray="${$}"
              stroke-dashoffset="${$}"
              style="transition-delay: ${w}ms" />`}const x=`
...
*/var $t={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},He={duration:.5,overwrite:!1,delay:0},Xi,ot,K,Pt=1e8,X=1/Pt,Yi=Math.PI*2,lm=Yi/4,cm=0,Po=Math.sqrt,dm=Math.cos,um=Math.sin,st=function(e){return typeof e=="string"},tt=function(e){return typeof e=="function"},Jt=function(e){return typeof e=="number"},Gi=function(e){return typeof e>"u"},jt=function(e){return typeof e=="object"},_t=function(e){return e!==!1},Wi=function(){return typeof window<"u"},Tr=function(e){return tt(e)||st(e)},zo=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},dt=Array.isArray,hm=/random\([^)]+\)/g,fm=/,\s*/g,Io=/(?:-?\.?\d|\.)+/gi,Fo=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,je=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Ui=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,qo=/[+-]=-?[.\d]+/,pm=/[^,'"\[\]\s]+/gi,gm=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,Z,Vt,Ki,Zi,At={},Lr={},No,Ro=function(e){return(Lr=Xe(e,At))&&xt},Ji=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},$n=function(e,t){return!t&&console.warn(e)},Do=function(e,t){return e&&(At[e]=t)&&Lr&&(Lr[e]=t)||At},An=function(){return 0},mm={suppressEvents:!0,isStart:!0,kill:!1},Pr={suppressEvents:!0,kill:!1},_m={suppressEvents:!0},Qi={},ie=[],ts={},Oo,St={},es={},Bo=30,zr=[],ns="",rs=function(e){var t=e[0],n,i;if(jt(t)||tt(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(i=zr.length;i--&&!zr[i].targetTest(t););n=zr[i]}for(i=e.length;i--;)e[i]&&(e[i]._gsap||(e[i]._gsap=new ml(e[i],n)))||e.splice(i,1);return e},ke=function(e){return e._gsap||rs(It(e))[0]._gsap},Ho=function(e,t,n){return(n=e[t])&&tt(n)?e[t]():Gi(n)&&e.getAttribute&&e.getAttribute(t)||n},vt=function(e,t){return(e=e.split(",")).forEach(t)||e},et=function(e){return Math.round(e*1e5)/1e5||0},J=function(e){return Math.round(e*1e7)/1e7||0},Ve=function(e,t){var n=t.charAt(0),i=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+i:n==="-"?e-i:n==="*"?e*i:e/i},vm=function(e,t){for(var n=t.length,i=0;e.indexOf(t[i])<0&&++i<n;);return i<n},Ir=function(){var e=ie.length,t=ie.slice(0),n,i;for(ts={},ie.length=0,n=0;n<e;n++)i=t[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},is=function(e){return!!(e._initted||e._startAt||e.add)},jo=function(e,t,n,i){ie.length&&!ot&&Ir(),e.render(t,n,!!(ot&&t<0&&is(e))),ie.length&&!ot&&Ir()},Vo=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(pm).length<2?t:st(e)?e.trim():e},Xo=function(e){return e},Ct=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},bm=function(e){return function(t,n){for(var i in n)i in t||i==="duration"&&e||i==="ease"||(t[i]=n[i])}},Xe=function(e,t){for(var n in t)e[n]=t[n];return e},Yo=function r(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=jt(t[n])?r(e[n]||(e[n]={}),t[n]):t[n]);return e},Fr=function(e,t){var n={},i;for(i in e)i in t||(n[i]=e[i]);return n},Sn=function(e){var t=e.parent||Z,n=e.keyframes?bm(dt(e.keyframes)):Ct;if(_t(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},xm=function(e,t){for(var n=e.length,i=n===t.length;i&&n--&&e[n]===t[n];);return n<0},Go=function(e,t,n,i,s){var a=e[i],o;if(s)for(o=t[s];a&&a[s]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[i]=t,t._prev=a,t.parent=t._dp=e,t},qr=function(e,t,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=t._prev,a=t._next;s?s._next=a:e[n]===t&&(e[n]=a),a?a._prev=s:e[i]===t&&(e[i]=s),t._next=t._prev=t.parent=null},se=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},$e=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},ym=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},ss=function(e,t,n,i){return e._startAt&&(ot?e._startAt.revert(Pr):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,i))},wm=function r(e){return!e||e._ts&&r(e.parent)},Wo=function(e){return e._repeat?Ye(e._tTime,e=e.duration()+e._rDelay)*e:0},Ye=function(e,t){var n=Math.floor(e=J(e/t));return e&&n===e?n-1:n},Nr=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},Rr=function(e){return e._end=J(e._start+(e._tDur/Math.abs(e._ts||e._rts||X)||0))},Dr=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=J(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),Rr(e),n._dirty||$e(n,e)),e},Uo=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Nr(e.rawTime(),t),(!t._dur||Mn(0,t.totalDuration(),n)-t._tTime>X)&&t.render(n,!0)),$e(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-X}},Xt=function(e,t,n,i){return t.parent&&se(t),t._start=J((Jt(n)?n:n||e!==Z?zt(e,n,t):e._time)+t._delay),t._end=J(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),Go(e,t,"_first","_last",e._sort?"_start":0),as(t)||(e._recent=t),i||Uo(e,t),e._ts<0&&Dr(e,e._tTime),e},Ko=function(e,t){return(At.ScrollTrigger||Ji("scrollTrigger",t))&&At.ScrollTrigger.create(t,e)},Zo=function(e,t,n,i,s){if(gs(e,t,s),!e._initted)return 1;if(!n&&e._pt&&!ot&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&Oo!==Et.frame)return ie.push(e),e._lazy=[s,i],1},km=function r(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||r(t))},as=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},$m=function(e,t,n,i){var s=e.ratio,a=t<0||!t&&(!e._start&&km(e)&&!(!e._initted&&as(e))||(e._ts<0||e._dp._ts<0)&&!as(e))?0:1,o=e._rDelay,c=0,l,d,u;if(o&&e._repeat&&(c=Mn(0,e._tDur,t),d=Ye(c,o),e._yoyo&&d&1&&(a=1-a),d!==Ye(e._tTime,o)&&(s=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==s||ot||i||e._zTime===X||!t&&e._zTime){if(!e._initted&&Zo(e,t,i,n,c))return;for(u=e._zTime,e._zTime=t||(n?X:0),n||(n=t&&!u),e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=c,l=e._pt;l;)l.r(a,l.d),l=l._next;t<0&&ss(e,t,n,!0),e._onUpdate&&!n&&Mt(e,"onUpdate"),c&&e._repeat&&!n&&e.parent&&Mt(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&se(e,1),!n&&!ot&&(Mt(e,a?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},Am=function(e,t,n){var i;if(n>t)for(i=e._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>t)return i;i=i._next}else for(i=e._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<t)return i;i=i._prev}},Ge=function(e,t,n,i){var s=e._repeat,a=J(t)||0,o=e._tTime/e._tDur;return o&&!i&&(e._time*=a/e._dur),e._dur=a,e._tDur=s?s<0?1e10:J(a*(s+1)+e._rDelay*s):a,o>0&&!i&&Dr(e,e._tTime=e._tDur*o),e.parent&&Rr(e),n||$e(e.parent,e),e},Jo=function(e){return e instanceof pt?$e(e):Ge(e,e._dur)},Sm={_start:0,endTime:An,totalDuration:An},zt=function r(e,t,n){var i=e.labels,s=e._recent||Sm,a=e.duration()>=Pt?s.endTime(!1):e._dur,o,c,l;return st(t)&&(isNaN(t)||t in i)?(c=t.charAt(0),l=t.substr(-1)==="%",o=t.indexOf("="),c==="<"||c===">"?(o>=0&&(t=t.replace(/=/,"")),(c==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(t.substr(1))||0)*(l?(o<0?s:n).totalDuration()/100:1)):o<0?(t in i||(i[t]=a),i[t]):(c=parseFloat(t.charAt(o-1)+t.substr(o+1)),l&&n&&(c=c/100*(dt(n)?n[0]:n).totalDuration()),o>1?r(e,t.substr(0,o-1),n)+c:a+c)):t==null?a:+t},Cn=function(e,t,n){var i=Jt(t[1]),s=(i?2:1)+(e<2?0:1),a=t[s],o,c;if(i&&(a.duration=t[1]),a.parent=n,e){for(o=a,c=n;c&&!("immediateRender"in o);)o=c.vars.defaults||{},c=_t(c.vars.inherit)&&c.parent;a.immediateRender=_t(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[s-1]}return new it(t[0],a,t[s+1])},ae=function(e,t){return e||e===0?t(e):t},Mn=function(e,t,n){return n<e?e:n>t?t:n},ut=function(e,t){return!st(e)||!(t=gm.exec(e))?"":t[1]},Cm=function(e,t,n){return ae(n,function(i){return Mn(e,t,i)})},os=[].slice,Qo=function(e,t){return e&&jt(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&jt(e[0]))&&!e.nodeType&&e!==Vt},Mm=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(i){var s;return st(i)&&!t||Qo(i,1)?(s=n).push.apply(s,It(i)):n.push(i)})||n},It=function(e,t,n){return K&&!t&&K.selector?K.selector(e):st(e)&&!n&&(Ki||!Ue())?os.call((t||Zi).querySelectorAll(e),0):dt(e)?Mm(e,n):Qo(e)?os.call(e,0):e?[e]:[]},ls=function(e){return e=It(e)[0]||$n("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return It(t,n.querySelectorAll?n:n===e?$n("Invalid scope")||Zi.createElement("div"):e)}},tl=function(e){return e.sort(function(){return .5-Math.random()})},el=function(e){if(tt(e))return e;var t=jt(e)?e:{each:e},n=Ae(t.ease),i=t.from||0,s=parseFloat(t.base)||0,a={},o=i>0&&i<1,c=isNaN(i)||o,l=t.axis,d=i,u=i;return st(i)?d=u={center:.5,edges:.5,end:1}[i]||0:!o&&c&&(d=i[0],u=i[1]),function(h,f,g){var p=(g||t).length,m=a[p],b,x,v,_,w,k,$,A,S;if(!m){if(S=t.grid==="auto"?0:(t.grid||[1,Pt])[1],!S){for($=-Pt;$<($=g[S++].getBoundingClientRect().left)&&S<p;);S<p&&S--}for(m=a[p]=[],b=c?Math.min(S,p)*d-.5:i%S,x=S===Pt?0:c?p*u/S-.5:i/S|0,$=0,A=Pt,k=0;k<p;k++)v=k%S-b,_=x-(k/S|0),m[k]=w=l?Math.abs(l==="y"?_:v):Po(v*v+_*_),w>$&&($=w),w<A&&(A=w);i==="random"&&tl(m),m.max=$-A,m.min=A,m.v=p=(parseFloat(t.amount)||parseFloat(t.each)*(S>p?p-1:l?l==="y"?p/S:S:Math.max(S,p/S))||0)*(i==="edges"?-1:1),m.b=p<0?s-p:s,m.u=ut(t.amount||t.each)||0,n=n&&p<0?fl(n):n}return p=(m[h]-m.min)/m.max||0,J(m.b+(n?n(p):p)*m.v)+m.u}},cs=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var i=J(Math.round(parseFloat(n)/e)*e*t);return(i-i%1)/t+(Jt(n)?0:ut(n))}},nl=function(e,t){var n=dt(e),i,s;return!n&&jt(e)&&(i=n=e.radius||Pt,e.values?(e=It(e.values),(s=!Jt(e[0]))&&(i*=i)):e=cs(e.increment)),ae(t,n?tt(e)?function(a){return s=e(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),c=parseFloat(s?a.y:0),l=Pt,d=0,u=e.length,h,f;u--;)s?(h=e[u].x-o,f=e[u].y-c,h=h*h+f*f):h=Math.abs(e[u]-o),h<l&&(l=h,d=u);return d=!i||l<=i?e[d]:a,s||d===a||Jt(a)?d:d+ut(a)}:cs(e))},rl=function(e,t,n,i){return ae(dt(e)?!t:n===!0?!!(n=0):!i,function(){return dt(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*i)/i})},Em=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduce(function(s,a){return a(s)},i)}},Tm=function(e,t){return function(n){return e(parseFloat(n))+(t||ut(n))}},Lm=function(e,t,n){return sl(e,t,0,1,n)},il=function(e,t,n){return ae(n,function(i){return e[~~t(i)]})},Pm=function r(e,t,n){var i=t-e;return dt(e)?il(e,r(0,e.length),t):ae(n,function(s){return(i+(s-e)%i)%i+e})},zm=function r(e,t,n){var i=t-e,s=i*2;return dt(e)?il(e,r(0,e.length-1),t):ae(n,function(a){return a=(s+(a-e)%s)%s||0,e+(a>i?s-a:a)})},En=function(e){return e.replace(hm,function(t){var n=t.indexOf("[")+1,i=t.substring(n||7,n?t.indexOf("]"):t.length-1).split(fm);return rl(n?i:+i[0],n?0:+i[1],+i[2]||1e-5)})},sl=function(e,t,n,i,s){var a=t-e,o=i-n;return ae(s,function(c){return n+((c-e)/a*o||0)})},Im=function r(e,t,n,i){var s=isNaN(e+t)?0:function(f){return(1-f)*e+f*t};if(!s){var a=st(e),o={},c,l,d,u,h;if(n===!0&&(i=1)&&(n=null),a)e={p:e},t={p:t};else if(dt(e)&&!dt(t)){for(d=[],u=e.length,h=u-2,l=1;l<u;l++)d.push(r(e[l-1],e[l]));u--,s=function(g){g*=u;var p=Math.min(h,~~g);return d[p](g-p)},n=t}else i||(e=Xe(dt(e)?[]:{},e));if(!d){for(c in t)fs.call(o,e,c,"get",t[c]);s=function(g){return vs(g,o)||(a?e.p:e)}}}return ae(n,s)},al=function(e,t,n){var i=e.labels,s=Pt,a,o,c;for(a in i)o=i[a]-t,o<0==!!n&&o&&s>(o=Math.abs(o))&&(c=a,s=o);return c},Mt=function(e,t,n){var i=e.vars,s=i[t],a=K,o=e._ctx,c,l,d;if(s)return c=i[t+"Params"],l=i.callbackScope||e,n&&ie.length&&Ir(),o&&(K=o),d=c?s.apply(l,c):s.call(l),K=a,d},Tn=function(e){return se(e),e.scrollTrigger&&e.scrollTrigger.kill(!!ot),e.progress()<1&&Mt(e,"onInterrupt"),e},We,ol=[],ll=function(e){if(e)if(e=!e.name&&e.default||e,Wi()||e.headless){var t=e.name,n=tt(e),i=t&&!n&&e.init?function(){this._props=[]}:e,s={init:An,render:vs,add:fs,kill:Km,modifier:Um,rawVars:0},a={targetTest:0,get:0,getSetter:_s,aliases:{},register:0};if(Ue(),e!==i){if(St[t])return;Ct(i,Ct(Fr(e,s),a)),Xe(i.prototype,Xe(s,Fr(e,a))),St[i.prop=t]=i,e.targetTest&&(zr.push(i),Qi[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}Do(t,i),e.register&&e.register(xt,i,bt)}else ol.push(e)},Y=255,Ln={aqua:[0,Y,Y],lime:[0,Y,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Y],navy:[0,0,128],white:[Y,Y,Y],olive:[128,128,0],yellow:[Y,Y,0],orange:[Y,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Y,0,0],pink:[Y,192,203],cyan:[0,Y,Y],transparent:[Y,Y,Y,0]},ds=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*Y+.5|0},cl=function(e,t,n){var i=e?Jt(e)?[e>>16,e>>8&Y,e&Y]:0:Ln.black,s,a,o,c,l,d,u,h,f,g;if(!i){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),Ln[e])i=Ln[e];else if(e.charAt(0)==="#"){if(e.length<6&&(s=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e="#"+s+s+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return i=parseInt(e.substr(1,6),16),[i>>16,i>>8&Y,i&Y,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),i=[e>>16,e>>8&Y,e&Y]}else if(e.substr(0,3)==="hsl"){if(i=g=e.match(Io),!t)c=+i[0]%360/360,l=+i[1]/100,d=+i[2]/100,a=d<=.5?d*(l+1):d+l-d*l,s=d*2-a,i.length>3&&(i[3]*=1),i[0]=ds(c+1/3,s,a),i[1]=ds(c,s,a),i[2]=ds(c-1/3,s,a);else if(~e.indexOf("="))return i=e.match(Fo),n&&i.length<4&&(i[3]=1),i}else i=e.match(Io)||Ln.transparent;i=i.map(Number)}return t&&!g&&(s=i[0]/Y,a=i[1]/Y,o=i[2]/Y,u=Math.max(s,a,o),h=Math.min(s,a,o),d=(u+h)/2,u===h?c=l=0:(f=u-h,l=d>.5?f/(2-u-h):f/(u+h),c=u===s?(a-o)/f+(a<o?6:0):u===a?(o-s)/f+2:(s-a)/f+4,c*=60),i[0]=~~(c+.5),i[1]=~~(l*100+.5),i[2]=~~(d*100+.5)),n&&i.length<4&&(i[3]=1),i},dl=function(e){var t=[],n=[],i=-1;return e.split(oe).forEach(function(s){var a=s.match(je)||[];t.push.apply(t,a),n.push(i+=a.length+1)}),t.c=n,t},ul=function(e,t,n){var i="",s=(e+i).match(oe),a=t?"hsla(":"rgba(",o=0,c,l,d,u;if(!s)return e;if(s=s.map(function(h){return(h=cl(h,t,1))&&a+(t?h[0]+","+h[1]+"%,"+h[2]+"%,"+h[3]:h.join(","))+")"}),n&&(d=dl(e),c=n.c,c.join(i)!==d.c.join(i)))for(l=e.replace(oe,"1").split(je),u=l.length-1;o<u;o++)i+=l[o]+(~c.indexOf(o)?s.shift()||a+"0,0,0,0)":(d.length?d:s.length?s:n).shift());if(!l)for(l=e.split(oe),u=l.length-1;o<u;o++)i+=l[o]+s[o];return i+l[u]},oe=(function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in Ln)r+="|"+e+"\\b";return new RegExp(r+")","gi")})(),Fm=/hsl[a]?\(/,hl=function(e){var t=e.join(" "),n;if(oe.lastIndex=0,oe.test(t))return n=Fm.test(t),e[1]=ul(e[1],n),e[0]=ul(e[0],n,dl(e[1])),!0},Pn,Et=(function(){var r=Date.now,e=500,t=33,n=r(),i=n,s=1e3/240,a=s,o=[],c,l,d,u,h,f,g=function p(m){var b=r()-i,x=m===!0,v,_,w,k;if((b>e||b<0)&&(n+=b-t),i+=b,w=i-n,v=w-a,(v>0||x)&&(k=++u.frame,h=w-u.time*1e3,u.time=w=w/1e3,a+=v+(v>=s?4:s-v),_=1),x||(c=l(p)),_)for(f=0;f<o.length;f++)o[f](w,h,k,m)};return u={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(m){return h/(1e3/(m||60))},wake:function(){No&&(!Ki&&Wi()&&(Vt=Ki=window,Zi=Vt.document||{},At.gsap=xt,(Vt.gsapVersions||(Vt.gsapVersions=[])).push(xt.version),Ro(Lr||Vt.GreenSockGlobals||!Vt.gsap&&Vt||{}),ol.forEach(ll)),d=typeof requestAnimationFrame<"u"&&requestAnimationFrame,c&&u.sleep(),l=d||function(m){return setTimeout(m,a-u.time*1e3+1|0)},Pn=1,g(2))},sleep:function(){(d?cancelAnimationFrame:clearTimeout)(c),Pn=0,l=An},lagSmoothing:function(m,b){e=m||1/0,t=Math.min(b||33,e)},fps:function(m){s=1e3/(m||240),a=u.time*1e3+s},add:function(m,b,x){var v=b?function(_,w,k,$){m(_,w,k,$),u.remove(v)}:m;return u.remove(m),o[x?"unshift":"push"](v),Ue(),v},remove:function(m,b){~(b=o.indexOf(m))&&o.splice(b,1)&&f>=b&&f--},_listeners:o},u})(),Ue=function(){return!Pn&&Et.wake()},H={},qm=/^[\d.\-M][\d.\-,\s]/,Nm=/["']/g,Rm=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),i=n[0],s=1,a=n.length,o,c,l;s<a;s++)c=n[s],o=s!==a-1?c.lastIndexOf(","):c.length,l=c.substr(0,o),t[i]=isNaN(l)?l.replace(Nm,"").trim():+l,i=c.substr(o+1).trim();return t},Dm=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),i=e.indexOf("(",t);return e.substring(t,~i&&i<n?e.indexOf(")",n+1):n)},Om=function(e){var t=(e+"").split("("),n=H[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[Rm(t[1])]:Dm(e).split(",").map(Vo)):H._CE&&qm.test(e)?H._CE("",e):n},fl=function(e){return function(t){return 1-e(1-t)}},pl=function r(e,t){for(var n=e._first,i;n;)n instanceof pt?r(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?r(n.timeline,t):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=t)),n=n._next},Ae=function(e,t){return e&&(tt(e)?e:H[e]||Om(e))||t},Se=function(e,t,n,i){n===void 0&&(n=function(c){return 1-t(1-c)}),i===void 0&&(i=function(c){return c<.5?t(c*2)/2:1-t((1-c)*2)/2});var s={easeIn:t,easeOut:n,easeInOut:i},a;return vt(e,function(o){H[o]=At[o]=s,H[a=o.toLowerCase()]=n;for(var c in s)H[a+(c==="easeIn"?".in":c==="easeOut"?".out":".inOut")]=H[o+"."+c]=s[c]}),s},gl=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},us=function r(e,t,n){var i=t>=1?t:1,s=(n||(e?.3:.45))/(t<1?t:1),a=s/Yi*(Math.asin(1/i)||0),o=function(d){return d===1?1:i*Math.pow(2,-10*d)*um((d-a)*s)+1},c=e==="out"?o:e==="in"?function(l){return 1-o(1-l)}:gl(o);return s=Yi/s,c.config=function(l,d){return r(e,l,d)},c},hs=function r(e,t){t===void 0&&(t=1.70158);var n=function(a){return a?--a*a*((t+1)*a+t)+1:0},i=e==="out"?n:e==="in"?function(s){return 1-n(1-s)}:gl(n);return i.config=function(s){return r(e,s)},i};vt("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,e){var t=e<5?e+1:e;Se(r+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})}),H.Linear.easeNone=H.none=H.Linear.easeIn,Se("Elastic",us("in"),us("out"),us()),(function(r,e){var t=1/e,n=2*t,i=2.5*t,s=function(o){return o<t?r*o*o:o<n?r*Math.pow(o-1.5/e,2)+.75:o<i?r*(o-=2.25/e)*o+.9375:r*Math.pow(o-2.625/e,2)+.984375};Se("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75),Se("Expo",function(r){return Math.pow(2,10*(r-1))*r+r*r*r*r*r*r*(1-r)}),Se("Circ",function(r){return-(Po(1-r*r)-1)}),Se("Sine",function(r){return r===1?1:-dm(r*lm)+1}),Se("Back",hs("in"),hs("out"),hs()),H.SteppedEase=H.steps=At.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,i=e+(t?0:1),s=t?1:0,a=1-X;return function(o){return((i*Mn(0,a,o)|0)+s)*n}}},He.ease=H["quad.out"],vt("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return ns+=r+","+r+"Params,"});var ml=function(e,t){this.id=cm++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:Ho,this.set=t?t.getSetter:_s},zn=(function(){function r(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,Ge(this,+t.duration,1,1),this.data=t.data,K&&(this._ctx=K,K.data.push(this)),Pn||Et.wake()}var e=r.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,Ge(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,i){if(Ue(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(Dr(this,n),!s._dp||s.parent||Uo(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Xt(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===X||!this._initted&&this._dur&&n||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),jo(this,n,i)),this},e.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Wo(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},e.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},e.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Wo(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?Ye(this._tTime,s)+1:1},e.timeScale=function(n,i){if(!arguments.length)return this._rts===-X?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?Nr(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-X?0:this._rts,this.totalTime(Mn(-Math.abs(this._delay),this.totalDuration(),s),i!==!1),Rr(this),ym(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Ue(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==X&&(this._tTime-=X)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=J(n);var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Xt(i,this,this._start-this._delay),this}return this._start},e.endTime=function(n){return this._start+(_t(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Nr(i.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=_m);var i=ot;return ot=n,is(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),ot=i,this},e.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Jo(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Jo(this),i?this.time(i):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,i){return this.totalTime(zt(this,n),_t(i))},e.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,_t(i)),this._dur||(this._zTime=-X),this},e.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},e.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},e.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-X:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-X,this},e.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-X)},e.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},e.then=function(n){var i=this,s=i._prom;return new Promise(function(a){var o=tt(n)?n:Xo,c=function(){var d=i.then;i.then=null,s&&s(),tt(o)&&(o=o(i))&&(o.then||o===i)&&(i.then=d),a(o),i.then=d};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?c():i._prom=c})},e.kill=function(){Tn(this)},r})();Ct(zn.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-X,_prom:0,_ps:!1,_rts:1});var pt=(function(r){Lo(e,r);function e(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=_t(n.sortChildren),Z&&Xt(n.parent||Z,Zt(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&Ko(Zt(s),n.scrollTrigger),s}var t=e.prototype;return t.to=function(i,s,a){return Cn(0,arguments,this),this},t.from=function(i,s,a){return Cn(1,arguments,this),this},t.fromTo=function(i,s,a,o){return Cn(2,arguments,this),this},t.set=function(i,s,a){return s.duration=0,s.parent=this,Sn(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new it(i,s,zt(this,a),1),this},t.call=function(i,s,a){return Xt(this,it.delayedCall(0,i,s),a)},t.staggerTo=function(i,s,a,o,c,l,d){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=l,a.onCompleteParams=d,a.parent=this,new it(i,a,zt(this,c)),this},t.staggerFrom=function(i,s,a,o,c,l,d){return a.runBackwards=1,Sn(a).immediateRender=_t(a.immediateRender),this.staggerTo(i,s,a,o,c,l,d)},t.staggerFromTo=function(i,s,a,o,c,l,d,u){return o.startAt=a,Sn(o).immediateRender=_t(o.immediateRender),this.staggerTo(i,s,o,c,l,d,u)},t.render=function(i,s,a){var o=this._time,c=this._dirty?this.totalDuration():this._tDur,l=this._dur,d=i<=0?0:J(i),u=this._zTime<0!=i<0&&(this._initted||!l),h,f,g,p,m,b,x,v,_,w,k,$;if(this!==Z&&d>c&&i>=0&&(d=c),d!==this._tTime||a||u){if(o!==this._time&&l&&(d+=this._time-o,i+=this._time-o),h=d,_=this._start,v=this._ts,b=!v,u&&(l||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(k=this._yoyo,m=l+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,s,a);if(h=J(d%m),d===c?(p=this._repeat,h=l):(w=J(d/m),p=~~w,p&&p===w&&(h=l,p--),h>l&&(h=l)),w=Ye(this._tTime,m),!o&&this._tTime&&w!==p&&this._tTime-w*m-this._dur<=0&&(w=p),k&&p&1&&(h=l-h,$=1),p!==w&&!this._lock){var A=k&&w&1,S=A===(k&&p&1);if(p<w&&(A=!A),o=A?0:d%l?l:d,this._lock=1,this.render(o||($?0:J(p*m)),s,!l)._lock=0,this._tTime=d,!s&&this.parent&&Mt(this,"onRepeat"),this.vars.repeatRefresh&&!$&&(this.invalidate()._lock=1,w=p),o&&o!==this._time||b!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(l=this._dur,c=this._tDur,S&&(this._lock=2,o=A?l:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!$&&this.invalidate()),this._lock=0,!this._ts&&!b)return this;pl(this,$)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(x=Am(this,J(o),J(h)),x&&(d-=h-(h=x._start))),this._tTime=d,this._time=h,this._act=!v,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&d&&l&&!s&&!w&&(Mt(this,"onStart"),this._tTime!==d))return this;if(h>=o&&i>=0)for(f=this._first;f;){if(g=f._next,(f._act||h>=f._start)&&f._ts&&x!==f){if(f.parent!==this)return this.render(i,s,a);if(f.render(f._ts>0?(h-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(h-f._start)*f._ts,s,a),h!==this._time||!this._ts&&!b){x=0,g&&(d+=this._zTime=-X);break}}f=g}else{f=this._last;for(var y=i<0?i:h;f;){if(g=f._prev,(f._act||y<=f._end)&&f._ts&&x!==f){if(f.parent!==this)return this.render(i,s,a);if(f.render(f._ts>0?(y-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(y-f._start)*f._ts,s,a||ot&&is(f)),h!==this._time||!this._ts&&!b){x=0,g&&(d+=this._zTime=y?-X:X);break}}f=g}}if(x&&!s&&(this.pause(),x.render(h>=o?0:-X)._zTime=h>=o?1:-1,this._ts))return this._start=_,Rr(this),this.render(i,s,a);this._onUpdate&&!s&&Mt(this,"onUpdate",!0),(d===c&&this._tTime>=this.totalDuration()||!d&&o)&&(_===this._start||Math.abs(v)!==Math.abs(this._ts))&&(this._lock||((i||!l)&&(d===c&&this._ts>0||!d&&this._ts<0)&&se(this,1),!s&&!(i<0&&!o)&&(d||o||!c)&&(Mt(this,d===c&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(d<c&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(i,s){var a=this;if(Jt(s)||(s=zt(this,s,i)),!(i instanceof zn)){if(dt(i))return i.forEach(function(o){return a.add(o,s)}),this;if(st(i))return this.addLabel(i,s);if(tt(i))i=it.delayedCall(0,i);else return this}return this!==i?Xt(this,i,s):this},t.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-Pt);for(var c=[],l=this._first;l;)l._start>=o&&(l instanceof it?s&&c.push(l):(a&&c.push(l),i&&c.push.apply(c,l.getChildren(!0,s,a)))),l=l._next;return c},t.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},t.remove=function(i){return st(i)?this.removeLabel(i):tt(i)?this.killTweensOf(i):(i.parent===this&&qr(this,i),i===this._recent&&(this._recent=this._last),$e(this))},t.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=J(Et.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},t.addLabel=function(i,s){return this.labels[i]=zt(this,s),this},t.removeLabel=function(i){return delete this.labels[i],this},t.addPause=function(i,s,a){var o=it.delayedCall(0,s||An,a);return o.data="isPause",this._hasPause=1,Xt(this,o,zt(this,i))},t.removePause=function(i){var s=this._first;for(i=zt(this,i);s;)s._start===i&&s.data==="isPause"&&se(s),s=s._next},t.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),c=o.length;c--;)le!==o[c]&&o[c].kill(i,s);return this},t.getTweensOf=function(i,s){for(var a=[],o=It(i),c=this._first,l=Jt(s),d;c;)c instanceof it?vm(c._targets,o)&&(l?(!le||c._initted&&c._ts)&&c.globalTime(0)<=s&&c.globalTime(c.totalDuration())>s:!s||c.isActive())&&a.push(c):(d=c.getTweensOf(o,s)).length&&a.push.apply(a,d),c=c._next;return a},t.tweenTo=function(i,s){s=s||{};var a=this,o=zt(a,i),c=s,l=c.startAt,d=c.onStart,u=c.onStartParams,h=c.immediateRender,f,g=it.to(a,Ct({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(l&&"time"in l?l.time:a._time))/a.timeScale())||X,onStart:function(){if(a.pause(),!f){var m=s.duration||Math.abs((o-(l&&"time"in l?l.time:a._time))/a.timeScale());g._dur!==m&&Ge(g,m,0,1).render(g._time,!0,!0),f=1}d&&d.apply(g,u||[])}},s));return h?g.render(0):g},t.tweenFromTo=function(i,s,a){return this.tweenTo(s,Ct({startAt:{time:zt(this,i)}},a))},t.recent=function(){return this._recent},t.nextLabel=function(i){return i===void 0&&(i=this._time),al(this,zt(this,i))},t.previousLabel=function(i){return i===void 0&&(i=this._time),al(this,zt(this,i),1)},t.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+X)},t.shiftChildren=function(i,s,a){a===void 0&&(a=0);var o=this._first,c=this.labels,l;for(i=J(i);o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(l in c)c[l]>=a&&(c[l]+=i);return $e(this)},t.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},t.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),$e(this)},t.totalDuration=function(i){var s=0,a=this,o=a._last,c=Pt,l,d,u;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(u=a.parent;o;)l=o._prev,o._dirty&&o.totalDuration(),d=o._start,d>c&&a._sort&&o._ts&&!a._lock?(a._lock=1,Xt(a,o,d-o._delay,1)._lock=0):c=d,d<0&&o._ts&&(s-=d,(!u&&!a._dp||u&&u.smoothChildTiming)&&(a._start+=J(d/a._ts),a._time-=d,a._tTime-=d),a.shiftChildren(-d,!1,-1/0),c=0),o._end>s&&o._ts&&(s=o._end),o=l;Ge(a,a===Z&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},e.updateRoot=function(i){if(Z._ts&&(jo(Z,Nr(i,Z)),Oo=Et.frame),Et.frame>=Bo){Bo+=$t.autoSleep||120;var s=Z._first;if((!s||!s._ts)&&$t.autoSleep&&Et._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||Et.sleep()}}},e})(zn);Ct(pt.prototype,{_lock:0,_hasPause:0,_forcing:0});var Bm=function(e,t,n,i,s,a,o){var c=new bt(this._pt,e,t,0,1,wl,null,s),l=0,d=0,u,h,f,g,p,m,b,x;for(c.b=n,c.e=i,n+="",i+="",(b=~i.indexOf("random("))&&(i=En(i)),a&&(x=[n,i],a(x,e,t),n=x[0],i=x[1]),h=n.match(Ui)||[];u=Ui.exec(i);)g=u[0],p=i.substring(l,u.index),f?f=(f+1)%5:p.substr(-5)==="rgba("&&(f=1),g!==h[d++]&&(m=parseFloat(h[d-1])||0,c._pt={_next:c._pt,p:p||d===1?p:",",s:m,c:g.charAt(1)==="="?Ve(m,g)-m:parseFloat(g)-m,m:f&&f<4?Math.round:0},l=Ui.lastIndex);return c.c=l<i.length?i.substring(l,i.length):"",c.fp=o,(qo.test(i)||b)&&(c.e=0),this._pt=c,c},fs=function(e,t,n,i,s,a,o,c,l,d){tt(i)&&(i=i(s||0,e,a));var u=e[t],h=n!=="get"?n:tt(u)?l?e[t.indexOf("set")||!tt(e["get"+t.substr(3)])?t:"get"+t.substr(3)](l):e[t]():u,f=tt(u)?l?Ym:xl:ms,g;if(st(i)&&(~i.indexOf("random(")&&(i=En(i)),i.charAt(1)==="="&&(g=Ve(h,i)+(ut(h)||0),(g||g===0)&&(i=g))),!d||h!==i||ps)return!isNaN(h*i)&&i!==""?(g=new bt(this._pt,e,t,+h||0,i-(h||0),typeof u=="boolean"?Wm:yl,0,f),l&&(g.fp=l),o&&g.modifier(o,this,e),this._pt=g):(!u&&!(t in e)&&Ji(t,i),Bm.call(this,e,t,h,i,f,c||$t.stringFilter,l))},Hm=function(e,t,n,i,s){if(tt(e)&&(e=In(e,s,t,n,i)),!jt(e)||e.style&&e.nodeType||dt(e)||zo(e))return st(e)?In(e,s,t,n,i):e;var a={},o;for(o in e)a[o]=In(e[o],s,t,n,i);return a},_l=function(e,t,n,i,s,a){var o,c,l,d;if(St[e]&&(o=new St[e]).init(s,o.rawVars?t[e]:Hm(t[e],i,s,a,n),n,i,a)!==!1&&(n._pt=c=new bt(n._pt,s,e,0,1,o.render,o,0,o.priority),n!==We))for(l=n._ptLookup[n._targets.indexOf(s)],d=o._props.length;d--;)l[o._props[d]]=c;return o},le,ps,gs=function r(e,t,n){var i=e.vars,s=i.ease,a=i.startAt,o=i.immediateRender,c=i.lazy,l=i.onUpdate,d=i.runBackwards,u=i.yoyoEase,h=i.keyframes,f=i.autoRevert,g=e._dur,p=e._startAt,m=e._targets,b=e.parent,x=b&&b.data==="nested"?b.vars.targets:m,v=e._overwrite==="auto"&&!Xi,_=e.timeline,w,k,$,A,S,y,C,M,T,L,E,q,I;if(_&&(!h||!s)&&(s="none"),e._ease=Ae(s,He.ease),e._yEase=u?fl(Ae(u===!0?s:u,He.ease)):0,u&&e._yoyo&&!e._repeat&&(u=e._yEase,e._yEase=e._ease,e._ease=u),e._from=!_&&!!i.runBackwards,!_||h&&!i.stagger){if(M=m[0]?ke(m[0]).harness:0,q=M&&i[M.prop],w=Fr(i,Qi),p&&(p._zTime<0&&p.progress(1),t<0&&d&&o&&!f?p.render(-1,!0):p.revert(d&&g?Pr:mm),p._lazy=0),a){if(se(e._startAt=it.set(m,Ct({data:"isStart",overwrite:!1,parent:b,immediateRender:!0,lazy:!p&&_t(c),startAt:null,delay:0,onUpdate:l&&function(){return Mt(e,"onUpdate")},stagger:0},a))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(ot||!o&&!f)&&e._startAt.revert(Pr),o&&g&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(d&&g&&!p){if(t&&(o=!1),$=Ct({overwrite:!1,data:"isFromStart",lazy:o&&!p&&_t(c),immediateRender:o,stagger:0,parent:b},w),q&&($[M.prop]=q),se(e._startAt=it.set(m,$)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(ot?e._startAt.revert(Pr):e._startAt.render(-1,!0)),e._zTime=t,!o)r(e._startAt,X,X);else if(!t)return}for(e._pt=e._ptCache=0,c=g&&_t(c)||c&&!g,k=0;k<m.length;k++){if(S=m[k],C=S._gsap||rs(m)[k]._gsap,e._ptLookup[k]=L={},ts[C.id]&&ie.length&&Ir(),E=x===m?k:x.indexOf(S),M&&(T=new M).init(S,q||w,e,E,x)!==!1&&(e._pt=A=new bt(e._pt,S,T.name,0,1,T.render,T,0,T.priority),T._props.forEach(function(P){L[P]=A}),T.priority&&(y=1)),!M||q)for($ in w)St[$]&&(T=_l($,w,e,E,S,x))?T.priority&&(y=1):L[$]=A=fs.call(e,S,$,"get",w[$],E,x,0,i.stringFilter);e._op&&e._op[k]&&e.kill(S,e._op[k]),v&&e._pt&&(le=e,Z.killTweensOf(S,L,e.globalTime(t)),I=!e.parent,le=0),e._pt&&c&&(ts[C.id]=1)}y&&kl(e),e._onInit&&e._onInit(e)}e._onUpdate=l,e._initted=(!e._op||e._pt)&&!I,h&&t<=0&&_.render(Pt,!0,!0)},jm=function(e,t,n,i,s,a,o,c){var l=(e._pt&&e._ptCache||(e._ptCache={}))[t],d,u,h,f;if(!l)for(l=e._ptCache[t]=[],h=e._ptLookup,f=e._targets.length;f--;){if(d=h[f][t],d&&d.d&&d.d._pt)for(d=d.d._pt;d&&d.p!==t&&d.fp!==t;)d=d._next;if(!d)return ps=1,e.vars[t]="+=0",gs(e,o),ps=0,c?$n(t+" not eligible for reset"):1;l.push(d)}for(f=l.length;f--;)u=l[f],d=u._pt||u,d.s=(i||i===0)&&!s?i:d.s+(i||0)+a*d.c,d.c=n-d.s,u.e&&(u.e=et(n)+ut(u.e)),u.b&&(u.b=d.s+ut(u.b))},Vm=function(e,t){var n=e[0]?ke(e[0]).harness:0,i=n&&n.aliases,s,a,o,c;if(!i)return t;s=Xe({},t);for(a in i)if(a in s)for(c=i[a].split(","),o=c.length;o--;)s[c[o]]=s[a];return s},Xm=function(e,t,n,i){var s=t.ease||i||"power1.inOut",a,o;if(dt(t))o=n[e]||(n[e]=[]),t.forEach(function(c,l){return o.push({t:l/(t.length-1)*100,v:c,e:s})});else for(a in t)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(e),v:t[a],e:s})},In=function(e,t,n,i,s){return tt(e)?e.call(t,n,i,s):st(e)&&~e.indexOf("random(")?En(e):e},vl=ns+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",bl={};vt(vl+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return bl[r]=1});var it=(function(r){Lo(e,r);function e(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:Sn(i))||this;var c=o.vars,l=c.duration,d=c.delay,u=c.immediateRender,h=c.stagger,f=c.overwrite,g=c.keyframes,p=c.defaults,m=c.scrollTrigger,b=c.yoyoEase,x=i.parent||Z,v=(dt(n)||zo(n)?Jt(n[0]):"length"in i)?[n]:It(n),_,w,k,$,A,S,y,C;if(o._targets=v.length?rs(v):$n("GSAP target "+n+" not found. https://gsap.com",!$t.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=f,g||h||Tr(l)||Tr(d)){if(i=o.vars,_=o.timeline=new pt({data:"nested",defaults:p||{},targets:x&&x.data==="nested"?x.vars.targets:v}),_.kill(),_.parent=_._dp=Zt(o),_._start=0,h||Tr(l)||Tr(d)){if($=v.length,y=h&&el(h),jt(h))for(A in h)~vl.indexOf(A)&&(C||(C={}),C[A]=h[A]);for(w=0;w<$;w++)k=Fr(i,bl),k.stagger=0,b&&(k.yoyoEase=b),C&&Xe(k,C),S=v[w],k.duration=+In(l,Zt(o),w,S,v),k.delay=(+In(d,Zt(o),w,S,v)||0)-o._delay,!h&&$===1&&k.delay&&(o._delay=d=k.delay,o._start+=d,k.delay=0),_.to(S,k,y?y(w,S,v):0),_._ease=H.none;_.duration()?l=d=0:o.timeline=0}else if(g){Sn(Ct(_.vars.defaults,{ease:"none"})),_._ease=Ae(g.ease||i.ease||"none");var M=0,T,L,E;if(dt(g))g.forEach(function(q){return _.to(v,q,">")}),_.duration();else{k={};for(A in g)A==="ease"||A==="easeEach"||Xm(A,g[A],k,g.easeEach);for(A in k)for(T=k[A].sort(function(q,I){return q.t-I.t}),M=0,w=0;w<T.length;w++)L=T[w],E={ease:L.e,duration:(L.t-(w?T[w-1].t:0))/100*l},E[A]=L.v,_.to(v,E,M),M+=E.duration;_.duration()<l&&_.to({},{duration:l-_.duration()})}}l||o.duration(l=_.duration())}else o.timeline=0;return f===!0&&!Xi&&(le=Zt(o),Z.killTweensOf(v),le=0),Xt(x,Zt(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(u||!l&&!g&&o._start===J(x._time)&&_t(u)&&wm(Zt(o))&&x.data!=="nested")&&(o._tTime=-X,o.render(Math.max(0,-d)||0)),m&&Ko(Zt(o),m),o}var t=e.prototype;return t.render=function(i,s,a){var o=this._time,c=this._tDur,l=this._dur,d=i<0,u=i>c-X&&!d?c:i<X?0:i,h,f,g,p,m,b,x,v,_;if(!l)$m(this,i,s,a);else if(u!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==d||this._lazy){if(h=u,v=this.timeline,this._repeat){if(p=l+this._rDelay,this._repeat<-1&&d)return this.totalTime(p*100+i,s,a);if(h=J(u%p),u===c?(g=this._repeat,h=l):(m=J(u/p),g=~~m,g&&g===m?(h=l,g--):h>l&&(h=l)),b=this._yoyo&&g&1,b&&(_=this._yEase,h=l-h),m=Ye(this._tTime,p),h===o&&!a&&this._initted&&g===m)return this._tTime=u,this;g!==m&&(v&&this._yEase&&pl(v,b),this.vars.repeatRefresh&&!b&&!this._lock&&h!==p&&this._initted&&(this._lock=a=1,this.render(J(p*g),!0).invalidate()._lock=0))}if(!this._initted){if(Zo(this,d?i:h,a,s,u))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==m))return this;if(l!==this._dur)return this.render(i,s,a)}if(this._tTime=u,this._time=h,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=x=(_||this._ease)(h/l),this._from&&(this.ratio=x=1-x),!o&&u&&!s&&!m&&(Mt(this,"onStart"),this._tTime!==u))return this;for(f=this._pt;f;)f.r(x,f.d),f=f._next;v&&v.render(i<0?i:v._dur*v._ease(h/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(d&&ss(this,i,s,a),Mt(this,"onUpdate")),this._repeat&&g!==m&&this.vars.onRepeat&&!s&&this.parent&&Mt(this,"onRepeat"),(u===this._tDur||!u)&&this._tTime===u&&(d&&!this._onUpdate&&ss(this,i,!0,!0),(i||!l)&&(u===this._tDur&&this._ts>0||!u&&this._ts<0)&&se(this,1),!s&&!(d&&!o)&&(u||o||b)&&(Mt(this,u===c?"onComplete":"onReverseComplete",!0),this._prom&&!(u<c&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},t.resetTo=function(i,s,a,o,c){Pn||Et.wake(),this._ts||this.play();var l=Math.min(this._dur,(this._dp._time-this._start)*this._ts),d;return this._initted||gs(this,l),d=this._ease(l/this._dur),jm(this,i,s,a,o,d,l,c)?this.resetTo(i,s,a,o,1):(Dr(this,0),this.parent||Go(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Tn(this):this.scrollTrigger&&this.scrollTrigger.kill(!!ot),this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,le&&le.vars.overwrite!==!0)._first||Tn(this),this.parent&&a!==this.timeline.totalDuration()&&Ge(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,c=i?It(i):o,l=this._ptLookup,d=this._pt,u,h,f,g,p,m,b;if((!s||s==="all")&&xm(o,c))return s==="all"&&(this._pt=0),Tn(this);for(u=this._op=this._op||[],s!=="all"&&(st(s)&&(p={},vt(s,function(x){return p[x]=1}),s=p),s=Vm(o,s)),b=o.length;b--;)if(~c.indexOf(o[b])){h=l[b],s==="all"?(u[b]=s,g=h,f={}):(f=u[b]=u[b]||{},g=s);for(p in g)m=h&&h[p],m&&((!("kill"in m.d)||m.d.kill(p)===!0)&&qr(this,m,"_pt"),delete h[p]),f!=="all"&&(f[p]=1)}return this._initted&&!this._pt&&d&&Tn(this),this},e.to=function(i,s){return new e(i,s,arguments[2])},e.from=function(i,s){return Cn(1,arguments)},e.delayedCall=function(i,s,a,o){return new e(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},e.fromTo=function(i,s,a){return Cn(2,arguments)},e.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new e(i,s)},e.killTweensOf=function(i,s,a){return Z.killTweensOf(i,s,a)},e})(zn);Ct(it.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0}),vt("staggerTo,staggerFrom,staggerFromTo",function(r){it[r]=function(){var e=new pt,t=os.call(arguments,0);return t.splice(r==="staggerFromTo"?5:4,0,0),e[r].apply(e,t)}});var ms=function(e,t,n){return e[t]=n},xl=function(e,t,n){return e[t](n)},Ym=function(e,t,n,i){return e[t](i.fp,n)},Gm=function(e,t,n){return e.setAttribute(t,n)},_s=function(e,t){return tt(e[t])?xl:Gi(e[t])&&e.setAttribute?Gm:ms},yl=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},Wm=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},wl=function(e,t){var n=t._pt,i="";if(!e&&t.b)i=t.b;else if(e===1&&t.e)i=t.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+i,n=n._next;i+=t.c}t.set(t.t,t.p,i,t)},vs=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},Um=function(e,t,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(e,t,n),s=a},Km=function(e){for(var t=this._pt,n,i;t;)i=t._next,t.p===e&&!t.op||t.op===e?qr(this,t,"_pt"):t.dep||(n=1),t=i;return!n},Zm=function(e,t,n,i){i.mSet(e,t,i.m.call(i.tween,n,i.mt),i)},kl=function(e){for(var t=e._pt,n,i,s,a;t;){for(n=t._next,i=s;i&&i.pr>t.pr;)i=i._next;(t._prev=i?i._prev:a)?t._prev._next=t:s=t,(t._next=i)?i._prev=t:a=t,t=n}e._pt=s},bt=(function(){function r(t,n,i,s,a,o,c,l,d){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||yl,this.d=c||this,this.set=l||ms,this.pr=d||0,this._next=t,t&&(t._prev=this)}var e=r.prototype;return e.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=Zm,this.m=n,this.mt=s,this.tween=i},r})();vt(ns+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return Qi[r]=1}),At.TweenMax=At.TweenLite=it,At.TimelineLite=At.TimelineMax=pt,Z=new pt({sortChildren:!1,defaults:He,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0}),$t.stringFilter=hl;var Ce=[],Or={},Jm=[],$l=0,Qm=0,bs=function(e){return(Or[e]||Jm).map(function(t){return t()})},xs=function(){var e=Date.now(),t=[];e-$l>2&&(bs("matchMediaInit"),Ce.forEach(function(n){var i=n.queries,s=n.conditions,a,o,c,l;for(o in i)a=Vt.matchMedia(i[o]).matches,a&&(c=1),a!==s[o]&&(s[o]=a,l=1);l&&(n.revert(),c&&t.push(n))}),bs("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),$l=e,bs("matchMedia"))},Al=(function(){function r(t,n){this.selector=n&&ls(n),this.data=[],this._r=[],this.isReverted=!1,this.id=Qm++,t&&this.add(t)}var e=r.prototype;return e.add=function(n,i,s){tt(n)&&(s=i,i=n,n=tt);var a=this,o=function(){var l=K,d=a.selector,u;return l&&l!==a&&l.data.push(a),s&&(a.selector=ls(s)),K=a,u=i.apply(a,arguments),tt(u)&&a._r.push(u),K=l,a.selector=d,a.isReverted=!1,u};return a.last=o,n===tt?o(a,function(c){return a.add(null,c)}):n?a[n]=o:o},e.ignore=function(n){var i=K;K=null,n(this),K=i},e.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof it&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,i){var s=this;if(n?(function(){for(var o=s.getTweens(),c=s.data.length,l;c--;)l=s.data[c],l.data==="isFlip"&&(l.revert(),l.getChildren(!0,!0,!1).forEach(function(d){return o.splice(o.indexOf(d),1)}));for(o.map(function(d){return{g:d._dur||d._delay||d._sat&&!d._sat.vars.immediateRender?d.globalTime(0):-1/0,t:d}}).sort(function(d,u){return u.g-d.g||-1/0}).forEach(function(d){return d.t.revert(n)}),c=s.data.length;c--;)l=s.data[c],l instanceof pt?l.data!=="nested"&&(l.scrollTrigger&&l.scrollTrigger.revert(),l.kill()):!(l instanceof it)&&l.revert&&l.revert(n);s._r.forEach(function(d){return d(n,s)}),s.isReverted=!0})():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Ce.length;a--;)Ce[a].id===this.id&&Ce.splice(a,1)},e.revert=function(n){this.kill(n||{})},r})(),t_=(function(){function r(t){this.contexts=[],this.scope=t,K&&K.data.push(this)}var e=r.prototype;return e.add=function(n,i,s){jt(n)||(n={matches:n});var a=new Al(0,s||this.scope),o=a.conditions={},c,l,d;K&&!a.selector&&(a.selector=K.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(l in n)l==="all"?d=1:(c=Vt.matchMedia(n[l]),c&&(Ce.indexOf(a)<0&&Ce.push(a),(o[l]=c.matches)&&(d=1),c.addListener?c.addListener(xs):c.addEventListener("change",xs)));return d&&i(a,function(u){return a.add(null,u)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r})(),Br={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(i){return ll(i)})},timeline:function(e){return new pt(e)},getTweensOf:function(e,t){return Z.getTweensOf(e,t)},getProperty:function(e,t,n,i){st(e)&&(e=It(e)[0]);var s=ke(e||{}).get,a=n?Xo:Vo;return n==="native"&&(n=""),e&&(t?a((St[t]&&St[t].get||s)(e,t,n,i)):function(o,c,l){return a((St[o]&&St[o].get||s)(e,o,c,l))})},quickSetter:function(e,t,n){if(e=It(e),e.length>1){var i=e.map(function(d){return xt.quickSetter(d,t,n)}),s=i.length;return function(d){for(var u=s;u--;)i[u](d)}}e=e[0]||{};var a=St[t],o=ke(e),c=o.harness&&(o.harness.aliases||{})[t]||t,l=a?function(d){var u=new a;We._pt=0,u.init(e,n?d+n:d,We,0,[e]),u.render(1,u),We._pt&&vs(1,We)}:o.set(e,c);return a?l:function(d){return l(e,c,n?d+n:d,o,1)}},quickTo:function(e,t,n){var i,s=xt.to(e,Ct((i={},i[t]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),a=function(c,l,d){return s.resetTo(t,c,l,d)};return a.tween=s,a},isTweening:function(e){return Z.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Ae(e.ease,He.ease)),Yo(He,e||{})},config:function(e){return Yo($t,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,i=e.plugins,s=e.defaults,a=e.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!St[o]&&!At[o]&&$n(t+" effect requires "+o+" plugin.")}),es[t]=function(o,c,l){return n(It(o),Ct(c||{},s),l)},a&&(pt.prototype[t]=function(o,c,l){return this.add(es[t](o,jt(c)?c:(l=c)&&{},this),l)})},registerEase:function(e,t){H[e]=Ae(t)},parseEase:function(e,t){return arguments.length?Ae(e,t):H},getById:function(e){return Z.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new pt(e),i,s;for(n.smoothChildTiming=_t(e.smoothChildTiming),Z.remove(n),n._dp=0,n._time=n._tTime=Z._time,i=Z._first;i;)s=i._next,(t||!(!i._dur&&i instanceof it&&i.vars.onComplete===i._targets[0]))&&Xt(n,i,i._start-i._delay),i=s;return Xt(Z,n,0),n},context:function(e,t){return e?new Al(e,t):K},matchMedia:function(e){return new t_(e)},matchMediaRefresh:function(){return Ce.forEach(function(e){var t=e.conditions,n,i;for(i in t)t[i]&&(t[i]=!1,n=1);n&&e.revert()})||xs()},addEventListener:function(e,t){var n=Or[e]||(Or[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Or[e],i=n&&n.indexOf(t);i>=0&&n.splice(i,1)},utils:{wrap:Pm,wrapYoyo:zm,distribute:el,random:rl,snap:nl,normalize:Lm,getUnit:ut,clamp:Cm,splitColor:cl,toArray:It,selector:ls,mapRange:sl,pipe:Em,unitize:Tm,interpolate:Im,shuffle:tl},install:Ro,effects:es,ticker:Et,updateRoot:pt.updateRoot,plugins:St,globalTimeline:Z,core:{PropTween:bt,globals:Do,Tween:it,Timeline:pt,Animation:zn,getCache:ke,_removeLinkedListItem:qr,reverting:function(){return ot},context:function(e){return e&&K&&(K.data.push(e),e._ctx=K),K},suppressOverwrites:function(e){return Xi=e}}};vt("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return Br[r]=it[r]}),Et.add(pt.updateRoot),We=Br.to({},{duration:0});var e_=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},n_=function(e,t){var n=e._targets,i,s,a;for(i in t)for(s=n.length;s--;)a=e._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=e_(a,i)),a&&a.modifier&&a.modifier(t[i],e,n[s],i))},ys=function(e,t){return{name:e,headless:1,rawVars:1,init:function(i,s,a){a._onInit=function(o){var c,l;if(st(s)&&(c={},vt(s,function(d){return c[d]=1}),s=c),t){c={};for(l in s)c[l]=t(s[l]);s=c}n_(o,s)}}}},xt=Br.registerPlugin({name:"attr",init:function(e,t,n,i,s){var a,o,c;this.tween=n;for(a in t)c=e.getAttribute(a)||"",o=this.add(e,"setAttribute",(c||0)+"",t[a],i,s,0,0,a),o.op=a,o.b=c,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)ot?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},ys("roundProps",cs),ys("modifiers"),ys("snap",nl))||Br;it.version=pt.version=xt.version="3.14.2",No=1,Wi()&&Ue(),H.Power0,H.Power1,H.Power2,H.Power3,H.Power4,H.Linear,H.Quad,H.Cubic,H.Quart,H.Quint,H.Strong,H.Elastic,H.Back,H.SteppedEase,H.Bounce,H.Sine,H.Expo,H.Circ;/*!
 * CSSPlugin 3.14.2
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Sl,ce,Ke,ws,Me,Cl,ks,r_=function(){return typeof window<"u"},Qt={},Ee=180/Math.PI,Ze=Math.PI/180,Je=Math.atan2,Ml=1e8,$s=/([A-Z])/g,i_=/(left|right|width|margin|padding|x)/i,s_=/[\s,\(]\S/,Yt={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},As=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},a_=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},o_=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},l_=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},c_=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},El=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Tl=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},d_=function(e,t,n){return e.style[t]=n},u_=function(e,t,n){return e.style.setProperty(t,n)},h_=function(e,t,n){return e._gsap[t]=n},f_=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},p_=function(e,t,n,i,s){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},g_=function(e,t,n,i,s){var a=e._gsap;a[t]=n,a.renderTransform(s,a)},Q="transform",yt=Q+"Origin",m_=function r(e,t){var n=this,i=this.target,s=i.style,a=i._gsap;if(e in Qt&&s){if(this.tfm=this.tfm||{},e!=="transform")e=Yt[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=te(i,o)}):this.tfm[e]=a.x?a[e]:te(i,e),e===yt&&(this.tfm.zOrigin=a.zOrigin);else return Yt.transform.split(",").forEach(function(o){return r.call(n,o,t)});if(this.props.indexOf(Q)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(yt,t,"")),e=Q}(s||t)&&this.props.push(e,t,s[e])},Ll=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},__=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,a;for(s=0;s<e.length;s+=3)e[s+1]?e[s+1]===2?t[e[s]](e[s+2]):t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace($s,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=ks(),(!s||!s.isStart)&&!n[Q]&&(Ll(n),i.zOrigin&&n[yt]&&(n[yt]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Pl=function(e,t){var n={target:e,props:[],revert:__,save:m_};return e._gsap||xt.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(i){return n.save(i)}),n},zl,Ss=function(e,t){var n=ce.createElementNS?ce.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):ce.createElement(e);return n&&n.style?n:ce.createElement(e)},Tt=function r(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace($s,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&r(e,Qe(t)||t,1)||""},Il="O,Moz,ms,Ms,Webkit".split(","),Qe=function(e,t,n){var i=t||Me,s=i.style,a=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Il[a]+e in s););return a<0?null:(a===3?"ms":a>=0?Il[a]:"")+e},Cs=function(){r_()&&window.document&&(Sl=window,ce=Sl.document,Ke=ce.documentElement,Me=Ss("div")||{style:{}},Ss("div"),Q=Qe(Q),yt=Q+"Origin",Me.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",zl=!!Qe("perspective"),ks=xt.core.reverting,ws=1)},Fl=function(e){var t=e.ownerSVGElement,n=Ss("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=e.cloneNode(!0),s;i.style.display="block",n.appendChild(i),Ke.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),Ke.removeChild(n),s},ql=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Nl=function(e){var t,n;try{t=e.getBBox()}catch{t=Fl(e),n=1}return t&&(t.width||t.height)||n||(t=Fl(e)),t&&!t.width&&!t.x&&!t.y?{x:+ql(e,["x","cx","x1"])||0,y:+ql(e,["y","cy","y1"])||0,width:0,height:0}:t},Rl=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Nl(e))},de=function(e,t){if(t){var n=e.style,i;t in Qt&&t!==yt&&(t=Q),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace($s,"-$1").toLowerCase())):n.removeAttribute(t)}},ue=function(e,t,n,i,s,a){var o=new bt(e._pt,t,n,0,1,a?Tl:El);return e._pt=o,o.b=i,o.e=s,e._props.push(n),o},Dl={deg:1,rad:1,turn:1},v_={grid:1,flex:1},he=function r(e,t,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Me.style,c=i_.test(t),l=e.tagName.toLowerCase()==="svg",d=(l?"client":"offset")+(c?"Width":"Height"),u=100,h=i==="px",f=i==="%",g,p,m,b;if(i===a||!s||Dl[i]||Dl[a])return s;if(a!=="px"&&!h&&(s=r(e,t,n,"px")),b=e.getCTM&&Rl(e),(f||a==="%")&&(Qt[t]||~t.indexOf("adius")))return g=b?e.getBBox()[c?"width":"height"]:e[d],et(f?s/g*u:s/100*g);if(o[c?"width":"height"]=u+(h?a:i),p=i!=="rem"&&~t.indexOf("adius")||i==="em"&&e.appendChild&&!l?e:e.parentNode,b&&(p=(e.ownerSVGElement||{}).parentNode),(!p||p===ce||!p.appendChild)&&(p=ce.body),m=p._gsap,m&&f&&m.width&&c&&m.time===Et.time&&!m.uncache)return et(s/m.width*u);if(f&&(t==="height"||t==="width")){var x=e.style[t];e.style[t]=u+i,g=e[d],x?e.style[t]=x:de(e,t)}else(f||a==="%")&&!v_[Tt(p,"display")]&&(o.position=Tt(e,"position")),p===e&&(o.position="static"),p.appendChild(Me),g=Me[d],p.removeChild(Me),o.position="absolute";return c&&f&&(m=ke(p),m.time=Et.time,m.width=p[d]),et(h?g*s/u:g&&s?u/g*s:0)},te=function(e,t,n,i){var s;return ws||Cs(),t in Yt&&t!=="transform"&&(t=Yt[t],~t.indexOf(",")&&(t=t.split(",")[0])),Qt[t]&&t!=="transform"?(s=qn(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:jr(Tt(e,yt))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Hr[t]&&Hr[t](e,t,n)||Tt(e,t)||Ho(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?he(e,t,s,n)+n:s},b_=function(e,t,n,i){if(!n||n==="none"){var s=Qe(t,e,1),a=s&&Tt(e,s,1);a&&a!==n?(t=s,n=a):t==="borderColor"&&(n=Tt(e,"borderTopColor"))}var o=new bt(this._pt,e.style,t,0,1,wl),c=0,l=0,d,u,h,f,g,p,m,b,x,v,_,w;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=Tt(e,i.substring(4,i.indexOf(")")))),i==="auto"&&(p=e.style[t],e.style[t]=i,i=Tt(e,t)||i,p?e.style[t]=p:de(e,t)),d=[n,i],hl(d),n=d[0],i=d[1],h=n.match(je)||[],w=i.match(je)||[],w.length){for(;u=je.exec(i);)m=u[0],x=i.substring(c,u.index),g?g=(g+1)%5:(x.substr(-5)==="rgba("||x.substr(-5)==="hsla(")&&(g=1),m!==(p=h[l++]||"")&&(f=parseFloat(p)||0,_=p.substr((f+"").length),m.charAt(1)==="="&&(m=Ve(f,m)+_),b=parseFloat(m),v=m.substr((b+"").length),c=je.lastIndex-v.length,v||(v=v||$t.units[t]||_,c===i.length&&(i+=v,o.e+=v)),_!==v&&(f=he(e,t,p,v)||0),o._pt={_next:o._pt,p:x||l===1?x:",",s:f,c:b-f,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=c<i.length?i.substring(c,i.length):""}else o.r=t==="display"&&i==="none"?Tl:El;return qo.test(i)&&(o.e=0),this._pt=o,o},Ol={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},x_=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Ol[n]||n,t[1]=Ol[i]||i,t.join(" ")},y_=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,a=n._gsap,o,c,l;if(s==="all"||s===!0)i.cssText="",c=1;else for(s=s.split(","),l=s.length;--l>-1;)o=s[l],Qt[o]&&(c=1,o=o==="transformOrigin"?yt:Q),de(n,o);c&&(de(n,Q),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",qn(n,1),a.uncache=1,Ll(i)))}},Hr={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var a=e._pt=new bt(e._pt,t,n,0,0,y_);return a.u=i,a.pr=-10,a.tween=s,e._props.push(n),1}}},Fn=[1,0,0,1,0,0],Bl={},Hl=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},jl=function(e){var t=Tt(e,Q);return Hl(t)?Fn:t.substr(7).match(Fo).map(et)},Ms=function(e,t){var n=e._gsap||ke(e),i=e.style,s=jl(e),a,o,c,l;return n.svg&&e.getAttribute("transform")?(c=e.transform.baseVal.consolidate().matrix,s=[c.a,c.b,c.c,c.d,c.e,c.f],s.join(",")==="1,0,0,1,0,0"?Fn:s):(s===Fn&&!e.offsetParent&&e!==Ke&&!n.svg&&(c=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(l=1,o=e.nextElementSibling,Ke.appendChild(e)),s=jl(e),c?i.display=c:de(e,"display"),l&&(o?a.insertBefore(e,o):a?a.appendChild(e):Ke.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Es=function(e,t,n,i,s,a){var o=e._gsap,c=s||Ms(e,!0),l=o.xOrigin||0,d=o.yOrigin||0,u=o.xOffset||0,h=o.yOffset||0,f=c[0],g=c[1],p=c[2],m=c[3],b=c[4],x=c[5],v=t.split(" "),_=parseFloat(v[0])||0,w=parseFloat(v[1])||0,k,$,A,S;n?c!==Fn&&($=f*m-g*p)&&(A=_*(m/$)+w*(-p/$)+(p*x-m*b)/$,S=_*(-g/$)+w*(f/$)-(f*x-g*b)/$,_=A,w=S):(k=Nl(e),_=k.x+(~v[0].indexOf("%")?_/100*k.width:_),w=k.y+(~(v[1]||v[0]).indexOf("%")?w/100*k.height:w)),i||i!==!1&&o.smooth?(b=_-l,x=w-d,o.xOffset=u+(b*f+x*p)-b,o.yOffset=h+(b*g+x*m)-x):o.xOffset=o.yOffset=0,o.xOrigin=_,o.yOrigin=w,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[yt]="0px 0px",a&&(ue(a,o,"xOrigin",l,_),ue(a,o,"yOrigin",d,w),ue(a,o,"xOffset",u,o.xOffset),ue(a,o,"yOffset",h,o.yOffset)),e.setAttribute("data-svg-origin",_+" "+w)},qn=function(e,t){var n=e._gsap||new ml(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,a="px",o="deg",c=getComputedStyle(e),l=Tt(e,yt)||"0",d,u,h,f,g,p,m,b,x,v,_,w,k,$,A,S,y,C,M,T,L,E,q,I,P,F,N,D,nt,lt,W,G;return d=u=h=p=m=b=x=v=_=0,f=g=1,n.svg=!!(e.getCTM&&Rl(e)),c.translate&&((c.translate!=="none"||c.scale!=="none"||c.rotate!=="none")&&(i[Q]=(c.translate!=="none"?"translate3d("+(c.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(c.rotate!=="none"?"rotate("+c.rotate+") ":"")+(c.scale!=="none"?"scale("+c.scale.split(" ").join(",")+") ":"")+(c[Q]!=="none"?c[Q]:"")),i.scale=i.rotate=i.translate="none"),$=Ms(e,n.svg),n.svg&&(n.uncache?(P=e.getBBox(),l=n.xOrigin-P.x+"px "+(n.yOrigin-P.y)+"px",I=""):I=!t&&e.getAttribute("data-svg-origin"),Es(e,I||l,!!I||n.originIsAbsolute,n.smooth!==!1,$)),w=n.xOrigin||0,k=n.yOrigin||0,$!==Fn&&(C=$[0],M=$[1],T=$[2],L=$[3],d=E=$[4],u=q=$[5],$.length===6?(f=Math.sqrt(C*C+M*M),g=Math.sqrt(L*L+T*T),p=C||M?Je(M,C)*Ee:0,x=T||L?Je(T,L)*Ee+p:0,x&&(g*=Math.abs(Math.cos(x*Ze))),n.svg&&(d-=w-(w*C+k*T),u-=k-(w*M+k*L))):(G=$[6],lt=$[7],N=$[8],D=$[9],nt=$[10],W=$[11],d=$[12],u=$[13],h=$[14],A=Je(G,nt),m=A*Ee,A&&(S=Math.cos(-A),y=Math.sin(-A),I=E*S+N*y,P=q*S+D*y,F=G*S+nt*y,N=E*-y+N*S,D=q*-y+D*S,nt=G*-y+nt*S,W=lt*-y+W*S,E=I,q=P,G=F),A=Je(-T,nt),b=A*Ee,A&&(S=Math.cos(-A),y=Math.sin(-A),I=C*S-N*y,P=M*S-D*y,F=T*S-nt*y,W=L*y+W*S,C=I,M=P,T=F),A=Je(M,C),p=A*Ee,A&&(S=Math.cos(A),y=Math.sin(A),I=C*S+M*y,P=E*S+q*y,M=M*S-C*y,q=q*S-E*y,C=I,E=P),m&&Math.abs(m)+Math.abs(p)>359.9&&(m=p=0,b=180-b),f=et(Math.sqrt(C*C+M*M+T*T)),g=et(Math.sqrt(q*q+G*G)),A=Je(E,q),x=Math.abs(A)>2e-4?A*Ee:0,_=W?1/(W<0?-W:W):0),n.svg&&(I=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Hl(Tt(e,Q)),I&&e.setAttribute("transform",I))),Math.abs(x)>90&&Math.abs(x)<270&&(s?(f*=-1,x+=p<=0?180:-180,p+=p<=0?180:-180):(g*=-1,x+=x<=0?180:-180)),t=t||n.uncache,n.x=d-((n.xPercent=d&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-d)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=h+a,n.scaleX=et(f),n.scaleY=et(g),n.rotation=et(p)+o,n.rotationX=et(m)+o,n.rotationY=et(b)+o,n.skewX=x+o,n.skewY=v+o,n.transformPerspective=_+a,(n.zOrigin=parseFloat(l.split(" ")[2])||!t&&n.zOrigin||0)&&(i[yt]=jr(l)),n.xOffset=n.yOffset=0,n.force3D=$t.force3D,n.renderTransform=n.svg?k_:zl?Vl:w_,n.uncache=0,n},jr=function(e){return(e=e.split(" "))[0]+" "+e[1]},Ts=function(e,t,n){var i=ut(t);return et(parseFloat(t)+parseFloat(he(e,"x",n+"px",i)))+i},w_=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Vl(e,t)},Te="0deg",Nn="0px",Le=") ",Vl=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,c=n.z,l=n.rotation,d=n.rotationY,u=n.rotationX,h=n.skewX,f=n.skewY,g=n.scaleX,p=n.scaleY,m=n.transformPerspective,b=n.force3D,x=n.target,v=n.zOrigin,_="",w=b==="auto"&&e&&e!==1||b===!0;if(v&&(u!==Te||d!==Te)){var k=parseFloat(d)*Ze,$=Math.sin(k),A=Math.cos(k),S;k=parseFloat(u)*Ze,S=Math.cos(k),a=Ts(x,a,$*S*-v),o=Ts(x,o,-Math.sin(k)*-v),c=Ts(x,c,A*S*-v+v)}m!==Nn&&(_+="perspective("+m+Le),(i||s)&&(_+="translate("+i+"%, "+s+"%) "),(w||a!==Nn||o!==Nn||c!==Nn)&&(_+=c!==Nn||w?"translate3d("+a+", "+o+", "+c+") ":"translate("+a+", "+o+Le),l!==Te&&(_+="rotate("+l+Le),d!==Te&&(_+="rotateY("+d+Le),u!==Te&&(_+="rotateX("+u+Le),(h!==Te||f!==Te)&&(_+="skew("+h+", "+f+Le),(g!==1||p!==1)&&(_+="scale("+g+", "+p+Le),x.style[Q]=_||"translate(0, 0)"},k_=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,c=n.rotation,l=n.skewX,d=n.skewY,u=n.scaleX,h=n.scaleY,f=n.target,g=n.xOrigin,p=n.yOrigin,m=n.xOffset,b=n.yOffset,x=n.forceCSS,v=parseFloat(a),_=parseFloat(o),w,k,$,A,S;c=parseFloat(c),l=parseFloat(l),d=parseFloat(d),d&&(d=parseFloat(d),l+=d,c+=d),c||l?(c*=Ze,l*=Ze,w=Math.cos(c)*u,k=Math.sin(c)*u,$=Math.sin(c-l)*-h,A=Math.cos(c-l)*h,l&&(d*=Ze,S=Math.tan(l-d),S=Math.sqrt(1+S*S),$*=S,A*=S,d&&(S=Math.tan(d),S=Math.sqrt(1+S*S),w*=S,k*=S)),w=et(w),k=et(k),$=et($),A=et(A)):(w=u,A=h,k=$=0),(v&&!~(a+"").indexOf("px")||_&&!~(o+"").indexOf("px"))&&(v=he(f,"x",a,"px"),_=he(f,"y",o,"px")),(g||p||m||b)&&(v=et(v+g-(g*w+p*$)+m),_=et(_+p-(g*k+p*A)+b)),(i||s)&&(S=f.getBBox(),v=et(v+i/100*S.width),_=et(_+s/100*S.height)),S="matrix("+w+","+k+","+$+","+A+","+v+","+_+")",f.setAttribute("transform",S),x&&(f.style[Q]=S)},$_=function(e,t,n,i,s){var a=360,o=st(s),c=parseFloat(s)*(o&&~s.indexOf("rad")?Ee:1),l=c-i,d=i+l+"deg",u,h;return o&&(u=s.split("_")[1],u==="short"&&(l%=a,l!==l%(a/2)&&(l+=l<0?a:-a)),u==="cw"&&l<0?l=(l+a*Ml)%a-~~(l/a)*a:u==="ccw"&&l>0&&(l=(l-a*Ml)%a-~~(l/a)*a)),e._pt=h=new bt(e._pt,t,n,i,l,a_),h.e=d,h.u="deg",e._props.push(n),h},Xl=function(e,t){for(var n in t)e[n]=t[n];return e},A_=function(e,t,n){var i=Xl({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,c,l,d,u,h,f,g;i.svg?(l=n.getAttribute("transform"),n.setAttribute("transform",""),a[Q]=t,o=qn(n,1),de(n,Q),n.setAttribute("transform",l)):(l=getComputedStyle(n)[Q],a[Q]=t,o=qn(n,1),a[Q]=l);for(c in Qt)l=i[c],d=o[c],l!==d&&s.indexOf(c)<0&&(f=ut(l),g=ut(d),u=f!==g?he(n,c,l,g):parseFloat(l),h=parseFloat(d),e._pt=new bt(e._pt,o,c,u,h-u,As),e._pt.u=g||0,e._props.push(c));Xl(o,i)};vt("padding,margin,Width,Radius",function(r,e){var t="Top",n="Right",i="Bottom",s="Left",a=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(o){return e<2?r+o:"border"+o+r});Hr[e>1?"border"+r:r]=function(o,c,l,d,u){var h,f;if(arguments.length<4)return h=a.map(function(g){return te(o,g,l)}),f=h.join(" "),f.split(h[0]).length===5?h[0]:f;h=(d+"").split(" "),f={},a.forEach(function(g,p){return f[g]=h[p]=h[p]||h[(p-1)/2|0]}),o.init(c,f,u)}});var Yl={name:"css",register:Cs,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var a=this._props,o=e.style,c=n.vars.startAt,l,d,u,h,f,g,p,m,b,x,v,_,w,k,$,A,S;ws||Cs(),this.styles=this.styles||Pl(e),A=this.styles.props,this.tween=n;for(p in t)if(p!=="autoRound"&&(d=t[p],!(St[p]&&_l(p,t,n,i,e,s)))){if(f=typeof d,g=Hr[p],f==="function"&&(d=d.call(n,i,e,s),f=typeof d),f==="string"&&~d.indexOf("random(")&&(d=En(d)),g)g(this,e,p,d,n)&&($=1);else if(p.substr(0,2)==="--")l=(getComputedStyle(e).getPropertyValue(p)+"").trim(),d+="",oe.lastIndex=0,oe.test(l)||(m=ut(l),b=ut(d),b?m!==b&&(l=he(e,p,l,b)+b):m&&(d+=m)),this.add(o,"setProperty",l,d,i,s,0,0,p),a.push(p),A.push(p,0,o[p]);else if(f!=="undefined"){if(c&&p in c?(l=typeof c[p]=="function"?c[p].call(n,i,e,s):c[p],st(l)&&~l.indexOf("random(")&&(l=En(l)),ut(l+"")||l==="auto"||(l+=$t.units[p]||ut(te(e,p))||""),(l+"").charAt(1)==="="&&(l=te(e,p))):l=te(e,p),h=parseFloat(l),x=f==="string"&&d.charAt(1)==="="&&d.substr(0,2),x&&(d=d.substr(2)),u=parseFloat(d),p in Yt&&(p==="autoAlpha"&&(h===1&&te(e,"visibility")==="hidden"&&u&&(h=0),A.push("visibility",0,o.visibility),ue(this,o,"visibility",h?"inherit":"hidden",u?"inherit":"hidden",!u)),p!=="scale"&&p!=="transform"&&(p=Yt[p],~p.indexOf(",")&&(p=p.split(",")[0]))),v=p in Qt,v){if(this.styles.save(p),S=d,f==="string"&&d.substring(0,6)==="var(--"){if(d=Tt(e,d.substring(4,d.indexOf(")"))),d.substring(0,5)==="calc("){var y=e.style.perspective;e.style.perspective=d,d=Tt(e,"perspective"),y?e.style.perspective=y:de(e,"perspective")}u=parseFloat(d)}if(_||(w=e._gsap,w.renderTransform&&!t.parseTransform||qn(e,t.parseTransform),k=t.smoothOrigin!==!1&&w.smooth,_=this._pt=new bt(this._pt,o,Q,0,1,w.renderTransform,w,0,-1),_.dep=1),p==="scale")this._pt=new bt(this._pt,w,"scaleY",w.scaleY,(x?Ve(w.scaleY,x+u):u)-w.scaleY||0,As),this._pt.u=0,a.push("scaleY",p),p+="X";else if(p==="transformOrigin"){A.push(yt,0,o[yt]),d=x_(d),w.svg?Es(e,d,0,k,0,this):(b=parseFloat(d.split(" ")[2])||0,b!==w.zOrigin&&ue(this,w,"zOrigin",w.zOrigin,b),ue(this,o,p,jr(l),jr(d)));continue}else if(p==="svgOrigin"){Es(e,d,1,k,0,this);continue}else if(p in Bl){$_(this,w,p,h,x?Ve(h,x+d):d);continue}else if(p==="smoothOrigin"){ue(this,w,"smooth",w.smooth,d);continue}else if(p==="force3D"){w[p]=d;continue}else if(p==="transform"){A_(this,d,e);continue}}else p in o||(p=Qe(p)||p);if(v||(u||u===0)&&(h||h===0)&&!s_.test(d)&&p in o)m=(l+"").substr((h+"").length),u||(u=0),b=ut(d)||(p in $t.units?$t.units[p]:m),m!==b&&(h=he(e,p,l,b)),this._pt=new bt(this._pt,v?w:o,p,h,(x?Ve(h,x+u):u)-h,!v&&(b==="px"||p==="zIndex")&&t.autoRound!==!1?c_:As),this._pt.u=b||0,v&&S!==d?(this._pt.b=l,this._pt.e=S,this._pt.r=l_):m!==b&&b!=="%"&&(this._pt.b=l,this._pt.r=o_);else if(p in o)b_.call(this,e,p,l,x?x+d:d);else if(p in e)this.add(e,p,l||e[p],x?x+d:d,i,s);else if(p!=="parseTransform"){Ji(p,d);continue}v||(p in o?A.push(p,0,o[p]):typeof e[p]=="function"?A.push(p,2,e[p]()):A.push(p,1,l||e[p])),a.push(p)}}$&&kl(this)},render:function(e,t){if(t.tween._time||!ks())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:te,aliases:Yt,getSetter:function(e,t,n){var i=Yt[t];return i&&i.indexOf(",")<0&&(t=i),t in Qt&&t!==yt&&(e._gsap.x||te(e,"x"))?n&&Cl===n?t==="scale"?f_:h_:(Cl=n||{})&&(t==="scale"?p_:g_):e.style&&!Gi(e.style[t])?d_:~t.indexOf("-")?u_:_s(e,t)},core:{_removeProperty:de,_getMatrix:Ms}};xt.utils.checkPrefix=Qe,xt.core.getStyleSaver=Pl,(function(r,e,t,n){var i=vt(r+","+e+","+t,function(s){Qt[s]=1});vt(e,function(s){$t.units[s]="deg",Bl[s]=1}),Yt[i[13]]=r+","+e,vt(n,function(s){var a=s.split(":");Yt[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY"),vt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){$t.units[r]="px"}),xt.registerPlugin(Yl);var Rn=xt.registerPlugin(Yl)||xt;Rn.core.Tween;const tn={input:"#ff2d75",hidden:"#7b68ee",output:"#00d4ff"},Dn=36,Vr=100,Ls=200,Gl=50,Ps=60,S_=`
  :host { display: block; }
...
`,fe=120,On=32,Xr=40;class E_ extends R{constructor(){super(...arguments);z(this,"_data",null);z(this,"_hasAnimated",!1);z(this,"_svg",null);z(this,"_container",null);z(this,"_root",null)}static get observedAttributes(){return["data","orientation"]}get _orientation(){return this.getAttribute("orientation")==="horizontal"?"horizontal":"vertical"}connectedCallback(){super.connectedCallback(),this.adoptStyles(M_),this._container=document.createElement("div"),this.root.appendChild(this._container),this._data=this.jsonAttr("data",{label:"root"}),this._initSvg(),this._buildHierarchy(),this._render(!1)}disconnectedCallback(){super.disconnectedCallback()}handleAttributeChange(t,n,i){n!==i&&(t==="data"&&(this._data=this.jsonAttr("data",{label:"root"}),this._buildHierarchy()),this._svg&&this._render(!1))}animateIn(t){this._hasAnimated||(this._hasAnimated=!0,t?this._render(!1):this._render(!0))}_initSvg(){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("role","img"),t.setAttribute("aria-label","Decision tree"),this._container.appendChild(t),this._svg=U(t),this._svg.append("g").attr("class","links-group"),this._svg.append("g").attr("class","nodes-group")}_buildHierarchy(){this._data&&(this._root=mr(this._data))}_getVisibleNodes(){if(!this._root)return[];const t=[],n=i=>{if(t.push(i),!i._collapsed&&i.children)for(const s of i.children)n(s)};return n(this._root),t}_toggleCollapse(t){!t.data.children||t.data.children.length===0||(t._collapsed?(t._collapsed=!1,t.children=t._children||[]):(t._collapsed=!0,t._children=t.children,t.children=void 0),this._render(!0))}_render(t){if(!this._svg||!this._root)return;const n=this._orientation==="horizontal",i=new Map,s=(y,C)=>{if(i.set(C,{collapsed:!!y._collapsed,_children:y._children}),y._collapsed&&y._children)for(let M=0;M<y._children.length;M++)s(y._children[M],`${C}/${M}`);if(y.children)for(let M=0;M<y.children.length;M++)s(y.children[M],`${C}/${M}`)};s(this._root,"0"),this._root=mr(this._data);const a=(y,C)=>{const M=i.get(C);if(M!=null&&M.collapsed&&(y._collapsed=!0,y._children=y.children,y.children=void 0),y.children)for(let T=0;T<y.children.length;T++)a(y.children[T],`${C}/${T}`)};a(this._root,"0");const o=this._getVisibleNodes(),c=o.filter(y=>!y.children||y.children.length===0).length,l=Gs(o,y=>y.depth)||0,d=On+20,u=fe+60;let h,f;n?(h=l*u,f=Math.max((c-1)*d,d)):(h=Math.max((c-1)*(fe+80),fe+80),f=l*u),Jp().size(n?[f,h]:[h,f]).separation((y,C)=>y.parent===C.parent?1.5:2)(this._root);const p=this._root.descendants(),m=this._root.links(),b=h+Xr*2+fe,x=f+Xr*2+On;this._svg.attr("viewBox",`0 0 ${b} ${x}`);const v=Xr+fe/2,_=Xr+On/2,w=y=>n?y.y+v:y.x+v,k=y=>n?y.x+_:y.y+_,$=this._svg.select(".links-group");$.selectAll("*").remove();const A=n?Lg().x(y=>y.y+v).y(y=>y.x+_):Pg().x(y=>y.x+v).y(y=>y.y+_);for(let y=0;y<m.length;y++){const C=m[y],M=$.append("path").attr("class","link").attr("d",A(C));if(t){const T=M.node().getTotalLength();M.attr("stroke-dasharray",T).attr("stroke-dashoffset",T).transition().delay(y*60+100).duration(500).ease(mn).attr("stroke-dashoffset",0)}}const S=this._svg.select(".nodes-group");S.selectAll("*").remove();for(let y=0;y<p.length;y++){const C=p[y],M=w(C),T=k(C),L=C.data.children&&C.data.children.length>0,E=!!C._collapsed,I=C.depth%Wl.length,P=getComputedStyle(this).getPropertyValue(`--lv-chart-${I}`).trim()||Wl[I],F=S.append("g").attr("transform",`translate(${M},${T})`);t&&F.attr("opacity",0).transition().delay(y*60).duration(400).ease(mn).attr("opacity",1);const N=F.append("rect").attr("class",`node-rect ${L?"has-children":"leaf"}`).attr("x",-fe/2).attr("y",-On/2).attr("width",fe).attr("height",On).attr("stroke",P);F.append("text").attr("class","node-label").text(C.data.label),L&&F.append("text").attr("class","collapse-indicator").attr("x",fe/2-12).attr("y",0).text(E?"+":"−"),L&&(N.on("click",()=>{this._toggleCollapse(C)}),F.select(".collapse-indicator").on("click",()=>{this._toggleCollapse(C)}))}}}customElements.define("lv-tree",E_);const T_="https://cdn.jsdelivr.net/npm/mermaid@10.9.1/dist/mermaid.min.js",L_=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
...
`;class q_ extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_step",0);z(this,"_nodes",[]);z(this,"_totalForward",0);z(this,"_phase","idle")}static get observedAttributes(){return["expression","values","speed"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(F_),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector("svg");n&&(n.style.opacity="0",n.style.transition="opacity 0.5s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}_build(){const t=this.getAttribute("expression")||"linear",n=this.jsonAttr("values",{x:2,w:.5,b:.1,y:1});this._nodes=this._buildGraph(t,n),this._totalForward=this._nodes.length,this._step=0,this._phase="idle",this._renderView()}_buildGraph(t,n){const i=n.x??2,s=n.w??.5,a=n.b??.1,o=n.y??1;switch(t){case"sigmoid":return[{id:"x",op:"x",value:null,grad:null,inputs:[],compute:()=>i,localGrad:(c,l)=>[l]},{id:"w",op:"w",value:null,grad:null,inputs:[],compute:()=>s,localGrad:(c,l)=>[l]},{id:"mul",op:"×",value:null,grad:null,inputs:[0,1],compute:c=>c[0]*c[1],localGrad:(c,l)=>[l*c[1],l*c[0]]},{id:"b",op:"b",value:null,grad:null,inputs:[],compute:()=>a,localGrad:(c,l)=>[l]},{id:"add",op:"+",value:null,grad:null,inputs:[2,3],compute:c=>c[0]+c[1],localGrad:(c,l)=>[l,l]},{id:"neg",op:"neg",value:null,grad:null,inputs:[4],compute:c=>-c[0],localGrad:(c,l)=>[-l]},{id:"exp",op:"exp",value:null,grad:null,inputs:[5],compute:c=>Math.exp(c[0]),localGrad:(c,l)=>[l*Math.exp(c[0])]},{id:"plus1",op:"+1",value:null,grad:null,inputs:[6],compute:c=>c[0]+1,localGrad:(c,l)=>[l]},{id:"inv",op:"1/x",value:null,grad:null,inputs:[7],compute:c=>1/c[0],localGrad:(c,l)=>[-l/(c[0]*c[0])]}];case"mse":{const c=s*i+a;return[{id:"y",op:"y",value:null,grad:null,inputs:[],compute:()=>o,localGrad:(l,d)=>[d]},{id:"yhat",op:"ŷ",value:null,grad:null,inputs:[],compute:()=>c,localGrad:(l,d)=>[d]},{id:"sub",op:"−",value:null,grad:null,inputs:[0,1],compute:l=>l[0]-l[1],localGrad:(l,d)=>[d,-d]},{id:"sq",op:"x²",value:null,grad:null,inputs:[2],compute:l=>l[0]*l[0],localGrad:(l,d)=>[2*l[0]*d]},{id:"half",op:"/2",value:null,grad:null,inputs:[3],compute:l=>l[0]/2,localGrad:(l,d)=>[d/2]}]}case"chain":return[{id:"x",op:"x",value:null,grad:null,inputs:[],compute:()=>i,localGrad:(c,l)=>[l]},{id:"sq",op:"x²",value:null,grad:null,inputs:[0],compute:c=>c[0]*c[0],localGrad:(c,l)=>[2*c[0]*l]},{id:"sin",op:"sin",value:null,grad:null,inputs:[1],compute:c=>Math.sin(c[0]),localGrad:(c,l)=>[Math.cos(c[0])*l]}];default:return[{id:"x",op:"x",value:null,grad:null,inputs:[],compute:()=>i,localGrad:(c,l)=>[l]},{id:"w",op:"w",value:null,grad:null,inputs:[],compute:()=>s,localGrad:(c,l)=>[l]},{id:"mul",op:"×",value:null,grad:null,inputs:[0,1],compute:c=>c[0]*c[1],localGrad:(c,l)=>[l*c[1],l*c[0]]},{id:"b",op:"b",value:null,grad:null,inputs:[],compute:()=>a,localGrad:(c,l)=>[l]},{id:"add",op:"+",value:null,grad:null,inputs:[2,3],compute:c=>c[0]+c[1],localGrad:(c,l)=>[l,l]}]}}_fmt(t){return Math.abs(t)<.001?t.toExponential(2):parseFloat(t.toFixed(4)).toString()}_stepForward(){if(this._phase==="idle"&&(this._phase="forward"),this._phase!=="forward")return;if(this._step>=this._nodes.length){this._phase="backward",this._nodes[this._nodes.length-1].grad=1,this._step=this._nodes.length-1,this._renderView();return}const t=this._nodes[this._step],n=t.inputs.map(i=>this._nodes[i].value);t.value=t.compute(n),this._step++,this._renderView()}_stepBackward(){if(this._phase!=="backward"||this._step<0)return;const t=this._nodes[this._step];if(t.inputs.length>0){const n=t.inputs.map(s=>this._nodes[s].value),i=t.localGrad(n,t.grad);t.inputs.forEach((s,a)=>{this._nodes[s].grad=(this._nodes[s].grad??0)+i[a]})}this._step--,this._renderView()}_reset(){this._nodes.forEach(t=>{t.value=null,t.grad=null}),this._step=0,this._phase="idle",this._renderView()}_renderView(){var v,_,w;const t=this._nodes,n=t.length,i=650,s=260,a=64,o=58,c=30,l=(i-60-a)/Math.max(n-1,1),d=100;let u="";for(let k=0;k<n;k++){const $=c+k*l+a/2;for(const A of t[k].inputs){const S=c+A*l+a/2,y=this._phase==="forward"&&this._step===k,C=this._phase==="backward"&&this._step===k;u+=`<line x1="${S}" y1="${d}" x2="${$}" y2="${d}" stroke="${y?"#3b82f6":C?"#ef4444":"var(--lv-border)"}" stroke-width="${y||C?2.5:1.5}" marker-end="url(#arrow)"/>`}}let h="";for(let k=0;k<n;k++){const $=c+k*l,A=this._phase==="forward"&&this._step===k,S=this._phase==="forward"&&k<this._step,y=this._phase==="backward"&&this._step===k,C=t[k].grad!==null;let M="var(--lv-border)",T="var(--lv-bg-card)";A?(M="#3b82f6",T="rgba(59,130,246,0.15)"):y?(M="#ef4444",T="rgba(239,68,68,0.15)"):S&&(M="var(--lv-accent)"),h+=`<g>
        ...
        <text x="${$+a/2}" y="${d+14}" text-anchor="middle" font-size="11"
          fill="var(--lv-text-dim)">${t[k].value!==null?this._fmt(t[k].value):""}</text>`,C&&(h+=`<text x="${$+a/2}" y="${d+o/2+18}" text-anchor="middle" font-size="10"
          fill="#ef4444">∂=${this._fmt(t[k].grad)}</text>`),h+="</g>"}let f="";if(this._phase==="forward"&&this._step>0&&this._step<=n){const k=t[this._step-1];if(k.inputs.length>0){const $=k.inputs.map(A=>t[A].op).join(", ");f=`Forward: ${k.op}(${$}) = ${this._fmt(k.value)}`}else f=`Forward: ${k.op} = ${this._fmt(k.value)}`}else if(this._phase==="backward")if(this._step>=0&&this._step<n){const k=t[this._step];f=`Backward: propagating gradient at ${k.op}, ∂=${this._fmt(k.grad)}`}else f="Backward pass complete.";else this._phase==="idle"&&(f="Press Step Forward to begin the forward pass.");const g=this._phase==="idle"||this._phase==="forward"&&this._step<=n,p=this._phase==="backward"&&this._step>=0,m=this._phase==="forward"?"phase-forward":this._phase==="backward"?"phase-backward":"",b=this._phase==="forward"?"Forward Pass":this._phase==="backward"?"Backward Pass":"",x=`<div class="bp-container">
    ...
    </div>`;this.render(x),(v=this.root.getElementById("btn-step-fwd"))==null||v.addEventListener("click",()=>this._stepForward()),(_=this.root.getElementById("btn-step-bwd"))==null||_.addEventListener("click",()=>this._stepBackward()),(w=this.root.getElementById("btn-reset"))==null||w.addEventListener("click",()=>this._reset())}_esc(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}customElements.define("lv-backprop-flow",q_);const N_=`
  :host { display: block; margin: var(--lv-sp-4) 0; }
...
`;class R_ extends R{constructor(){super(...arguments);z(this,"_hasAnimated",!1);z(this,"_allNodes",[]);z(this,"_root",null);z(this,"_steps",[]);z(this,"_stepIdx",-1);z(this,"_playing",!1);z(this,"_timer",null)}static get observedAttributes(){return["fn","n","speed","show-memo"]}connectedCallback(){super.connectedCallback(),this.adoptStyles(N_),this._build()}handleAttributeChange(){this.isConnected&&this._build()}animateIn(t){if(this._hasAnimated||(this._hasAnimated=!0,t))return;const n=this.root.querySelector(".rt-container");n&&(n.style.opacity="0",n.style.transition="opacity 0.5s ease-out",requestAnimationFrame(()=>{n.style.opacity="1"}))}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearTimeout(this._timer)}_build(){const t=this.getAttribute("fn")||"fibonacci",n=parseInt(this.getAttribute("n")||"5",10),i=this.hasAttribute("show-memo");this._allNodes=[],this._root=this._buildTree(t,n),this._layoutTree(this._root),this._steps=[],this._stepIdx=-1,this._playing=!1;const s=new Map;this._generateSteps(this._root,s,i),this._allNodes.forEach(a=>a.state="hidden"),this._renderView()}_buildTree(t,n){const i=new Map,s=(c,l)=>{const d=`${c}(${l.join(",")})`,u={call:d,args:l,children:[],result:null,x:0,y:0,state:"hidden"};switch(this._allNodes.push(u),c){case"fibonacci":case"fib":{const h=l[0];if(h<=1)u.result=h;else{const f=s("fib",[h-1]),g=s("fib",[h-2]);u.children=[f,g],u.result=f.result+g.result}break}case"factorial":case"fact":{const h=l[0];if(h<=1)u.result=1;else{const f=s("fact",[h-1]);u.children=[f],u.result=h*f.result}break}case"power":case"pow":{const[h,f]=l.length>=2?l:[2,l[0]];if(f===0)u.result=1,u.call=`pow(${h},0)`;else if(f===1)u.result=h,u.call=`pow(${h},1)`;else{const g=Math.floor(f/2);u.call=`pow(${h},${f})`;const p=s("pow",[h,g]);if(f%2===0)u.children=[p],u.result=p.result*p.result;else{const m=s("pow",[h,f-1]);u.children=[m],u.result=h*m.result}}break}case"mergesort":case"ms":{const h=l[0];if(h<=1)u.result=h,u.call=`ms(${h})`;else{u.call=`ms(${h})`;const f=Math.floor(h/2),g=s("ms",[f]),p=s("ms",[h-f]);u.children=[g,p],u.result=h}break}default:u.result=n}return i.set(d,u.result),u};return s(t==="fibonacci"?"fib":t==="factorial"?"fact":t==="mergesort"?"ms":t==="power"?"pow":t,t==="power"?[2,n]:[n])}_layoutTree(t){let n=0;const i=(s,a)=>{if(s.y=a,s.children.length===0)s.x=n++;else{for(const o of s.children)i(o,a+1);s.x=s.children.reduce((o,c)=>o+c.x,0)/s.children.length}};i(t,0)}_generateSteps(t,n,i,s){const a=this._allNodes.indexOf(t);if(i&&n.has(t.call)){this._steps.push({nodeIdx:a,action:"show",edgeFrom:s}),this._steps.push({nodeIdx:a,action:"memo"});return}this._steps.push({nodeIdx:a,action:"show",edgeFrom:s}),this._steps.push({nodeIdx:a,action:"activate"});for(const o of t.children)this._generateSteps(o,n,i,a);this._steps.push({nodeIdx:a,action:"compute"}),i&&n.set(t.call,!0)}_doStep(){if(this._stepIdx>=this._steps.length-1){this._playing=!1,this._renderView();return}this._stepIdx++;const t=this._steps[this._stepIdx],n=this._allNodes[t.nodeIdx];switch(t.action){case"show":n.state="pending";break;case"activate":n.state="active";break;case"compute":n.state="computed";break;case"memo":n.state="memo";break}this._renderView()}_play(){if(this._playing){this._playing=!1,this._timer&&clearTimeout(this._timer),this._renderView();return}this._playing=!0;const t=parseInt(this.getAttribute("speed")||"400",10),n=()=>{if(!this._playing||this._stepIdx>=this._steps.length-1){this._playing=!1,this._renderView();return}this._doStep(),this._timer=setTimeout(n,t)};n()}_reset(){this._playing=!1,this._timer&&clearTimeout(this._timer),this._stepIdx=-1,this._allNodes.forEach(t=>t.state="hidden"),this._renderView()}_renderView(){var w,k,$;if(!this._root)return;const t=this._allNodes;let n=0,i=0;for(const A of t)A.x>n&&(n=A.x),A.y>i&&(i=A.y);const s=60,a=40,o=Math.max(70,Math.min(110,600/(n+1))),c=70,l=(n+1)*o+s*2,d=(i+1)*c+a*2,u=56,h=32,f=A=>s+A.x*o+o/2,g=A=>a+A.y*c+c/2;let p="";for(const A of t)if(A.state!=="hidden")for(const S of A.children){if(S.state==="hidden")continue;const y=S.state==="active",C=y?"var(--lv-accent)":"var(--lv-border)";p+=`<line x1="${f(A)}" y1="${g(A)+h/2}" x2="${f(S)}" y2="${g(S)-h/2}" stroke="${C}" stroke-width="${y?2:1.5}"/>`}let m="";const b={hidden:{fill:"transparent",stroke:"transparent"},pending:{fill:"var(--lv-bg-card)",stroke:"var(--lv-border)"},active:{fill:"rgba(59,130,246,0.15)",stroke:"#3b82f6"},computed:{fill:"rgba(34,197,94,0.15)",stroke:"#22c55e"},memo:{fill:"rgba(234,179,8,0.2)",stroke:"#eab308"}};for(const A of t){if(A.state==="hidden")continue;const S=f(A),y=g(A),C=b[A.state];m+=`<g>
        ...
        <text x="${S}" y="${y-2}" text-anchor="middle" font-size="10" fill="var(--lv-text)">${this._esc(A.call)}</text>`,(A.state==="computed"||A.state==="memo")&&(m+=`<text x="${S}" y="${y+12}" text-anchor="middle" font-size="10" font-weight="600"
          fill="${A.state==="memo"?"#eab308":"#22c55e"}">${A.state==="memo"?"memo: ":"= "}${A.result}</text>`),m+="</g>"}let x="";if(this._stepIdx>=0&&this._stepIdx<this._steps.length){const A=this._steps[this._stepIdx],S=t[A.nodeIdx];A.action==="activate"?x=`Calling ${S.call}...`:A.action==="compute"?x=`${S.call} returns ${S.result}`:A.action==="memo"&&(x=`Memo hit! ${S.call} = ${S.result}`)}this._stepIdx>=this._steps.length-1&&this._stepIdx>=0&&(x="Recursion complete.");const v=this._stepIdx>=this._steps.length-1,_=`<div class="rt-container">
    ...
    </div>`;this.render(_),(w=this.root.getElementById("btn-play"))==null||w.addEventListener("click",()=>this._play()),(k=this.root.getElementById("btn-step"))==null||k.addEventListener("click",()=>this._doStep()),($=this.root.getElementById("btn-reset"))==null||$.addEventListener("click",()=>this._reset())}_esc(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}customElements.define("lv-recursion-tree",R_),O.LvBaseElement=R,O.clamp=qs,O.colorScale=Ns,O.formatNum=Rs,O.getToken=sc,O.lerp=ze,O.loadScript=Ds,O.loadStylesheet=ic,O.scrollAnimator=Gr,O.setTheme=ac,O.simColorScale=ec,O.uid=rc,Object.defineProperty(O,Symbol.toStringTag,{value:"Module"})}));
